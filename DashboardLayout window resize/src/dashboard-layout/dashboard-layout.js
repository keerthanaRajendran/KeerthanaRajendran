...
define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base"], function (require, exports, ej2_base_1, ej2_base_2, ej2_base_3, ej2_base_4) {
    ...
    var DashboardLayout = /** @class */ (function (_super) {
        ...
        function DashboardLayout(options, element) {
            ...
            ej2_base_2.setValue('mergePersistData', _this.mergePersistPanelData, _this);
            return _this;
        }
        /**
        ...
        DashboardLayout.prototype.preRender = function () {
            this.isBlazor = (ej2_base_3.isBlazor() && this.isServerRendered);
        ...
        DashboardLayout.prototype.createPanelElement = function (cssClass, idValue) {
            ...
            if (cssClass && cssClass.length > 0) {
                ej2_base_4.addClass([ele], cssClass);
            }
            if (idValue) {
        ...
        DashboardLayout.prototype.initialize = function () {
            ...
            if (this.element.childElementCount > 0 && this.element.querySelectorAll('.e-panel').length > 0
                ...
                for (var i = 0; i < panelElements.length; i++) {
                    ...
                    if (this.enableRtl) {
                        ej2_base_4.addClass([panelElement], 'e-rtl');
                    }
        ...
        DashboardLayout.prototype.maxRow = function (recheck) {
            var maxRow = 1;
            if (this.rows > 1 && ej2_base_2.isNullOrUndefined(recheck)) {
                maxRow = this.rows;
                return maxRow;
            }
            for (var i = 0; i < this.panels.length; i++) {
        ...
        DashboardLayout.prototype.createSubElement = function (cssClass, idValue, className) {
            ...
            if (className) {
                ej2_base_4.addClass([element], [className]);
            }
            if (cssClass && cssClass.length > 0) {
                ej2_base_4.addClass([element], cssClass);
            }
            if (idValue) {
        ...
        DashboardLayout.prototype.templateParser = function (template) {
            if (template) {
                try {
                    ...
                    var sanitizedValue = ej2_base_3.SanitizeHtmlHelper.sanitize(template);
                    return ej2_base_3.compile((this.enableHtmlSanitizer && typeof (template) === 'string') ? sanitizedValue : template);
                }
            }
            return undefined;
        };
        DashboardLayout.prototype.renderTemplate = function (content, appendElement, type, isStringTemplate, prop) {
            ...
            if (compilerFn) {
                ...
                ej2_base_2.append([].slice.call(templateElements), appendElement);
            }
        };
        DashboardLayout.prototype.renderPanels = function (cellElement, panelModel, panelId, isStringTemplate) {
            if (!this.isBlazor) {
                ej2_base_4.addClass([cellElement], [panel, panelTransition]);
            }
            ...
            if (panelModel.header) {
                ...
                if (!this.isBlazor) {
                    ej2_base_4.addClass([headerTemplateElement], [header]);
                }
                if (!cellElement.querySelector('.e-panel-header') && !this.isBlazor) {
                    ...
                    this.renderReactTemplates();
                    ej2_base_2.updateBlazorTemplate(id, 'HeaderTemplate', panelModel);
                }
            }
            if (panelModel.content) {
                ...
                ej2_base_4.setStyleAttribute(this.panelBody, { height: contentHeightValue });
                if (!cellElement.querySelector('.e-panel-content') && !this.isBlazor) {
                    ...
                    this.renderReactTemplates();
                    ej2_base_2.updateBlazorTemplate(id, 'ContentTemplate', panelModel);
                }
            }
            return cellElement;
        };
        DashboardLayout.prototype.disablePanel = function (panelElement) {
            ej2_base_4.addClass([panelElement], [disable]);
        };
        DashboardLayout.prototype.getInlinePanels = function (panelElement) {
            ...
            if (ej2_base_1.isUndefined(model.enabled)) {
                model.enabled = true;
            }
        ...
        DashboardLayout.prototype.resizeEvents = function () {
            if (this.allowResizing) {
                ...
                for (var i = 0; i < panelElements.length; i++) {
                    var eventName = (ej2_base_4.Browser.info.name === 'msie') ? 'mousedown pointerdown' : 'mousedown';
                    ej2_base_4.EventHandler.add(panelElements[i], eventName, this.downResizeHandler, this);
                    if (ej2_base_4.Browser.info.name !== 'msie') {
                        ej2_base_4.EventHandler.add(panelElements[i], 'touchstart', this.touchDownResizeHandler, this);
                    }
                }
            }
        };
        ...
        DashboardLayout.prototype.downResizeHandler = function (e) {
            ...
            var moveEventName = (ej2_base_4.Browser.info.name === 'msie') ? 'mousemove pointermove' : 'mousemove';
            var upEventName = (ej2_base_4.Browser.info.name === 'msie') ? 'mouseup pointerup' : 'mouseup';
            if (!this.isMouseMoveBound) {
                ej2_base_4.EventHandler.add(document, moveEventName, this.moveResizeHandler, this);
                this.isMouseMoveBound = true;
            }
            if (!this.isMouseUpBound) {
                ej2_base_4.EventHandler.add(document, upEventName, this.upResizeHandler, this);
        ...
        DashboardLayout.prototype.downHandler = function (e) {
            ...
            var el = ej2_base_3.closest((e.currentTarget), '.e-panel');
            var args = { event: e, element: el, isInteracted: true };
            this.trigger('resizeStart', args);
            this.downTarget = e.currentTarget;
            this.shadowEle = document.createElement('div');
            this.shadowEle.classList.add('e-holder');
            ej2_base_4.addClass([this.element], [preventSelect]);
        ...
        DashboardLayout.prototype.touchDownResizeHandler = function (e) {
            ...
            if (!this.isMouseMoveBound) {
                ej2_base_4.EventHandler.add(document, 'touchmove', this.touchMoveResizeHandler, this);
                this.isMouseMoveBound = true;
            }
            if (!this.isMouseUpBound) {
                ej2_base_4.EventHandler.add(document, 'touchend', this.upResizeHandler, this);
                this.isMouseUpBound = true;
            }
        };
        ...
        DashboardLayout.prototype.updateMaxTopLeft = function (e) {
            ...
            var el = ej2_base_3.closest((this.moveTarget), '.e-panel');
            var args = { event: e, element: el, isInteracted: true };
        ...
        DashboardLayout.prototype.updateResizeElement = function (el) {
            ...
            ej2_base_4.removeClass([el], 'e-panel-transition');
            ej2_base_4.addClass([el], [dragging]);
        ...
        DashboardLayout.prototype.upResizeHandler = function (e) {
            if (ej2_base_2.isNullOrUndefined(this.downTarget)) {
                return;
            }
            this.updateServerPanelData();
            this.upTarget = this.downTarget;
            var el = ej2_base_3.closest((this.upTarget), '.e-panel');
            var args = { event: e, element: el, isInteracted: true };
            if (el) {
                ej2_base_4.addClass([el], 'e-panel-transition');
                var moveEventName = (ej2_base_4.Browser.info.name === 'msie') ? 'mousemove pointermove' : 'mousemove';
                var upEventName = (ej2_base_4.Browser.info.name === 'msie') ? 'mouseup pointerup' : 'mouseup';
                ej2_base_4.EventHandler.remove(document, moveEventName, this.moveResizeHandler);
                ej2_base_4.EventHandler.remove(document, upEventName, this.upResizeHandler);
                if (ej2_base_4.Browser.info.name !== 'msie') {
                    ej2_base_4.EventHandler.remove(document, 'touchmove', this.touchMoveResizeHandler);
                    ej2_base_4.EventHandler.remove(document, 'touchend', this.upResizeHandler);
                }
                this.isMouseUpBound = false;
                this.isMouseMoveBound = false;
                if (this.shadowEle) {
                    ej2_base_4.detach(this.shadowEle);
                }
                this.shadowEle = null;
                var panelModel = this.getCellInstance(el.getAttribute('id'));
            ...
            ej2_base_4.removeClass([el], [dragging]);
        ...
        DashboardLayout.prototype.refresh = function () {
            ...
            if (this.checkMediaQuery()) {
                ...
                if (this.element.classList.contains(responsive)) {
                    ej2_base_4.removeClass([this.element], [responsive]);
                    for (var i = 0; i < this.element.querySelectorAll('.e-panel').length; i++) {
        ...
        DashboardLayout.prototype.checkMediaQuerySizing = function () {
            ej2_base_4.addClass([this.element], [responsive]);
            var updatedPanel;
            ...
            for (var i = 0; i < updatedPanel.length; i++) {
                ...
                if (panelElement) {
                    ej2_base_4.setStyleAttribute(panelElement, { 'width': '100%' });
        ...
        DashboardLayout.prototype.setHeightWidth = function () {
            ...
            ej2_base_4.setStyleAttribute(this.element, { 'height': heightValue });
            widthValue = window.getComputedStyle(this.element).width;
            ej2_base_4.setStyleAttribute(this.element, { 'width': widthValue });
        };
        DashboardLayout.prototype.setHeightAndWidth = function (panelElement, panelModel) {
            ej2_base_4.setStyleAttribute(panelElement, { 'height': ej2_base_3.formatUnit(this.setXYDimensions(panelModel)[0]) });
            ej2_base_4.setStyleAttribute(panelElement, { 'width': ej2_base_3.formatUnit(this.setXYDimensions(panelModel)[1]) });
        };
        DashboardLayout.prototype.renderCell = function (panel, isStringTemplate, index) {
            var cellElement;
            this.dimensions = this.setXYDimensions(panel);
            if (ej2_base_1.isUndefined(panel.enabled)) {
                panel.enabled = true;
            }
            if (this.isBlazor) {
                ...
                if (this.contentTemplateChild.length > 0 && !ej2_base_2.isNullOrUndefined(index)) {
                    cellElement = this.contentTemplateChild[index];
                    if (panel.cssClass) {
                        ej2_base_4.addClass([cellElement], [panel.cssClass]);
                    }
                    if (panel.id) {
            ...
            if (!this.isBlazor) {
                ...
                if (bodyElement) {
                    ...
                    var contentHeightValue = 'calc( 100% - ' + headerHeight + ')';
                    ej2_base_4.setStyleAttribute(bodyElement, { height: contentHeightValue });
                }
            }
        ...
        DashboardLayout.prototype.setPanelPosition = function (cellElement, row, col) {
            ...
            ej2_base_4.setStyleAttribute(cellElement, { 'left': left + 'px', 'top': top + 'px' });
        };
        ...
        DashboardLayout.prototype.renderDashBoardCells = function (cells) {
            if (this.element.querySelectorAll('.e-panel').length > 0 || this.panels.length > 0) {
                for (var j = 0; j < cells.length; j++) {
                    ...
                    if (!this.isBlazor) {
                        if (this.enableRtl) {
                            ej2_base_4.addClass([cell], 'e-rtl');
                        }
        ...
        DashboardLayout.prototype.adjustmentAvailable = function (row, col, sizeY, sizeX, ele) {
            ...
            if (!this.rightAdjustable && !this.leftAdjustable && row > 0) {
                ...
                for (var rowValue = row; rowValue >= 0; rowValue--) {
                    ...
                    if ((rowValue !== endRow) && (rowValue === endRow - sizeY) &&
                        ...
                        this.spacedRowValue = ej2_base_2.isNullOrUndefined(this.spacedRowValue) ? rowValue : this.spacedRowValue;
            ...
            if (this.rightAdjustable || this.leftAdjustable || this.topAdjustable) {
                isAdjustable = true;
                if (ej2_base_2.isNullOrUndefined(this.spacedRowValue)) {
        ...
        DashboardLayout.prototype.updatePanelLayout = function (element, panelModel) {
            ...
            if (initialModel.length > 0) {
                ...
                swappingAvailable = !ej2_base_2.isNullOrUndefined(this.startRow) ? this.checkForSwapping(initialModel, element, panelModel) : false;
                if (swappingAvailable) {
                    ...
                    for (var i = 0; i < initialModel.length; i++) {
                        ...
                        if (checkForAdjustment && !ej2_base_2.isNullOrUndefined(this.spacedColumnValue)) {
        ...
        DashboardLayout.prototype.removeResizeClasses = function (panelElements) {
            for (var i = 0; i < panelElements.length; i++) {
                ...
                for (var i_2 = 0; i_2 < resizerElements.length; i_2++) {
                    ej2_base_4.detach(resizerElements[i_2]);
                }
            }
        };
        DashboardLayout.prototype.ensureDrag = function () {
            ...
            ej2_base_4.removeClass(dragPanels, [drag]);
            this.setClasses(this.panelCollection);
        };
            ...
            for (var i = 0; i < panelCollection.length; i++) {
                ...
                if (this.allowDragging) {
                    if (this.draggableHandle && element.querySelectorAll(this.draggableHandle)[0]) {
                        ej2_base_4.addClass([element.querySelectorAll(this.draggableHandle)[0]], [drag]);
                    }
                    else {
                        ej2_base_4.addClass([element], [drag]);
                    }
                }
                if (this.allowResizing &&
        ...
        DashboardLayout.prototype.setResizingClass = function (ele, container) {
            ...
            for (var j = 0; j < this.availableClasses.length; j++) {
                ...
                ej2_base_4.addClass([spanEle], [addClassValue, this.availableClasses[j], resize, resizeicon]);
            }
        };
        DashboardLayout.prototype.setXYAttributes = function (element, panelModel) {
            var value = {
                value: {
                    ...
                    maxSizeX: !ej2_base_2.isNullOrUndefined(panelModel.maxSizeX) ? panelModel.maxSizeX.toString() : undefined,
                    maxSizeY: !ej2_base_2.isNullOrUndefined(panelModel.maxSizeY) ? panelModel.maxSizeY.toString() : undefined,
        ...
        DashboardLayout.prototype.setXYDimensions = function (panelModel) {
            ...
            if (panelModel && typeof (cellHeight) === 'number' && panelModel.sizeY > 1 && typeof (panelModel.sizeY) === 'number') {
                ...
                heigthValue = ej2_base_3.formatUnit(cellHeight);
            }
        ...
        DashboardLayout.prototype.checkForChanges = function (isInteracted, added, removed) {
            ...
            if (this.removeAllCalled) {
                ...
                for (var i = 0; i < this.panels.length; i++) {
                    if (((!ej2_base_2.isNullOrUndefined(added) ? (this.panels[i].id !== added[0].id) : true) &&
                        (!ej2_base_2.isNullOrUndefined(removed) ? (this.panels[i].id !== removed[0].id) : true)) &&
            ...
            if (changedPanels.length > 0 || this.removeAllCalled) {
                var changedArgs = {
                    ...
                    addedPanels: !ej2_base_2.isNullOrUndefined(added) ? added : [], removedPanels: !ej2_base_2.isNullOrUndefined(removed) ? removed : []
                };
        ...
        DashboardLayout.prototype.enableDraggingContent = function (collections) {
            ...
            for (var i = 0; i < collections.length; i++) {
                ...
                {
                    this.dragobj = new ej2_base_2.Draggable(cellElement, {
                        ...
                        dragStop: function (args) {
                            ...
                            if (_this.shadowEle) {
                                ej2_base_4.detach(_this.shadowEle);
                            }
                            ej2_base_4.removeClass([_this.element], [preventSelect]);
                            ej2_base_4.removeClass([args.element], [dragging]);
                        ...
                        drag: function (args) {
                            _this.draggedEventArgs = {
                                ...
                                target: ej2_base_3.closest((args.target), '.e-panel')
                            };
        ...
        DashboardLayout.prototype.onDraggingStart = function (args) {
            ...
            ej2_base_4.setStyleAttribute(this.shadowEle, { 'position': 'absolute' });
            ej2_base_4.addClass([this.element], [preventSelect]);
            ej2_base_4.addClass([args.element], [dragging]);
            this.element.appendChild(this.shadowEle);
            this.renderReactTemplates();
        ...
        DashboardLayout.prototype.addPanel = function (panel) {
            ...
            if (this.allowResizing) {
                for (var i = 0; i < cell.querySelectorAll('.e-resize').length; i++) {
                    var eventName = (ej2_base_4.Browser.info.name === 'msie') ? 'mousedown pointerdown' : 'mousedown';
                    ej2_base_4.EventHandler.add(cell.querySelectorAll('.e-resize')[i], eventName, this.downResizeHandler, this);
                    if (ej2_base_4.Browser.info.name !== 'msie') {
                        ej2_base_4.EventHandler.add(cell.querySelectorAll('.e-resize')[i], 'touchstart', this.touchDownResizeHandler, this);
                    }
                }
            }
        ...
        DashboardLayout.prototype.updatePanel = function (panel) {
            ...
            if (ej2_base_2.isNullOrUndefined(panel.col)) {
            ...
            if (panelInstance.header) {
                ...
                if (cell.querySelector('.e-panel-header')) {
                    ej2_base_4.detach(cell.querySelector('.e-panel-header'));
                }
            }
            if (panelInstance.content) {
                ...
                if (cell.querySelector('.e-panel-content')) {
                    ej2_base_4.detach(cell.querySelector('.e-panel-content'));
                }
            }
        ...
        DashboardLayout.prototype.removeAll = function () {
            ...
            for (var i = 0; i < this.panelCollection.length; i++) {
                ej2_base_4.detach(this.panelCollection[i]);
                this.clearTemplate();
            }
            this.removeAllPanel();
            this.updateServerPanelData();
        ...
        DashboardLayout.prototype.destroy = function () {
            ej2_base_4.removeClass([this.element], ['e-dashboardlayout', 'e-lib', 'e-responsive', 'e-control']);
        ...
        DashboardLayout.prototype.removeAllPanel = function () {
            while (this.element.firstElementChild) {
                ej2_base_4.detach(this.element.firstElementChild);
                this.clearTemplate();
            }
        };
        DashboardLayout.prototype.setEnableRtl = function () {
            this.enableRtl ? ej2_base_4.addClass([this.element], 'e-rtl') : ej2_base_4.removeClass([this.element], 'e-rtl');
        };
        /**
        ...
        DashboardLayout.prototype.checkForIDValues = function (panels) {
            var _this = this;
            if (!ej2_base_2.isNullOrUndefined(panels) && panels.length > 0) {
                this.panelID = 0;
                    ...
                    case 'allowResizing':
                        ...
                        if (this.allowResizing) {
                            ...
                            for (var i = 0; i < panelElements.length; i++) {
                                var eventName = (ej2_base_4.Browser.info.name === 'msie') ? 'mousedown pointerdown' : 'mousedown';
                                var element = panelElements[i];
                                ej2_base_4.EventHandler.remove(element, eventName, this.downResizeHandler);
                                if (ej2_base_4.Browser.info.name !== 'msie') {
                                    ej2_base_4.EventHandler.remove(element, 'touchstart', this.touchDownResizeHandler);
                                }
                            }
                            this.removeResizeClasses(this.panelCollection);
                        }
        ...
        DashboardLayout.prototype.mergePersistPanelData = function (persistedData) {
            ...
            if (!(ej2_base_2.isNullOrUndefined(data) || (data === '')) || !ej2_base_2.isNullOrUndefined(persistedData)) {
                var dataObj = !ej2_base_2.isNullOrUndefined(persistedData) ? persistedData : JSON.parse(data);
                var keys = Object.keys(dataObj);
                this.isProtectedOnChange = true;
                for (var _i = 0, keys_1 = keys; _i < keys_1.length; _i++) {
                    var key = keys_1[_i];
                    if ((typeof ej2_base_3.getValue(key, this) === 'object' && !ej2_base_2.isNullOrUndefined(ej2_base_3.getValue(key, this)))) {
                        if (Array.isArray(ej2_base_3.getValue(key, this)) && key === 'panels') {
        ...
        DashboardLayout.prototype.mergePanels = function (sortedPanels, panels) {
            ...
            var _loop_6 = function (i) {
                ...
                if (!ej2_base_2.isNullOrUndefined(localPanel)) {
                    storedColumns[i] = ej2_base_4.extend(localPanel, storedColumns[i], {}, true);
                }
            };
            var this_4 = this;
        ...
        __decorate([
            ej2_base_1.Property('max-width: 600px')
        ], DashboardLayout.prototype, "mediaQuery", void 0);
        __decorate([
            ej2_base_2.Collection([], Panel)
        ], DashboardLayout.prototype, "panels", void 0);
        __decorate([
            ej2_base_1.Property(['e-south-east'])
