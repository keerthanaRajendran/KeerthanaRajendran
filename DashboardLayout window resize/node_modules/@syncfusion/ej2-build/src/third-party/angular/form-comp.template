import { Component, ElementRef, ViewContainerRef, ValueProvider, Renderer2, Injector, ChangeDetectionStrategy, forwardRef{{queryChild}}{{optionalImport}}{{templateRefImport}} } from '@angular/core';
