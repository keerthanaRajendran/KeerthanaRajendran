...
function publishApi(repo, done) {
    var component = JSON.parse(fs.readFileSync('./package.json', 'UTF8'));
    var packName = component.name.replace(/\@syncfusion\/ej2\-/,'');
    if (( packName !== 'react-barcode-generator') && (!fs.existsSync('./ej2-docs'))) {
        ...
        var ej2docRepo = 'https://' + user + ':' + token + '@gitlab.syncfusion.com/essential-studio/ej2-'+repo+'-api-library.git';
