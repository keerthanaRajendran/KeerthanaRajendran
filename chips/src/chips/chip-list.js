            ...
            if (ej2_base_3.isBlazor()) {
                ...
                for (var i = 0; i < childElement.length; i++) {
                    if (childElement[i] != null) {
                        ej2_base_3.detach(childElement[i]);
                    }
                }
            }
            else {
            ...
            if (chipWrapper) {
                ...
                this.trigger('beforeClick', chipDataArgs, function (observedArgs) {
                    if (!observedArgs.cancel) {
                        observedArgs.element = ej2_base_3.isBlazor() ? ej2_base_3.getElement(observedArgs.element) : observedArgs.element;
            ...
            if (ej2_base_3.isBlazor()) {
                ...
                for (var i = 0; i < chipChildElement.length; i++) {
                    if (chipChildElement[i] != null) {
                        ej2_base_3.detach(chipChildElement[i]);
                    }
                }
            }
            else {
