...
define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "../popup/popup", "../common/position", "../common/collision"], function (require, exports, ej2_base_1, ej2_base_2, ej2_base_3, ej2_base_4, ej2_base_5, popup_1, position_1, collision_1) {
    ...
    var Tooltip = /** @class */ (function (_super) {
        ...
        Tooltip.prototype.isServerRender = function () {
            return ej2_base_1.isBlazor() && this.isServerRendered;
        };
        ...
        Tooltip.prototype.renderArrow = function () {
            ...
            if (!(this.isServerRender())) {
                ...
                ej2_base_4.addClass([tip.querySelector('.' + ARROW_TIP_OUTER)], this.tipClass);
                ej2_base_4.addClass([tip.querySelector('.' + ARROW_TIP_INNER)], this.tipClass);
                this.tooltipEle.appendChild(tip);
            }
        };
        ...
        Tooltip.prototype.closePopupHandler = function () {
            ej2_base_4.resetBlazorTemplate(this.element.id + 'content', 'Content');
                ...
                if (this.isBlazorTooltip || !(this.isServerRender())) {
                    ...
                    if (this.content instanceof HTMLElement) {
                        ...
                        if (this.enableHtmlSanitizer) {
                            this.setProperties({ content: ej2_base_5.SanitizeHtmlHelper.sanitize(this.content) }, true);
                        }
                        ...
                        if (tempArr) {
                            ej2_base_1.append(tempArr, tooltipContent);
                        }
                        this.renderReactTemplates();
                        if (typeof this.content === 'string' && this.content.indexOf('<div>Blazor') >= 0) {
                            this.isBlazorTemplate = true;
                            ej2_base_4.updateBlazorTemplate(this.element.id + 'content', 'Content', this);
                        }
                    }
                }
            }
        ...
        Tooltip.prototype.targetHover = function (e) {
            ...
            if (ej2_base_3.isNullOrUndefined(target) || (target.getAttribute('data-tooltip-id') !== null && this.closeDelay === 0)) {
                return;
            }
        ...
        Tooltip.prototype.showTooltip = function (target, showAnimation, e) {
            ...
            this.tooltipEventArgs = {
                ...
                element: this.tooltipEle, isInteracted: !ej2_base_3.isNullOrUndefined(e)
            };
                ...
                if (ej2_base_3.isNullOrUndefined(this.tooltipEle)) {
                    if (this.isServerRender()) {
                        ...
                        this.ctrlId = this.element.getAttribute('id') ?
                            ej2_base_3.getUniqueID(this.element.getAttribute('id')) : ej2_base_3.getUniqueID('tooltip');
                        this.tooltipEle = this.createElement('div', {
                            className: TOOLTIP_WRAP + ' ' + POPUP_ROOT + ' ' + POPUP_LIB, attrs: {
                                role: 'tooltip', 'aria-hidden': 'false', 'id': this.ctrlId + '_content'
                            }, styles: 'width:' +
                                ej2_base_3.formatUnit(this.width) + ';height:' + ej2_base_3.formatUnit(this.height) + ';position:absolute;'
                        });
        ...
        Tooltip.prototype.contentUpdated = function (args) {
            if (ej2_base_3.isNullOrUndefined(this.tooltipEle)) {
                if (this.isServerRender()) {
                    ...
                    if (this.tooltipEle) {
                        this.tooltipEle.setAttribute('style', 'width:' + ej2_base_3.formatUnit(this.width) +
                            ';height:' + ej2_base_3.formatUnit(this.height) + ';position:absolute;');
        ...
        Tooltip.prototype.beforeRenderBlazor = function (target, ctrlObj) {
            if (target) {
                if (ej2_base_2.Browser.isDevice) {
                    ej2_base_4.addClass([ctrlObj.tooltipEle], DEVICE);
                }
                if (ctrlObj.width !== 'auto') {
                    ctrlObj.tooltipEle.style.maxWidth = ej2_base_3.formatUnit(ctrlObj.width);
                }
                if (!(this.isServerRender())) {
                    ctrlObj.tooltipEle.appendChild(ctrlObj.createElement('div', { className: CONTENT }));
                }
                document.body.appendChild(ctrlObj.tooltipEle);
                ej2_base_4.removeClass([ctrlObj.tooltipEle], HIDE_POPUP);
                ctrlObj.addDescribedBy(target, ctrlObj.ctrlId + '_content');
                ctrlObj.renderContent(target);
                ej2_base_4.addClass([ctrlObj.tooltipEle], POPUP_OPEN);
                ...
                ej2_base_2.Animation.stop(ctrlObj.tooltipEle);
                ctrlObj.reposition(target);
            }
        };
        Tooltip.prototype.afterRenderBlazor = function (target, e, showAnimation, ctrlObj) {
            if (target) {
                ej2_base_4.removeClass([ctrlObj.tooltipEle], POPUP_OPEN);
                ej2_base_4.addClass([ctrlObj.tooltipEle], POPUP_CLOSE);
                ctrlObj.tooltipEventArgs = {
                    type: e ? e.type : null, cancel: false, target: target, event: e ? e : null,
                    element: ctrlObj.tooltipEle, isInteracted: !ej2_base_3.isNullOrUndefined(e)
                };
        ...
        Tooltip.prototype.beforeOpenCallback = function (observedArgs, target, showAnimation, e) {
            ...
            if (observedArgs.cancel) {
                ...
                if (this.openDelay > 0) {
                    var show = function () {
                        if (_this.mouseTrail) {
                            ej2_base_2.EventHandler.add(target, 'mousemove touchstart mouseenter', _this.onMouseMove, _this);
                        }
                        if (_this.popupObj) {
        ...
        Tooltip.prototype.needTemplateReposition = function () {
            ...
            var tooltip = this;
            return !ej2_base_3.isNullOrUndefined(tooltip.viewContainerRef)
        ...
        Tooltip.prototype.collisionFlipFit = function (target, x, y) {
            ...
            if (elePos.position !== newpos) {
                var pos = position_1.calculatePosition(target, elePos.horizontal, elePos.vertical);
        ...
        Tooltip.prototype.onMouseOut = function (e) {
            ...
            if (enteredElement && !this.mouseTrail) {
                var checkForTooltipElement = ej2_base_4.closest(enteredElement, "." + TOOLTIP_WRAP + "." + POPUP_LIB + "." + POPUP_ROOT);
                if (checkForTooltipElement) {
                    ej2_base_2.EventHandler.add(checkForTooltipElement, 'mouseleave', this.tooltipElementMouseOut, this);
                }
                else {
                    this.hideTooltip(this.animation.close, e, this.findTarget());
                    if (this.closeDelay === 0) {
        ...
        Tooltip.prototype.tooltipElementMouseOut = function (e) {
            this.hideTooltip(this.animation.close, e, this.findTarget());
            ej2_base_2.EventHandler.remove(this.element, 'mouseleave', this.tooltipElementMouseOut);
            this.clear();
        };
        ...
        Tooltip.prototype.touchEnd = function (e) {
            if (this.tooltipEle && ej2_base_4.closest(e.target, '.' + ROOT) === null && !this.isSticky) {
                this.close();
            }
        };
        Tooltip.prototype.scrollHandler = function (e) {
            if (this.tooltipEle) {
                if (!(ej2_base_4.closest(e.target, "." + TOOLTIP_WRAP + "." + POPUP_LIB + "." + POPUP_ROOT))) {
                    this.close();
                }
            }
        };
                ...
                if (opensOn === 'Hover') {
                    if (ej2_base_2.Browser.isDevice) {
                        ...
                        if (this.isServerRender() && !this.isSticky) {
                            ej2_base_2.EventHandler.add(this.element, 'mouseleave', this.onMouseOut, this);
                        }
                    }
                }
            }
            ej2_base_2.EventHandler.add(document, 'touchend', this.touchEnd, this);
            ej2_base_2.EventHandler.add(document, 'scroll wheel', this.scrollHandler, this);
        ...
        Tooltip.prototype.wireMouseEvents = function (e, target) {
            if (this.tooltipEle) {
                if (!this.isSticky) {
                    ...
                    if (this.closeDelay) {
                        ej2_base_2.EventHandler.add(this.tooltipEle, 'mouseenter', this.tooltipHover, this);
                        ej2_base_2.EventHandler.add(this.tooltipEle, 'mouseleave', this.tooltipMouseOut, this);
                    }
                }
            ...
            for (var _i = 0, triggerList_2 = triggerList; _i < triggerList_2.length; _i++) {
                ...
                if (opensOn === 'Hover') {
                    if (ej2_base_2.Browser.isDevice) {
                        ...
                        if (this.isServerRender() && !this.isSticky) {
                            ej2_base_2.EventHandler.remove(this.element, 'mouseleave', this.onMouseOut);
                        }
                    }
                }
            }
            ej2_base_2.EventHandler.remove(document, 'touchend', this.touchEnd);
            ej2_base_2.EventHandler.remove(document, 'scroll wheel', this.scrollHandler);
        ...
        Tooltip.prototype.unwireMouseEvents = function (target) {
            if (!this.isSticky) {
                ...
                if (this.closeDelay) {
                    ej2_base_2.EventHandler.remove(target, 'mouseenter', this.tooltipHover);
                    ej2_base_2.EventHandler.remove(target, 'mouseleave', this.tooltipMouseOut);
                }
            }
            if (this.mouseTrail) {
                ...
                switch (prop) {
                    case 'width':
                        if (this.tooltipEle && targetElement) {
                            this.tooltipEle.style.width = this.tooltipEle.style.maxWidth = ej2_base_3.formatUnit(newProp.width);
        ...
        Tooltip.prototype.open = function (element, animation) {
            if (ej2_base_3.isNullOrUndefined(animation)) {
