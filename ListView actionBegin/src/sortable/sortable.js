...
define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base"], function (require, exports, ej2_base_1, ej2_base_2, ej2_base_3) {
    ...
    var Sortable = (function (_super) {
        ...
        function Sortable(element, options) {
            ...
            _this.getHelper = function (e) {
                ...
                ej2_base_3.addClass([element], ['e-sortableclone']);
            ...
            _this.onDrag = function (e) {
                ...
                if ((_this.isValidTarget(target, newInst) || e.target.className.indexOf('e-list-group-item') > -1) && (_this.curTarget !== target ||
                    !ej2_base_3.isNullOrUndefined(newInst.placeHolder)) && (newInst.placeHolderElement ? newInst.placeHolderElement !== e.target :
                    true)) {
                    ...
                    var newIdx = void 0;
                    if (placeHolder) {
                        oldIdx = ej2_base_3.isNullOrUndefined(oldIdx) ? _this.getIndex(_this.target) : oldIdx;
                        ...
                        if (isPlaceHolderPresent) {
                            ej2_base_2.remove(newInst.placeHolderElement);
                        }
                        ...
                        oldIdx = ej2_base_3.isNullOrUndefined(oldIdx) ? _this.getIndex(_this.target) :
                ...
                if (ej2_base_3.isNullOrUndefined(target) && e.target !== newInst.placeHolderElement) {
            ...
            _this.onDragStop = function (e) {
                ...
                if (isPlaceHolderPresent) {
                    ...
                    _this.trigger('beforeDrop', args, function (observedArgs) {
                        ...
                        ej2_base_2.remove(dropInst.placeHolderElement);
                    });
                }
                ...
                ej2_base_3.getComponent(_this.element, ej2_base_2.Draggable).intDestroy(e.event);
            };
            _this.bind();
            return _this;
        }
        ...
        Sortable.prototype.bind = function () {
            if (!this.element.id) {
                this.element.id = ej2_base_1.getUniqueID('sortable');
            }
            if (!this.itemClass) {
        ...
        Sortable.prototype.initializeDraggable = function () {
            new ej2_base_2.Draggable(this.element, {
        ...
        Sortable.prototype.isValidTarget = function (target, instance) {
            return target && ej2_base_2.compareElementParent(target, instance.element) && target.classList.contains(instance.itemClass) &&
                !target.classList.contains('e-disabled');
        };
        Sortable.prototype.removePlaceHolder = function (instance) {
            ej2_base_2.remove(instance.placeHolderElement);
        ...
        Sortable.prototype.getSortableInstance = function (element) {
            element = ej2_base_2.closest(element, ".e-" + this.getModuleName());
            if (element) {
                var inst = ej2_base_3.getComponent(element, Sortable_1);
        ...
        Sortable.prototype.getIndex = function (target, instance, e) {
            ...
            [].slice.call(instance.element.children).forEach(function (element, index) {
                ...
                if (element === target) {
                    idx = index;
                    if (!ej2_base_3.isNullOrUndefined(e)) {
        ...
        Sortable.prototype.getSortableElement = function (element, instance) {
            if (instance === void 0) { instance = this; }
            return ej2_base_2.closest(element, "." + instance.itemClass);
        };
        ...
        Sortable.prototype.isPlaceHolderPresent = function (instance) {
            return instance.placeHolderElement && !!ej2_base_2.closest(instance.placeHolderElement, "#" + instance.element.id);
        };
        ...
        Sortable.prototype.destroy = function () {
            ...
            ej2_base_3.getComponent(this.element, ej2_base_2.Draggable).destroy();
    ...
    function moveTo(from, to, targetIndexes, insertBefore) {
        ...
        if (ej2_base_3.isNullOrUndefined(insertBefore)) {
