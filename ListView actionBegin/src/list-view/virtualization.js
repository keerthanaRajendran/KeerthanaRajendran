define(["require", "exports", "./list-view", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "../common/list-base", "@syncfusion/ej2-data"], function (require, exports, list_view_1, ej2_base_1, ej2_base_2, list_base_1, ej2_data_1) {
    "use strict";
    ...
    var Virtualization = (function () {
        ...
        Virtualization.prototype.uiVirtualization = function () {
            ...
            if (!(ej2_base_2.isBlazor() || this.listViewInstance.isServerRendered)) {
                this.listViewInstance.ulElement = this.listViewInstance.curUL = list_base_1.ListBase.createList(this.listViewInstance.createElement, firstDs, this.listViewInstance.listBaseOption, null, this);
                this.listViewInstance.contentContainer = this.listViewInstance.createElement('div', { className: list_view_1.classNames.content });
            ...
            if (!(ej2_base_2.isBlazor() || this.listViewInstance.isServerRendered)) {
                var listItems = list_base_1.ListBase.createListItemFromJson(this.listViewInstance.createElement, otherDs, this.listViewInstance.listBaseOption, null, null, this);
        ...
        Virtualization.prototype.wireScrollEvent = function (destroy) {
            if (!destroy) {
                if (!(ej2_base_2.isBlazor() && this.listViewInstance.isServerRendered)) {
                    ...
                    if (this.listViewInstance.isWindow) {
                        this.onVirtualScroll = ej2_base_2.debounce(this.onVirtualUiScroll.bind(this), 350);
                        this.updateUl = this.updateUlContainer.bind(this);
                        window.addEventListener('scroll', this.onVirtualScroll);
                        window.addEventListener('scroll', this.updateUl);
                    }
                    else {
                        ej2_base_1.EventHandler.add(this.listViewInstance.element, 'scroll', ej2_base_2.debounce(this.onVirtualUiScroll, 350), this);
                        ej2_base_1.EventHandler.add(this.listViewInstance.element, 'scroll', this.updateUlContainer, this);
                    }
                }
            }
            else {
                ...
                this.listViewInstance.isWindow ? window.removeEventListener('scroll', this.updateUl) :
                    ej2_base_1.EventHandler.remove(this.listViewInstance.element, 'scroll', this.updateUlContainer);
            }
        };
        Virtualization.prototype.updateUlContainer = function (e) {
            var listDiff;
            var virtualElementContainer = this.listViewInstance.ulElement.querySelector('.' + list_view_1.classNames.virtualElementContainer);
            if (ej2_base_1.isNullOrUndefined(this.listViewInstance.liElementHeight)) {
        ...
        Virtualization.prototype.uiIndicesInitialization = function () {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                if (!ej2_base_1.isNullOrUndefined(data[i][this.listViewInstance.fields.enabled]) && !data[i][this.listViewInstance.fields.enabled]) {
        ...
        Virtualization.prototype.updateUiContent = function (element, index) {
            ...
            if (typeof this.listViewInstance.dataSource[0] === 'string' ||
                ...
                element.dataset.uid = curViewDs[index][this.listViewInstance.fields.id] ?
                    curViewDs[index][this.listViewInstance.fields.id].toString() : list_base_1.ListBase.generateId();
                element.getElementsByClassName(list_view_1.classNames.listItemText)[0].innerHTML =
            ...
            if (this.listViewInstance.showIcon) {
                ...
                if (this.listViewInstance.curViewDS[index][this.listViewInstance.fields.iconCss]) {
                    ...
                    var target = this.listViewInstance.createElement('div', {
                        className: list_view_1.classNames.listIcon + ' ' +
            ...
            if (this.listViewInstance.showCheckBox && this.listViewInstance.fields.groupBy) {
                ...
                if (this.listViewInstance.curViewDS[index].isHeader) {
                    ...
                    if (!element.querySelector('.' + list_view_1.classNames.checkboxWrapper)) {
                        ...
                        textContent.insertBefore(this.checkListWrapper.cloneNode(true), element.querySelector('.' + list_view_1.classNames.listItemText));
                    }
                }
            }
        };
        ...
        Virtualization.prototype.selectItem = function (obj) {
            ...
            else if (ej2_base_1.isNullOrUndefined(obj) && !this.listViewInstance.showCheckBox) {
                this.listViewInstance.removeSelect();
        ...
        Virtualization.prototype.setCheckboxLI = function (li, e) {
            ...
            if (li.classList.contains(list_view_1.classNames.selected)) {
        ...
        Virtualization.prototype.createAndInjectNewItem = function (itemData, index) {
            var target;
            var li = list_base_1.ListBase.createListItemFromJson(this.listViewInstance.createElement, [itemData], this.listViewInstance.listBaseOption, null, null, this);
            if ((Object.keys(this.listViewInstance.curViewDS).length - 1) === index) {
                target = this.listViewInstance.curUL.lastElementChild;
            }
            else {
        ...
        Virtualization.prototype.createUIItem = function (args) {
            ...
            if (this.listViewInstance.showCheckBox) {
                ...
                if ((!ej2_base_1.isNullOrUndefined(this.listViewInstance.virtualCheckBox)) &&
        ...
        Virtualization.prototype.onChange = function (newData, listElement) {
            ...
            if (!ej2_base_1.isNullOrUndefined(newData.isHeader) && newData.isHeader && listElement.context.type === 'groupList') {
                var element = listElement.firstElementChild;
                ej2_base_1.detach(listElement.firstElementChild);
                ...
                var _loop_1 = function (i) {
                    ...
                    subNode.onChange = function (value) {
                        if (subNode.bindedvalue) {
                            ej2_base_1.removeClass([element], subNode.bindedvalue.split(' ').filter(function (css) { return css; }));
                        }
                        var newCss = classFunction(value);
                        if (newCss) {
                            ej2_base_1.addClass([element], (newCss).split(' ').filter(function (css) { return css; }));
                        }
                    ...
                    if (subNode.bindedvalue) {
                        ej2_base_1.addClass([element], subNode.bindedvalue.split(' ').filter(function (css) { return css; }));
                    }
        ...
        Virtualization.prototype.updateUI = function (element, index, targetElement) {
            ...
            if (this.listViewInstance.template || this.listViewInstance.groupTemplate) {
                ...
                element.dataset.uid = curViewDS[this.listViewInstance.fields.id] ?
                    curViewDS[this.listViewInstance.fields.id].toString() : list_base_1.ListBase.generateId();
