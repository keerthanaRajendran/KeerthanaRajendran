...
gulp.task('ci-report', function (done) {
    var jenkinUrl = process.env.JOB_URL.replace('jenkins.syncfusion.com',
        process.env.GITLAB_USER + ':' + process.env.JENKINS_GITLAB_TOKEN + '@jenkins.syncfusion.com');
...
gulp.task('ci-test', function (done) {
    ...
    runSequence('css-validation', 'lint', 'pre-push', done);
});
...
gulp.task('ci-publish', function (done) {
    ...
    var changelog = 'publish-changelog';
    var github = 'publish-github-source';
    runSequence('release', changelog, github, publish, registry, 'publish-ej2', 'publish-resources',
