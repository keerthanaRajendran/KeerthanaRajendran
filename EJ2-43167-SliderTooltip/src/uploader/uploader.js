...
define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-popups", "@syncfusion/ej2-base"], function (require, exports, ej2_base_1, ej2_base_2, ej2_base_3, ej2_base_4, ej2_popups_1, ej2_base_5) {
    "use strict";
    ...
    var Uploader = /** @class */ (function (_super) {
        ...
        Uploader.prototype.setLocalizedTexts = function () {
            if (ej2_base_1.isNullOrUndefined(this.template)) {
                if (typeof (this.buttons.browse) === 'string') {
                    ...
                    if (this.uploadWrapper && !ej2_base_1.isNullOrUndefined(this.uploadWrapper.querySelector('.' + DROP_AREA))) {
        ...
        Uploader.prototype.preRender = function () {
            ...
            this.preLocaleObj = ej2_base_3.getValue('currentLocale', this.l10n);
            this.isServerBlazor = (ej2_base_5.isBlazor() && this.isServerRendered) ? true : false;
            this.isBlazorTemplate = this.isServerBlazor && this.template !== '' && !ej2_base_1.isNullOrUndefined(this.template) ? true : false;
            this.isBlazorSaveUrl = (this.isServerRendered &&
                (this.asyncSettings.saveUrl === '' || ej2_base_1.isNullOrUndefined(this.asyncSettings.saveUrl))) ? true : false;
            ...
            if (!this.isServerBlazor) {
                ...
                if (ejInstance[0].isPureReactComponent) {
                    if (!ej2_base_1.isNullOrUndefined(ejInstance[0].props.name)) {
                        this.element.setAttribute('name', ejInstance[0].props.name);
                    }
                    else if (!ej2_base_1.isNullOrUndefined(ejInstance[0].props.id) && ej2_base_1.isNullOrUndefined(ejInstance[0].props.name)) {
            ...
            this.browserName = ej2_base_4.Browser.info.name;
            this.uploaderName = this.element.getAttribute('name');
        };
        Uploader.prototype.formRendered = function () {
            var parentEle = ej2_base_4.closest(this.element, 'form');
            if (!ej2_base_1.isNullOrUndefined(parentEle)) {
        ...
        Uploader.prototype.render = function () {
            if (!this.isServerBlazor) {
                ...
                this.dropAreaWrapper = ej2_base_4.closest(this.element, '.' + DROP_WRAPPER);
                this.uploadWrapper = ej2_base_4.closest(this.element, '.e-upload.e-control-wrapper');
        ...
        Uploader.prototype.renderPreLoadFiles = function () {
            if (this.files.length) {
                ...
                if (ej2_base_1.isNullOrUndefined(this.files[0].size)) {
                    return;
                }
        ...
        Uploader.prototype.setDropArea = function () {
            ...
            else if (!ej2_base_1.isNullOrUndefined(this.uploaderOptions) && this.uploaderOptions.dropArea === undefined) {
                this.createDropTextHint();
                    ...
                    if (wrapperAttr.indexOf(pro) > -1) {
                        if (pro === 'class') {
                            ...
                            if (updatedClassValues !== '') {
                                ej2_base_3.addClass([this.uploadWrapper], updatedClassValues.split(' '));
                            }
                        }
                        else if (pro === 'style') {
                            var uploadStyle = this.uploadWrapper.getAttribute(pro);
                            uploadStyle = !ej2_base_1.isNullOrUndefined(uploadStyle) ? (uploadStyle + this.htmlAttributes[pro]) :
        ...
        Uploader.prototype.setCSSClass = function (oldCSSClass) {
            ...
            if (!ej2_base_1.isNullOrUndefined(this.cssClass) && updatedCssClassValue !== '') {
                ej2_base_3.addClass([this.uploadWrapper], updatedCssClassValue.split(updatedCssClassValue.indexOf(',') > -1 ? ',' : ' '));
            }
            var updatedOldCssClass = oldCSSClass;
            if (!ej2_base_1.isNullOrUndefined(oldCSSClass)) {
                updatedOldCssClass = (oldCSSClass.replace(/\s+/g, ' ')).trim();
            }
            if (!ej2_base_1.isNullOrUndefined(oldCSSClass) && updatedOldCssClass !== '') {
                ej2_base_3.removeClass([this.uploadWrapper], updatedOldCssClass.split(' '));
            }
        };
            ...
            switch (e.action) {
                case 'enter':
                    if (e.target === this.clearButton) {
                        ...
                        var metaData = this.getCurrentMetaData(null, e);
                        if (!ej2_base_1.isNullOrUndefined(metaData)) {
        ...
        Uploader.prototype.getCurrentMetaData = function (fileInfo, e) {
            var fileData;
            var targetMetaData;
            if (ej2_base_1.isNullOrUndefined(fileInfo)) {
                var target = e.target.parentElement;
        ...
        Uploader.prototype.bindDropEvents = function () {
            if (this.dropZoneElement) {
                ...
                ej2_base_1.EventHandler.add(this.dropZoneElement, 'paste', this.onPasteFile, this);
            }
        };
        ...
        Uploader.prototype.removeFiles = function (args) {
            ...
            if (ej2_base_1.isNullOrUndefined(fileData)) {
                return;
            }
            if (args.target.classList.contains(ABORT_ICON) && !formUpload) {
                ...
                if (!ej2_base_1.isNullOrUndefined(liElement)) {
                    ...
                    ej2_popups_1.createSpinner({ target: spinnerTarget, width: '20px' });
                    ej2_popups_1.showSpinner(spinnerTarget);
                }
                if (this.sequentialUpload) {
                    /* istanbul ignore next */
            ...
            else if (!ej2_base_4.closest(args.target, '.' + SPINNER_PANE)) {
        ...
        Uploader.prototype.removeFilesData = function (file, customTemplate) {
            ...
            this.filesData.splice(index, 1);
            if (!this.isBlazorSaveUrl) {
                if (this.fileList.length === 0 && !ej2_base_1.isNullOrUndefined(this.listParent)) {
                    ej2_base_2.detach(this.listParent);
                    this.listParent = null;
                    this.removeActionButtons();
                }
        ...
        Uploader.prototype.removeUploadedFile = function (file, eventArgs, removeDirectly, custom) {
            ...
            var ajax = new ej2_base_4.Ajax(this.asyncSettings.removeUrl, 'POST', true, null);
            ajax.emitError = false;
            var formData = new FormData();
            ajax.beforeSend = function (e) {
                eventArgs.currentRequest = ajax.httpRequest;
                if (ej2_base_5.isBlazor()) {
            ...
            if (this.isServerBlazor) {
                ...
                if (!ej2_base_1.isNullOrUndefined(selectedFiles.rawFile) && selectedFiles.rawFile !== '') {
        ...
        Uploader.prototype.removingEventCallback = function (eventArgs, formData, selectedFiles, file) {
            ...
            if (!ej2_base_1.isNullOrUndefined(liElement) && (!ej2_base_1.isNullOrUndefined(liElement.querySelector('.' + DELETE_ICON)) ||
                !ej2_base_1.isNullOrUndefined(liElement.querySelector('.' + REMOVE_ICON)))) {
            ...
            if (!this.isServerBlazor) {
                if (eventArgs.postRawFile && !ej2_base_1.isNullOrUndefined(selectedFiles.rawFile) && selectedFiles.rawFile !== '') {
        ...
        Uploader.prototype.removeFailed = function (e, files, customTemplate) {
            ...
            if (!ej2_base_1.isNullOrUndefined(liElement) && !ej2_base_1.isNullOrUndefined(liElement.querySelector('.' + DELETE_ICON))) {
                ...
                ej2_popups_1.hideSpinner(spinnerTarget);
                ej2_base_2.detach(liElement.querySelector('.e-spinner-pane'));
            }
        };
        /* istanbul ignore next */
        ...
        targetFiles, file, i, fileData, directory, paste) {
            var fileName = directory ? targetFiles[i].path.substring(1, targetFiles[i].path.length) : paste ?
                ej2_base_4.getUniqueID(file.name.substring(0, file.name.lastIndexOf('.'))) + '.' + this.getFileType(file.name) :
            ...
            var fileDetails = {
                ...
                statusCode: '1',
                id: ej2_base_4.getUniqueID(file.name.substring(0, file.name.lastIndexOf('.'))) + '.' + this.getFileType(file.name)
            };
            /* istanbul ignore next */
            if (paste) {
        ...
        Uploader.prototype.allowUpload = function () {
            ...
            if (this.isForm && (!ej2_base_1.isNullOrUndefined(this.asyncSettings.saveUrl) && this.asyncSettings.saveUrl !== '')) {
        ...
        Uploader.prototype.isFormUpload = function () {
            ...
            if (this.isForm && ((ej2_base_1.isNullOrUndefined(this.asyncSettings.saveUrl) || this.asyncSettings.saveUrl === '')
                && (ej2_base_1.isNullOrUndefined(this.asyncSettings.removeUrl) || this.asyncSettings.removeUrl === ''))) {
                isFormUpload = true;
            }
            return isFormUpload;
        };
        Uploader.prototype.clearData = function (singleUpload) {
            if (!ej2_base_1.isNullOrUndefined(this.listParent) && !(this.isBlazorSaveUrl || this.isBlazorTemplate)) {
                ej2_base_2.detach(this.listParent);
                this.listParent = null;
            }
        ...
        Uploader.prototype.createCustomfileList = function (fileData) {
            this.createParentUL();
            ej2_base_5.resetBlazorTemplate(this.element.id + 'Template', 'Template');
            for (var _i = 0, fileData_1 = fileData; _i < fileData_1.length; _i++) {
                ...
                ej2_base_2.append(fromElements, liElement);
                var eventArgs = {
                    element: liElement,
                    fileInfo: listItem,
                    index: index,
            ...
            ej2_base_5.updateBlazorTemplate(this.element.id + 'Template', 'Template', this, false);
        };
        ...
        Uploader.prototype.formFileList = function (fileData, files) {
            ...
            if (ej2_base_1.isNullOrUndefined(fileList.querySelector('.e-icons'))) {
        ...
        Uploader.prototype.formCustomFileList = function (fileData, files) {
            ...
            var index = this.listParent.querySelectorAll('li').length;
            ej2_base_2.append(fromElements, fileList);
            if (!fileList.classList.contains(INVALID_FILE)) {
                this.createFormInput(fileData);
            }
            var eventArgs = {
        ...
        Uploader.prototype.getLiElement = function (files) {
            var index;
            for (var i = 0; i < this.filesData.length; i++) {
                if ((!ej2_base_1.isNullOrUndefined(this.filesData[i].id) && !ej2_base_1.isNullOrUndefined(files.id)) ? (this.filesData[i].name === files.name &&
        ...
        Uploader.prototype.uploadInProgress = function (e, files, customUI, request) {
            var li = this.getLiElement(files);
            if (ej2_base_1.isNullOrUndefined(li) && (!customUI)) {
                return;
            }
            if (!ej2_base_1.isNullOrUndefined(li)) {
                /* istanbul ignore next */
                ...
                this.trigger('canceling', eventArgs, function (eventArgs) {
                    if (eventArgs.cancel) {
                        ...
                        if (!ej2_base_1.isNullOrUndefined(li)) {
                            ...
                            if (!ej2_base_1.isNullOrUndefined(spinnerTarget)) {
                                ej2_popups_1.hideSpinner(spinnerTarget);
                                ej2_base_2.detach(li.querySelector('.e-spinner-pane'));
                            }
                        }
                    }
                    else {
                        ...
                        if (files.statusCode === '5') {
                            ...
                            var ajax = new ej2_base_4.Ajax(_this.asyncSettings.removeUrl, 'POST', true, null);
                            ajax.emitError = false;
        ...
        Uploader.prototype.removecanceledFile = function (e, file) {
            var liElement = this.getLiElement(file);
            if (liElement.querySelector('.' + RETRY_ICON) || ej2_base_1.isNullOrUndefined(liElement.querySelector('.' + ABORT_ICON))) {
                return;
            }
        ...
        Uploader.prototype.renderFailureState = function (e, file, liElement) {
            ...
            if (!ej2_base_1.isNullOrUndefined(liElement.querySelector('.e-file-status'))) {
                liElement.querySelector('.e-file-status').classList.add(UPLOAD_FAILED);
            }
            var deleteIcon = liElement.querySelector('.' + ABORT_ICON);
            if (ej2_base_1.isNullOrUndefined(deleteIcon)) {
                return;
            }
        ...
        Uploader.prototype.reloadcanceledFile = function (e, file, liElement, custom) {
            ...
            if (!custom) {
                ...
                if (!ej2_base_1.isNullOrUndefined(liElement.querySelector('.' + RETRY_ICON))) {
                    ej2_base_2.detach(liElement.querySelector('.' + RETRY_ICON));
                }
        ...
        Uploader.prototype.serverRemoveIconBindEvent = function () {
            if (this.uploadWrapper && this.isBlazorSaveUrl) {
                ...
                for (var i = 0; i < iconElement.length; i++) {
                    ...
                    if (removeIconEle) {
                        ej2_base_1.EventHandler.remove(removeIconEle, 'click', this.removeFiles);
                        ej2_base_1.EventHandler.add(removeIconEle, 'click', this.removeFiles, this);
                    }
                }
            }
        };
        Uploader.prototype.raiseSuccessEvent = function (e, file) {
            ...
            if (!this.isBlazorSaveUrl) {
                ...
                if (!ej2_base_1.isNullOrUndefined(liElement)) {
                    ...
                    if (!ej2_base_1.isNullOrUndefined(spinnerEle)) {
                        ej2_popups_1.hideSpinner(liElement);
                        ej2_base_2.detach(spinnerEle);
                    }
                }
            }
        ...
        Uploader.prototype.setExtensions = function (extensions) {
            if (extensions !== '' && !ej2_base_1.isNullOrUndefined(extensions)) {
        ...
        Uploader.prototype.checkHTMLAttributes = function (isDynamic) {
            var attributes = isDynamic ? ej2_base_1.isNullOrUndefined(this.htmlAttributes) ? [] : Object.keys(this.htmlAttributes) :
                ['accept', 'multiple', 'disabled'];
            for (var _i = 0, attributes_1 = attributes; _i < attributes_1.length; _i++) {
                var prop = attributes_1[_i];
                if (!ej2_base_1.isNullOrUndefined(this.element.getAttribute(prop))) {
                    switch (prop) {
                        case 'accept':
                            // tslint:disable-next-line
                            if ((ej2_base_1.isNullOrUndefined(this.uploaderOptions) || (this.uploaderOptions['allowedExtensions'] === undefined))
                                || isDynamic) {
                        ...
                        case 'multiple':
                            // tslint:disable-next-line
                            if ((ej2_base_1.isNullOrUndefined(this.uploaderOptions) || (this.uploaderOptions['multiple'] === undefined)) || isDynamic) {
                        ...
                        case 'disabled':
                            // tslint:disable-next-line
                            if ((ej2_base_1.isNullOrUndefined(this.uploaderOptions) || (this.uploaderOptions['enabled'] === undefined)) || isDynamic) {
        ...
        Uploader.prototype.sendRequest = function (file, metaData, custom, fileIndex) {
            ...
            var ajax = new ej2_base_4.Ajax({ url: this.asyncSettings.saveUrl, type: 'POST', async: true, contentType: null });
            ajax.emitError = false;
        ...
        Uploader.prototype.checkChunkUpload = function () {
            return (this.asyncSettings.chunkSize <= 0 || ej2_base_1.isNullOrUndefined(this.asyncSettings.chunkSize)) ? false : true;
        };
        Uploader.prototype.chunkUploadComplete = function (e, metaData, custom) {
            ...
            if (response.readyState === 4 && response.status >= 200 && response.status < 300) {
                ...
                if (ej2_base_1.isNullOrUndefined(custom) || !custom) {
                ...
                if (metaData.file.statusCode === '5') {
                    ...
                    this.trigger('canceling', eventArgs_1, function (eventArgs) {
                        ...
                        if (eventArgs.cancel) {
                            metaData.file.statusCode = '3';
                            var spinnerTarget = liElement.querySelector('.' + ABORT_ICON);
                            if (!ej2_base_1.isNullOrUndefined(liElement) && !ej2_base_1.isNullOrUndefined(spinnerTarget)) {
                                ej2_popups_1.hideSpinner(spinnerTarget);
                                ej2_base_2.detach(liElement.querySelector('.e-spinner-pane'));
                            }
                    ...
                    if ((totalChunk - 1) === metaData.chunkIndex && totalChunk > metaData.chunkIndex) {
                        ...
                        if (ej2_base_1.isNullOrUndefined(this.template) && (ej2_base_1.isNullOrUndefined(custom) || !custom) && liElement) {
                            if (liElement) {
                                ej2_base_2.detach(liElement.querySelector('.' + PAUSE_UPLOAD));
                            }
        ...
        Uploader.prototype.removeChunkFile = function (e, metaData, custom) {
            if (ej2_base_1.isNullOrUndefined(this.template) && (ej2_base_1.isNullOrUndefined(custom) && !custom)) {
                ...
                if (!ej2_base_1.isNullOrUndefined(liElement) && !ej2_base_1.isNullOrUndefined(deleteIcon)) {
                    ej2_popups_1.hideSpinner(spinnerTarget);
                    ej2_base_2.detach(liElement.querySelector('.e-spinner-pane'));
                }
            }
        ...
        Uploader.prototype.resumeUpload = function (metaData, e, custom) {
            ...
            if (!ej2_base_1.isNullOrUndefined(targetElement) && (ej2_base_1.isNullOrUndefined(custom) || !custom)) {
        ...
        Uploader.prototype.removeChunkProgressBar = function (metaData) {
            ...
            if (!ej2_base_1.isNullOrUndefined(liElement)) {
                ...
                if (!ej2_base_1.isNullOrUndefined(cancelButton)) {
                ...
                if (!eventArgs.cancel) {
                    if (metaData.retryCount < _this.asyncSettings.retryCount) {
                        ...
                        if (!ej2_base_1.isNullOrUndefined(liElement)) {
                            ...
                            if (!ej2_base_1.isNullOrUndefined(pauseButton)) {
                            ...
                            if (!ej2_base_1.isNullOrUndefined(liElement.querySelector('.' + PAUSE_UPLOAD))) {
                                ej2_base_2.detach(liElement.querySelector('.' + PAUSE_UPLOAD));
                            }
                            if (metaData.start > 0) {
                                iconElement.classList.add(DELETE_ICON);
        ...
        Uploader.prototype.chunkUploadInProgress = function (e, metaData, custom) {
            ...
            var target;
            var retryElement = liElement.querySelector('.' + RETRY_ICON);
            if (!ej2_base_1.isNullOrUndefined(retryElement)) {
            ...
            if (!ej2_base_1.isNullOrUndefined(liElement)) {
                if (!(liElement.querySelectorAll('.' + PROGRESS_WRAPPER).length > 0)) {
                    ...
                    if (!ej2_base_1.isNullOrUndefined(clearIcon)) {
                        clearIcon.classList.add(ABORT_ICON);
                        clearIcon.setAttribute('title', this.localizedTexts('abort'));
                        clearIcon.classList.remove(REMOVE_ICON);
                    }
                }
                if (!isNaN(Math.round((e.loaded / e.total) * 100)) && ej2_base_1.isNullOrUndefined(this.template) && metaData.file.statusCode !== '4') {
            ...
            if (ej2_base_1.isNullOrUndefined(liElement.querySelector('.' + PAUSE_UPLOAD)) && ej2_base_1.isNullOrUndefined(this.template)) {
        ...
        Uploader.prototype.destroy = function () {
            ...
            if (!this.isServerBlazor) {
                if (!ej2_base_1.isNullOrUndefined(this.uploadWrapper)) {
        ...
        Uploader.prototype.uploadFilesRequest = function (selectedFiles, i, custom) {
            ...
            var ajax = new ej2_base_4.Ajax(this.asyncSettings.saveUrl, 'POST', true, null);
            ajax.emitError = false;
            var getFileData;
            /* istanbul ignore next */
            if (this.isServerBlazor) {
        ...
        Uploader.prototype.remove = function (fileData, customTemplate, removeDirectly, postRawFile, args) {
            var _this = this;
            if (ej2_base_1.isNullOrUndefined(postRawFile)) {
                postRawFile = true;
            }
            var eventArgs = {
                event: args,
            ...
            this.trigger('beforeRemove', beforeEventArgs, function (beforeEventArgs) {
                if (!beforeEventArgs.cancel) {
                    ...
                    if (_this.isFormUpload() && !_this.isBlazorSaveUrl) {
                        ...
                        _this.trigger('removing', eventArgs, function (eventArgs) {
                            if (!eventArgs.cancel) {
                                ...
                                for (var _i = 0, removingFiles_1 = removingFiles; _i < removingFiles_1.length; _i++) {
                                    ...
                                    if (liIndex > -1) {
                                        var inputElement = !ej2_base_1.isNullOrUndefined(data.input) ? data.input : null;
                                        if (inputElement) {
                                            ej2_base_2.detach(inputElement);
                                        }
                                        _this.spliceFiles(liIndex);
                                        ej2_base_2.detach(_this.fileList[liIndex]);
                    ...
                    else if (_this.isForm && (ej2_base_1.isNullOrUndefined(_this.asyncSettings.removeUrl) || _this.asyncSettings.removeUrl === '')
                        ...
                        var removeFiles = [];
                        fileData = !ej2_base_1.isNullOrUndefined(fileData) ? fileData : _this.filesData;
        ...
        Uploader.prototype.getFiles = function (fileData) {
            var files = [];
            if (!ej2_base_1.isNullOrUndefined(fileData) && !(fileData instanceof Array)) {
                files.push(fileData);
            }
            else {
                files = fileData;
        ...
        Uploader.prototype.showHideUploadSpinner = function (files) {
            var liElement = this.getLiElement(files);
            if (!ej2_base_1.isNullOrUndefined(liElement) && ej2_base_1.isNullOrUndefined(this.template)) {
                var spinnerTarget = liElement.querySelector('.' + ABORT_ICON);
                ej2_popups_1.createSpinner({ target: spinnerTarget, width: '20px' });
                ej2_popups_1.showSpinner(spinnerTarget);
            }
