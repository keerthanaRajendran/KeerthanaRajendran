...
define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base"], function (require, exports, ej2_base_1, ej2_base_2, ej2_base_3, ej2_base_4) {
    ...
    var FormValidator = /** @class */ (function (_super) {
        ...
        function FormValidator(element, options) {
            ...
            _this.l10n = new ej2_base_4.L10n('formValidator', _this.defaultMessages, _this.locale);
            if (_this.locale) {
                _this.localeFunc();
            }
            ej2_base_3.onIntlChange.on('notifyExternalChange', _this.afterLocalization, _this);
        ...
        FormValidator.prototype.destroy = function () {
            ...
            ej2_base_3.onIntlChange.off('notifyExternalChange', this.afterLocalization);
        };
        /**
         * @private
         */
        ...
        FormValidator.prototype.refresh = function () {
            this.unwireEvents();
            this.inputElements = ej2_base_1.selectAll(this.selectQuery, this.element);
            this.wireEvents();
        };
        ...
        FormValidator.prototype.optionalValidationStatus = function (name, refer) {
            if (!this.rules[name][this.required] && !this.inputElement.value.length && !ej2_base_2.isNullOrUndefined(this.infoElement)) {
        ...
        FormValidator.prototype.getErrorElement = function (name) {
            ...
            if (!this.infoElement) {
                this.infoElement = ej2_base_1.select(this.errorElement + '.' + this.errorClass + '[for="' + name + '"]', this.element);
            }
        ...
        FormValidator.checkValidator = {
            ...
            email: function (option) {
                return exports.regex.EMAIL.test(option.value);
            },
            url: function (option) {
                return exports.regex.URL.test(option.value);
            },
            dateIso: function (option) {
                return exports.regex.DATE_ISO.test(option.value);
            },
            tel: function (option) {
                return exports.regex.PHONE.test(option.value);
            },
            creditcard: function (option) {
                return exports.regex.CREDITCARD.test(option.value);
            },
            number: function (option) {
                return !isNaN(Number(option.value)) && option.value.indexOf(' ') === -1;
            },
            digits: function (option) {
                return exports.regex.DIGITS.test(option.value);
            },
