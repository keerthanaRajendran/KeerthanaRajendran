...
define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "../../input/input", "../base/index", "../base/index", "../base/mask-base"], function (require, exports, ej2_base_1, ej2_base_2, ej2_base_3, input_1, index_1, index_2, mask_base_1) {
    "use strict";
    ...
    var MaskedTextBox = /** @class */ (function (_super) {
        ...
        MaskedTextBox.prototype.render = function () {
            if (this.element.tagName.toLowerCase() === 'input') {
                ...
                if (!ej2_base_3.Browser.isDevice && (ej2_base_3.Browser.info.version === '11.0' || ej2_base_3.Browser.info.name === 'edge')) {
                    this.element.blur();
                }
                if (ej2_base_3.Browser.isDevice && ej2_base_3.Browser.isIos) {
                    this.element.blur();
                }
        ...
        MaskedTextBox.prototype.updateCssClass = function (newClass, oldClass) {
            input_1.Input.setCssClass(this.getValidClassList(newClass), [this.inputObj.container], this.getValidClassList(oldClass));
        };
        MaskedTextBox.prototype.getValidClassList = function (maskClassName) {
            var result = maskClassName;
            if (!ej2_base_2.isNullOrUndefined(maskClassName) && maskClassName !== '') {
                    ...
                    if (wrapperAttr.indexOf(key) > -1) {
                        if (key === 'class') {
                            ...
                            if (updatedClassValues !== '') {
                                ej2_base_2.addClass([this.inputObj.container], updatedClassValues.split(' '));
                            }
                        }
                        else if (key === 'style') {
                            var maskStyle = this.inputObj.container.getAttribute(key);
                            maskStyle = !ej2_base_2.isNullOrUndefined(maskStyle) ? (maskStyle + this.htmlAttributes[key]) :
        ...
        MaskedTextBox.prototype.setWidth = function (width) {
            if (!ej2_base_2.isNullOrUndefined(width)) {
                if (typeof width === 'number') {
                    ...
                    var elementWidth = (width.match(/px|%|em/)) ? (width) : (ej2_base_2.formatUnit(width));
        ...
        MaskedTextBox.prototype.checkHtmlAttributes = function (isDynamic) {
            var attributes = isDynamic ? ej2_base_2.isNullOrUndefined(this.htmlAttributes) ? [] : Object.keys(this.htmlAttributes)
                : ['placeholder', 'disabled', 'value', 'readonly'];
            for (var _i = 0, attributes_1 = attributes; _i < attributes_1.length; _i++) {
                var key = attributes_1[_i];
                if (!ej2_base_2.isNullOrUndefined(this.element.getAttribute(key))) {
                    switch (key) {
                        case 'placeholder':
                            // tslint:disable-next-line
                            if ((ej2_base_2.isNullOrUndefined(this.maskOptions) || (this.maskOptions['placeholder'] === undefined)) || isDynamic) {
                                this.setProperties({ placeholder: this.element.placeholder }, !isDynamic);
                            }
                            break;
                        case 'disabled':
                            // tslint:disable-next-line
                            if ((ej2_base_2.isNullOrUndefined(this.maskOptions) || (this.maskOptions['enabled'] === undefined)) || isDynamic) {
                        ...
                        case 'value':
                            // tslint:disable-next-line
                            if ((ej2_base_2.isNullOrUndefined(this.maskOptions) || (this.maskOptions['value'] === undefined)) || isDynamic) {
                                this.setProperties({ value: this.element.value }, !isDynamic);
                            }
                            break;
                        case 'readonly':
                            // tslint:disable-next-line
                            if ((ej2_base_2.isNullOrUndefined(this.maskOptions) || (this.maskOptions['readonly'] === undefined)) || isDynamic) {
        ...
        MaskedTextBox.prototype.createWrapper = function () {
            ...
            if (!ej2_base_2.isNullOrUndefined(this.cssClass) && this.cssClass !== '') {
            ...
            for (var _i = 0, _a = Object.keys(newProp); _i < _a.length; _i++) {
                ...
                switch (prop) {
                    ...
                    case 'cssClass':
                        ...
                        break;
                    case 'enabled':
                        input_1.Input.setEnabled(newProp.enabled, this.element, this.floatLabelType, this.inputObj.container);
                        break;
                    case 'readonly':
                    ...
                    case 'showClearButton':
                        input_1.Input.setClearButton(newProp.showClearButton, this.element, this.inputObj, undefined, this.createElement);
        ...
        MaskedTextBox.prototype.focusIn = function () {
            if (document.activeElement !== this.element && this.enabled) {
                this.element.focus();
                ej2_base_2.addClass([this.inputObj.container], [MASKINPUT_FOCUS]);
            }
        };
        /**
        ...
        MaskedTextBox.prototype.focusOut = function () {
            if (document.activeElement === this.element && this.enabled) {
                this.element.blur();
                ej2_base_3.removeClass([this.inputObj.container], [MASKINPUT_FOCUS]);
            }
        };
        /**
