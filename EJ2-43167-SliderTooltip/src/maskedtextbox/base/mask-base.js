define(["require", "exports", "@syncfusion/ej2-base", "../../input/input"], function (require, exports, ej2_base_1, input_1) {
    ...
    function wireEvents() {
        ...
        if (this.enabled) {
            ...
            if (this.formElement) {
                ej2_base_1.EventHandler.add(this.formElement, 'reset', resetFormHandler, this);
            }
        }
    }
    ...
    function unwireEvents() {
        ...
        if (this.formElement) {
            ej2_base_1.EventHandler.remove(this.formElement, 'reset', resetFormHandler);
        }
    }
            ...
            for (var i = 0; i < this.customRegExpCollec.length; i++) {
                ...
                if (!checkMask) {
                    if ((maskValue[i] !== this.promptChar) && (!ej2_base_1.isNullOrUndefined(this.customRegExpCollec[k]) &&
                        ((this._callPasteHandler || !ej2_base_1.isNullOrUndefined(this.regExpCollec[this.customRegExpCollec[k]])) ||
    ...
    function maskInputHandler(event) {
        if (ej2_base_1.Browser.isIE === true && this.element.value === '' && this.floatLabelType === 'Never') {
            return;
        }
    ...
    function triggerMaskChangeEvent(event, oldValue) {
        ...
        if (!ej2_base_1.isNullOrUndefined(this.changeEventArgs) && !this.isInitial) {
            var eventArgs = {};
    ...
    function removeMaskError() {
        var parentElement = this.element.parentNode;
        if (!ej2_base_1.isNullOrUndefined(parentElement)) {
