...
define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "../input/input"], function (require, exports, ej2_base_1, ej2_base_2, ej2_base_3, ej2_base_4, ej2_base_5, input_1) {
    ...
    var NumericTextBox = /** @class */ (function (_super) {
        ...
        NumericTextBox.prototype.preRender = function () {
            ...
            ej2_base_3.removeClass([this.cloneElement], [CONTROL, COMPONENT, 'e-lib']);
            this.angularTagName = null;
            this.formEle = ej2_base_3.closest(this.element, 'form');
            ...
            if (!(ej2_base_5.isBlazor() && this.isServerRendered)) {
            ...
            this.validateMinMax();
            this.validateStep();
            if (this.placeholder === null && !(ej2_base_5.isBlazor() && this.isServerRendered)) {
            ...
            if (this.element.tagName.toLowerCase() === 'input') {
                if (!(ej2_base_5.isBlazor() && this.isServerRendered)) {
                    ...
                    if (this.showClearButton) {
                        ...
                        input_1.Input.wireClearBtnEvents(this.element, this.inputWrapper.clearButton, this.inputWrapper.container);
                    }
                    if (this.showSpinButton) {
                    ...
                    input_1.Input.bindInitialEvent({
        ...
        NumericTextBox.prototype.checkAttributes = function (isDynamic) {
            var attributes = isDynamic ? ej2_base_4.isNullOrUndefined(this.htmlAttributes) ? [] : Object.keys(this.htmlAttributes) :
                ...
                if (!ej2_base_4.isNullOrUndefined(this.element.getAttribute(prop))) {
                    switch (prop) {
                        case 'disabled':
                            ...
                            if ((ej2_base_4.isNullOrUndefined(this.numericOptions) || (this.numericOptions['enabled'] === undefined)) || isDynamic) {
                        ...
                        case 'readonly':
                            // tslint:disable-next-line
                            if ((ej2_base_4.isNullOrUndefined(this.numericOptions) || (this.numericOptions['readonly'] === undefined)) || isDynamic) {
                        ...
                        case 'placeholder':
                            // tslint:disable-next-line
                            if ((ej2_base_4.isNullOrUndefined(this.numericOptions) || (this.numericOptions['placeholder'] === undefined)) || isDynamic) {
                                this.setProperties({ placeholder: this.element.placeholder }, !isDynamic);
                            }
                            break;
                        case 'value':
                            // tslint:disable-next-line
                            if ((ej2_base_4.isNullOrUndefined(this.numericOptions) || (this.numericOptions['value'] === undefined)) || isDynamic) {
                                var setNumber = this.instance.getNumberParser({ format: 'n' })(this.element.getAttribute(prop));
                                this.setProperties(ej2_base_4.setValue(prop, setNumber, {}), !isDynamic);
                            }
                            break;
                        case 'min':
                            // tslint:disable-next-line
                            if ((ej2_base_4.isNullOrUndefined(this.numericOptions) || (this.numericOptions['min'] === undefined)) || isDynamic) {
                                var minValue = this.instance.getNumberParser({ format: 'n' })(this.element.getAttribute(prop));
                                if (minValue !== null && !isNaN(minValue)) {
                                    this.setProperties(ej2_base_4.setValue(prop, minValue, {}), !isDynamic);
                                }
                            }
                            break;
                        case 'max':
                            // tslint:disable-next-line
                            if ((ej2_base_4.isNullOrUndefined(this.numericOptions) || (this.numericOptions['max'] === undefined)) || isDynamic) {
                                var maxValue = this.instance.getNumberParser({ format: 'n' })(this.element.getAttribute(prop));
                                if (maxValue !== null && !isNaN(maxValue)) {
                                    this.setProperties(ej2_base_4.setValue(prop, maxValue, {}), !isDynamic);
                                }
                            }
                            break;
                        case 'step':
                            // tslint:disable-next-line
                            if ((ej2_base_4.isNullOrUndefined(this.numericOptions) || (this.numericOptions['step'] === undefined)) || isDynamic) {
                                var stepValue = this.instance.getNumberParser({ format: 'n' })(this.element.getAttribute(prop));
                                if (stepValue !== null && !isNaN(stepValue)) {
                                    this.setProperties(ej2_base_4.setValue(prop, stepValue, {}), !isDynamic);
                                }
                            }
                            break;
                        case 'style':
        ...
        NumericTextBox.prototype.updateCssClass = function (newClass, oldClass) {
            input_1.Input.setCssClass(this.getNumericValidClassList(newClass), [this.container], this.getNumericValidClassList(oldClass));
        };
        NumericTextBox.prototype.getNumericValidClassList = function (numericClassName) {
            var result = numericClassName;
            if (!ej2_base_4.isNullOrUndefined(numericClassName) && numericClassName !== '') {
                    ...
                    if (wrapperAttributes.indexOf(pro) > -1) {
                        if (pro === 'class') {
                            ...
                            if (updatedClassValue !== '') {
                                ej2_base_3.addClass([this.container], updatedClassValue.split(' '));
                            }
                        }
                        else if (pro === 'style') {
                            var numericStyle = this.container.getAttribute(pro);
                            numericStyle = !ej2_base_4.isNullOrUndefined(numericStyle) ? (numericStyle + this.htmlAttributes[pro]) :
        ...
        NumericTextBox.prototype.setElementWidth = function (width) {
            if (!ej2_base_4.isNullOrUndefined(width)) {
                if (typeof width === 'number') {
                    this.container.style.width = ej2_base_4.formatUnit(width);
                }
                else if (typeof width === 'string') {
                    this.container.style.width = (width.match(/px|%|em/)) ? (width) : (ej2_base_4.formatUnit(width));
                }
            }
        };
        /* Spinner creation */
        NumericTextBox.prototype.spinBtnCreation = function () {
            this.spinDown = input_1.Input.appendSpan(SPINICON + ' ' + SPINDOWN, this.container, this.createElement);
            ej2_base_3.attributes(this.spinDown, {
                'title': this.l10n.getConstant('decrementTitle'),
                'aria-label': this.l10n.getConstant('decrementTitle')
            });
            this.spinUp = input_1.Input.appendSpan(SPINICON + ' ' + SPINUP, this.container, this.createElement);
        ...
        NumericTextBox.prototype.clear = function (event) {
            ...
            var formElement = ej2_base_3.closest(this.element, 'form');
            if (formElement) {
        ...
        NumericTextBox.prototype.wireEvents = function () {
            ...
            if (this.enabled) {
                this.bindClearEvent();
                if (this.formEle) {
                    ej2_base_1.EventHandler.add(this.formEle, 'reset', this.resetFormHandler, this);
                }
            }
        };
        ...
        NumericTextBox.prototype.unwireEvents = function () {
            ...
            if (this.formEle) {
                ej2_base_1.EventHandler.remove(this.formEle, 'reset', this.resetFormHandler);
            }
        };
        ...
        NumericTextBox.prototype.inputHandler = function (event) {
            ...
            if ((fireFox || iOS) && ej2_base_1.Browser.isDevice) {
                this.preventHandler();
            }
            if (this.isVue) {
        ...
        NumericTextBox.prototype.getNumberOfDecimals = function (value) {
            ...
            if (EXPREGEXP.test(valueString)) {
                ...
                if (!ej2_base_4.isNullOrUndefined(result)) {
        ...
        NumericTextBox.prototype.keyPressHandler = function (event) {
            ...
            if (!ej2_base_1.Browser.isDevice && ej2_base_1.Browser.info.version === '11.0' && event.keyCode === 13) {
                var parsedInput = this.instance.getNumberParser({ format: 'n' })(this.element.value);
                this.updateValue(parsedInput, event);
                return true;
            }
        ...
        NumericTextBox.prototype.floatLabelTypeUpdate = function () {
            ...
            input_1.Input.addFloating(this.element, this.floatLabelType, this.placeholder, this.createElement);
        ...
        NumericTextBox.prototype.focusIn = function () {
            if (document.activeElement !== this.element && this.enabled) {
                this.element.focus();
                ej2_base_3.addClass([this.container], [NUMERIC_FOCUS]);
            }
        };
        /**
        ...
        NumericTextBox.prototype.focusOut = function () {
            if (document.activeElement === this.element && this.enabled) {
                this.element.blur();
                ej2_base_3.removeClass([this.container], [NUMERIC_FOCUS]);
            }
        };
        /**
        ...
        NumericTextBox.prototype.updateClearButton = function (newProp) {
            if (ej2_base_5.isBlazor()) {
                ...
                input_1.Input.setClearButton(newProp.showClearButton, this.element, this.inputWrapper, undefined, this.createElement);
                this.bindClearEvent();
            }
        };
