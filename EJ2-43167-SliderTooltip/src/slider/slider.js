...
define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-popups"], function (require, exports, ej2_base_1, ej2_base_2, ej2_base_3, ej2_base_4, ej2_base_5, ej2_popups_1) {
    "use strict";
    ...
    var TooltipData = /** @class */ (function (_super) {
        ...
        __decorate([
            ej2_base_1.Property('Before')
        ], TooltipData.prototype, "placement", void 0);
        __decorate([
            ej2_base_1.Property('Focus')
    ...
    var Slider = /** @class */ (function (_super) {
        ...
        Slider.prototype.preRender = function () {
            ...
            this.l10n = new ej2_base_2.L10n('slider', localeText, this.locale);
        ...
        Slider.prototype.formChecker = function () {
            var formElement = ej2_base_4.closest(this.element, 'form');
            if (formElement) {
                this.isForm = true;
                ...
                if (!ej2_base_5.isNullOrUndefined(this.formResetValue)) {
                    this.setProperties({ 'value': this.formResetValue }, true);
                }
                this.formResetValue = this.value;
                if (this.type === 'Range' &&
                    (ej2_base_5.isNullOrUndefined(this.formResetValue) || typeof (this.formResetValue) !== 'object')) {
                    this.formResetValue = [parseFloat(ej2_base_5.formatUnit(this.min)), parseFloat(ej2_base_5.formatUnit(this.max))];
                }
                else if (ej2_base_5.isNullOrUndefined(this.formResetValue)) {
                    this.formResetValue = parseFloat(ej2_base_5.formatUnit(this.min));
                }
        ...
        Slider.prototype.initCultureFunc = function () {
            this.internationalization = new ej2_base_2.Internationalization(this.locale);
        };
        Slider.prototype.initCultureInfo = function () {
            this.tooltipFormatInfo.format = (!ej2_base_5.isNullOrUndefined(this.tooltip.format)) ? this.tooltip.format : null;
            this.ticksFormatInfo.format = (!ej2_base_5.isNullOrUndefined(this.ticks.format)) ? this.ticks.format : null;
        };
        ...
        Slider.prototype.initialize = function () {
            ej2_base_4.addClass([this.element], classNames.root);
            this.setCSSClass();
        };
        Slider.prototype.setElementWidth = function (width) {
            if (!ej2_base_5.isNullOrUndefined(width)) {
                if (typeof width === 'number') {
                    this.sliderContainer.style.width = ej2_base_5.formatUnit(width);
                }
                else if (typeof width === 'string') {
                    this.sliderContainer.style.width = (width.match(/px|%|em/)) ? (width) : (ej2_base_5.formatUnit(width));
                }
            }
        };
        Slider.prototype.setCSSClass = function (oldCSSClass) {
            if (oldCSSClass) {
                ej2_base_4.removeClass([this.element], oldCSSClass.split(' '));
            }
            if (this.cssClass) {
                ej2_base_4.addClass([this.element], this.cssClass.split(' '));
            }
        };
        Slider.prototype.setEnabled = function () {
            if (!this.enabled) {
                ej2_base_4.addClass([this.sliderContainer], [classNames.sliderDisabled]);
                ...
                ej2_base_4.removeClass([this.sliderContainer], [classNames.sliderDisabled]);
                if (this.tooltip.isVisible && this.tooltipElement && this.tooltip.showOn === 'Always') {
        ...
        Slider.prototype.initRender = function () {
            ...
            if (!ej2_base_1.isBlazor() || !this.isServerRendered) {
                ...
                this.hiddenInput = (this.createElement('input', {
                    attrs: {
                        type: 'hidden', value: (ej2_base_5.isNullOrUndefined(this.value) ? this.min.toString() : this.value.toString()),
            ...
            if (this.type === 'Range') {
                ...
                this.value = ej2_base_5.isNullOrUndefined(this.value) ? parseFloat(ej2_base_5.formatUnit(this.min.toString())) : this.value;
            }
            this.previousVal = this.type !== 'Range' ? this.checkHandleValue(parseFloat(ej2_base_5.formatUnit(this.value.toString()))) :
                [this.checkHandleValue(parseFloat(ej2_base_5.formatUnit(this.value[0].toString()))),
                    this.checkHandleValue(parseFloat(ej2_base_5.formatUnit(this.value[1].toString())))];
            this.previousChanged = this.previousVal;
            if (!ej2_base_5.isNullOrUndefined(this.element.hasAttribute('name'))) {
            ...
            if (!ej2_base_1.isBlazor() || !this.isServerRendered) {
                ...
                if (this.readonly) {
                    ej2_base_4.addClass([this.sliderContainer], [classNames.readonly]);
                }
                else {
                    ej2_base_4.removeClass([this.sliderContainer], [classNames.readonly]);
                }
            }
        };
        ...
        Slider.prototype.setAriaAttributes = function (element) {
            ...
            var min = this.min;
            var max = this.max;
            if (!ej2_base_5.isNullOrUndefined(this.customValues) && this.customValues.length > 0) {
                min = this.customValues[0];
                max = this.customValues[this.customValues.length - 1];
            }
            if (this.type !== 'Range') {
                ej2_base_4.attributes(element, {
                    'aria-valuemin': min.toString(), 'aria-valuemax': max.toString()
                });
            }
            else {
                var range = !ej2_base_5.isNullOrUndefined(this.customValues) && this.customValues.length > 0 ?
        ...
        Slider.prototype.wireFirstHandleEvt = function (destroy) {
            if (!destroy) {
                ej2_base_1.EventHandler.add(this.firstHandle, 'mousedown touchstart', this.handleFocus, this);
                ej2_base_1.EventHandler.add(this.firstHandle, 'transitionend', this.transitionEnd, this);
                ej2_base_1.EventHandler.add(this.firstHandle, 'mouseenter touchenter', this.handleOver, this);
                ej2_base_1.EventHandler.add(this.firstHandle, 'mouseleave touchend', this.handleLeave, this);
            }
            else {
                ej2_base_1.EventHandler.remove(this.firstHandle, 'mousedown touchstart', this.handleFocus);
                ej2_base_1.EventHandler.remove(this.firstHandle, 'transitionend', this.transitionEnd);
                ej2_base_1.EventHandler.remove(this.firstHandle, 'mouseenter touchenter', this.handleOver);
                ej2_base_1.EventHandler.remove(this.firstHandle, 'mouseleave touchend', this.handleLeave);
            }
        };
        Slider.prototype.wireSecondHandleEvt = function (destroy) {
            if (!destroy) {
                ej2_base_1.EventHandler.add(this.secondHandle, 'mousedown touchstart', this.handleFocus, this);
                ej2_base_1.EventHandler.add(this.secondHandle, 'transitionend', this.transitionEnd, this);
                ej2_base_1.EventHandler.add(this.secondHandle, 'mouseenter touchenter', this.handleOver, this);
                ej2_base_1.EventHandler.add(this.secondHandle, 'mouseleave touchend', this.handleLeave, this);
            }
            else {
                ej2_base_1.EventHandler.remove(this.secondHandle, 'mousedown touchstart', this.handleFocus);
                ej2_base_1.EventHandler.remove(this.secondHandle, 'transitionend', this.transitionEnd);
                ej2_base_1.EventHandler.remove(this.secondHandle, 'mouseenter touchenter', this.handleOver);
                ej2_base_1.EventHandler.remove(this.secondHandle, 'mouseleave touchend', this.handleLeave);
            }
        };
        ...
        Slider.prototype.setEnableRTL = function () {
            if (!ej2_base_1.isBlazor() || !this.isServerRendered) {
                this.enableRtl && this.orientation !== 'Vertical' ? ej2_base_4.addClass([this.sliderContainer], classNames.rtl) :
                    ej2_base_4.removeClass([this.sliderContainer], classNames.rtl);
                ...
                if (preDir !== currDir) {
                    if (this.orientation === 'Horizontal') {
                        ej2_base_4.setStyleAttribute(this.firstHandle, { 'right': '', 'left': 'auto' });
                        if (this.type === 'Range') {
                            ej2_base_4.setStyleAttribute(this.secondHandle, { 'top': '', 'left': 'auto' });
                        }
                    }
                }
            }
            ...
            if (!ariaContent) {
                if (this.type === 'Range') {
                    if (this.enableRtl && this.orientation !== 'Vertical') {
                        content = (!ej2_base_5.isNullOrUndefined(formatInfo.format)) ? (this.formatString(handle2, formatInfo)
                            .formatString + ' - ' + this.formatString(handle1, formatInfo).formatString) :
                            (handle2.toString() + ' - ' + handle1.toString());
                    }
                    else {
                        content = (!ej2_base_5.isNullOrUndefined(formatInfo.format)) ? (this.formatString(handle1, formatInfo)
                            .formatString + ' - ' + this.formatString(handle2, formatInfo).formatString) :
                            (handle1.toString() + ' - ' + handle2.toString());
                    }
                }
                else {
                    if (!ej2_base_5.isNullOrUndefined(handle1)) {
                        content = (!ej2_base_5.isNullOrUndefined(formatInfo.format)) ?
                ...
                if (this.type === 'Range') {
                    if (this.enableRtl && this.orientation !== 'Vertical') {
                        content = (!ej2_base_5.isNullOrUndefined(this.tooltip) && !ej2_base_5.isNullOrUndefined(this.tooltip.format)) ?
        ...
        Slider.prototype.tooltipBeforeOpen = function (args) {
            ...
            if (this.tooltip.cssClass) {
                ej2_base_4.addClass([this.tooltipElement], this.tooltip.cssClass.split(' ').filter(function (css) { return css; }));
            }
        ...
        Slider.prototype.initializeTooltipProps = function () {
            ...
            [this.firstHandle, this.rangeBar, this.secondHandle].forEach(function (handle) {
                if (!ej2_base_5.isNullOrUndefined(handle)) {
        ...
        Slider.prototype.buttonTitle = function () {
            ...
            ej2_base_4.attributes(enabledRTL ? this.secondBtn : this.firstBtn, { 'aria-label': decrementTitle, title: decrementTitle });
            ej2_base_4.attributes(enabledRTL ? this.firstBtn : this.secondBtn, { 'aria-label': incrementTitle, title: incrementTitle });
        };
        ...
        Slider.prototype.renderScale = function () {
            ...
            if (ej2_base_5.Browser.isAndroid && orien === 'h') {
                this.ul.classList.add(classNames.sliderTickPosition);
            }
            var smallStep = this.ticks.smallStep;
            if (!this.ticks.showSmallTicks) {
                this.ticks.largeStep > 0 ? (smallStep = this.ticks.largeStep) :
                    (smallStep = (parseFloat(ej2_base_5.formatUnit(this.max))) - (parseFloat(ej2_base_5.formatUnit(this.min))));
            }
            else if (smallStep <= 0) {
                smallStep = parseFloat(ej2_base_5.formatUnit(this.step));
            }
            ...
            var bigNum = !ej2_base_5.isNullOrUndefined(this.customValues) && this.customValues.length > 0 && this.customValues.length - 1;
            var customStep = this.customTickCounter(bigNum);
            var count = !ej2_base_5.isNullOrUndefined(this.customValues) && this.customValues.length > 0 ?
            ...
            for (var i = 0, y = !ej2_base_5.isNullOrUndefined(this.customValues) && this.customValues.length > 0 ?
                ...
                if (islargeTick) {
                    ...
                    if (ej2_base_1.isBlazor() && this.isServerRendered && ej2_base_5.isNullOrUndefined(this.customValues)) {
                        this.updateTicksValues(start, this.ul.children[liElementPosition]);
                        liElementPosition++;
                    }
                }
                else if (ej2_base_5.isNullOrUndefined(this.customValues)) {
                ...
                if (ej2_base_5.isNullOrUndefined(this.customValues)) {
        ...
        Slider.prototype.blazortTicksValue = function (li, start, span) {
            ...
            var text = !ej2_base_5.isNullOrUndefined(this.ticks) && !ej2_base_5.isNullOrUndefined(this.ticks.format) ?
            ...
            this.trigger('renderingTicks', eventArgs, function (observedArgs) {
                ...
                if (span) {
                    if (_this.enableHtmlSanitizer) {
                        span.innerHTML = ej2_base_5.SanitizeHtmlHelper.sanitize(observedArgs.text.toString());
                    }
                    else {
        ...
        Slider.prototype.createTick = function (li, start, tickWidth) {
            ...
            if (ej2_base_5.isNullOrUndefined(this.customValues)) {
                ...
                if (this.enableHtmlSanitizer) {
                    span.innerHTML = ej2_base_5.SanitizeHtmlHelper.sanitize(start.toString());
                }
                else {
        ...
        Slider.prototype.formatTicksValue = function (li, start, spanElement, tickWidth) {
            ...
            this.trigger('renderingTicks', eventArgs, function (observedArgs) {
                ...
                if (spanElement) {
                    if (_this.enableHtmlSanitizer) {
                        spanElement.innerHTML = ej2_base_5.SanitizeHtmlHelper.sanitize(observedArgs.text.toString());
                    }
                    else {
                        spanElement.innerHTML = observedArgs.text.toString();
                    }
                }
                if (!ej2_base_5.isNullOrUndefined(_this.renderingTicks) && ej2_base_1.isBlazor()) {
        ...
        Slider.prototype.tickValuePosition = function () {
            ...
            var otherChild;
            var smallStep = this.ticks.smallStep;
            var count = Math.abs((parseFloat(ej2_base_5.formatUnit(this.max))) - (parseFloat(ej2_base_5.formatUnit(this.min)))) / smallStep;
            ...
            for (var i = 0; i < other.length; i++) {
                ...
                if (this.orientation === 'Vertical') {
                    if (!ej2_base_1.isBlazor() || !this.isServerRendered) {
                        ej2_base_4.setStyleAttribute(other[i], { top: (tickWidth - otherChild.height) / 2 + 'px' });
                    }
                }
                else {
                    ej2_base_4.setStyleAttribute(other[i], { left: (tickWidth - otherChild.width) / 2 + 'px' });
                }
            }
        ...
        Slider.prototype.setAriaAttrValue = function (element) {
            var ariaValueText;
            var isTickFormatted = ((!ej2_base_5.isNullOrUndefined(this.ticks) && !ej2_base_5.isNullOrUndefined(this.ticks.format))) ? true : false;
            ...
            if (this.type !== 'Range') {
                ej2_base_4.attributes(element, { 'aria-valuenow': valuenow, 'aria-valuetext': text });
            }
            else {
                (!this.enableRtl) ? ((element === this.firstHandle) ?
                    ej2_base_4.attributes(element, { 'aria-valuenow': valuenow.split(' - ')[0], 'aria-valuetext': ariaValueText[0] }) :
                    ej2_base_4.attributes(element, { 'aria-valuenow': valuenow.split(' - ')[1], 'aria-valuetext': ariaValueText[1] })) :
        ...
        Slider.prototype.buttonClick = function (args) {
            ...
            if (args.currentTarget.classList.contains(classNames.firstButton)) {
                ej2_base_1.EventHandler.add(this.firstBtn, 'mouseup touchend', this.buttonUp, this);
            }
            if (args.currentTarget.classList.contains(classNames.secondButton)) {
                ej2_base_1.EventHandler.add(this.secondBtn, 'mouseup touchend', this.buttonUp, this);
            }
        };
        ...
        Slider.prototype.buttonUp = function (args) {
            if (args.currentTarget.classList.contains(classNames.firstButton)) {
                ej2_base_1.EventHandler.remove(this.firstBtn, 'mouseup touchend', this.buttonUp);
            }
            if (args.currentTarget.classList.contains(classNames.secondButton)) {
                ej2_base_1.EventHandler.remove(this.secondBtn, 'mouseup touchend', this.buttonUp);
            }
        };
        Slider.prototype.setRangeBar = function () {
            if (this.orientation === 'Horizontal') {
                if (this.type === 'MinRange') {
                    ...
                    ej2_base_4.setStyleAttribute(this.rangeBar, { 'width': ej2_base_5.isNullOrUndefined(this.handlePos1) ? 0 : this.handlePos1 + 'px' });
                }
                else {
                    this.enableRtl ? (this.rangeBar.style.right =
                        this.handlePos1 + 'px') : (this.rangeBar.style.left = this.handlePos1 + 'px');
                    ej2_base_4.setStyleAttribute(this.rangeBar, { 'width': this.handlePos2 - this.handlePos1 + 'px' });
                }
            }
            else {
                if (this.type === 'MinRange') {
                    this.rangeBar.style.bottom = '0px';
                    ej2_base_4.setStyleAttribute(this.rangeBar, { 'height': ej2_base_5.isNullOrUndefined(this.handlePos1) ? 0 : this.handlePos1 + 'px' });
                }
                else {
                    this.rangeBar.style.bottom = this.handlePos1 + 'px';
                    ej2_base_4.setStyleAttribute(this.rangeBar, { 'height': this.handlePos2 - this.handlePos1 + 'px' });
                }
            }
        };
        ...
        Slider.prototype.getLimitValueAndPosition = function (currentValue, minValue, maxValue, limitBar) {
            if (ej2_base_5.isNullOrUndefined(minValue)) {
                minValue = this.min;
                if (ej2_base_5.isNullOrUndefined(currentValue) && limitBar) {
                    currentValue = minValue;
                }
            }
            if (ej2_base_5.isNullOrUndefined(maxValue)) {
                maxValue = this.max;
                if (ej2_base_5.isNullOrUndefined(currentValue) && limitBar) {
        ...
        Slider.prototype.setValue = function () {
            ...
            this.handleVal1 = ej2_base_5.isNullOrUndefined(this.value) ? this.checkHandleValue(parseFloat(this.min.toString())) :
                this.checkHandleValue(parseFloat(this.value.toString()));
            this.handlePos1 = this.checkHandlePosition(this.handleVal1);
            this.preHandlePos1 = this.handlePos1;
            ej2_base_5.isNullOrUndefined(this.activeHandle) ? (this.type === 'Range' ? this.activeHandle = 2 : this.activeHandle = 1) :
        ...
        Slider.prototype.rangeValueUpdate = function () {
            if (this.value === null || typeof (this.value) !== 'object') {
                this.value = [parseFloat(ej2_base_5.formatUnit(this.min)), parseFloat(ej2_base_5.formatUnit(this.max))];
            }
        };
        ...
        Slider.prototype.modifyZindex = function () {
            if (this.type === 'Range') {
                ...
                this.tooltipElement.style.zIndex = ej2_popups_1.getZindexPartial(this.element) + '';
            }
        };
        Slider.prototype.setHandlePosition = function (event) {
            ...
            handle.forEach(function (handle) {
                ...
                if (ej2_base_1.isBlazor() && _this.isServerRendered) {
        ...
        Slider.prototype.changeEventArgs = function (eventName, e) {
            ...
            if (this.tooltip.isVisible && this.tooltipObj && this.initialTooltip) {
                ...
                eventArgs = {
                    ...
                    action: eventName, text: this.tooltipObj.content, isInteracted: ej2_base_5.isNullOrUndefined(e) ? false : true
                };
            }
            else {
                eventArgs = {
                    value: this.value,
                    previousValue: eventName === 'change' ? this.previousVal : this.previousChanged,
                    action: eventName, text: ej2_base_5.isNullOrUndefined(this.ticksFormatInfo.format) ? this.value.toString() :
                    ...
                    isInteracted: ej2_base_5.isNullOrUndefined(e) ? false : true
                };
            }
            return eventArgs;
        };
        ...
        Slider.prototype.checkHandlePosition = function (value) {
            var pos;
            value = (100 *
                (value - (parseFloat(ej2_base_5.formatUnit(this.min))))) / ((parseFloat(ej2_base_5.formatUnit(this.max))) - (parseFloat(ej2_base_5.formatUnit(this.min))));
            if (this.orientation === 'Horizontal') {
            ...
            if (((parseFloat(ej2_base_5.formatUnit(this.max))) === (parseFloat(ej2_base_5.formatUnit(this.min))))) {
                if (this.orientation === 'Horizontal') {
        ...
        Slider.prototype.checkHandleValue = function (value) {
            ...
            if (this.min === this.max) {
                return (parseFloat(ej2_base_5.formatUnit(this.max)));
            }
        ...
        Slider.prototype.stepValueCalculation = function (value) {
            ...
            var percentStep = (parseFloat(ej2_base_5.formatUnit(this.step))) / ((parseFloat(ej2_base_5.formatUnit(this.max)) - parseFloat(ej2_base_5.formatUnit(this.min))) / 100);
        ...
        Slider.prototype.positionToValue = function (pos) {
            var val;
            var diff = parseFloat(ej2_base_5.formatUnit(this.max)) - parseFloat(ej2_base_5.formatUnit(this.min));
            if (this.orientation === 'Horizontal') {
        ...
        Slider.prototype.sliderBarUp = function (event) {
            ...
            ej2_base_1.EventHandler.remove(document, 'mousemove touchmove', this.sliderBarMove);
            ej2_base_1.EventHandler.remove(document, 'mouseup touchend', this.sliderBarUp);
        };
        ...
        Slider.prototype.wireButtonEvt = function (destroy) {
            if (!destroy) {
                ej2_base_1.EventHandler.add(this.firstBtn, 'mouseleave touchleave', this.buttonFocusOut, this);
                ej2_base_1.EventHandler.add(this.secondBtn, 'mouseleave touchleave', this.buttonFocusOut, this);
                ej2_base_1.EventHandler.add(this.firstBtn, 'mousedown touchstart', this.repeatHandlerMouse, this);
                ej2_base_1.EventHandler.add(this.firstBtn, 'mouseup mouseleave touchup touchend', this.repeatHandlerUp, this);
                ej2_base_1.EventHandler.add(this.secondBtn, 'mousedown touchstart', this.repeatHandlerMouse, this);
                ej2_base_1.EventHandler.add(this.secondBtn, 'mouseup mouseleave touchup touchend', this.repeatHandlerUp, this);
                ej2_base_1.EventHandler.add(this.firstBtn, 'focusout', this.sliderFocusOut, this);
                ej2_base_1.EventHandler.add(this.secondBtn, 'focusout', this.sliderFocusOut, this);
            }
            else {
                ej2_base_1.EventHandler.remove(this.firstBtn, 'mouseleave touchleave', this.buttonFocusOut);
                ej2_base_1.EventHandler.remove(this.secondBtn, 'mouseleave touchleave', this.buttonFocusOut);
                ej2_base_1.EventHandler.remove(this.firstBtn, 'mousedown touchstart', this.repeatHandlerMouse);
                ej2_base_1.EventHandler.remove(this.firstBtn, 'mouseup mouseleave touchup touchend', this.repeatHandlerUp);
                ej2_base_1.EventHandler.remove(this.secondBtn, 'mousedown touchstart', this.repeatHandlerMouse);
                ej2_base_1.EventHandler.remove(this.secondBtn, 'mouseup mouseleave touchup touchend', this.repeatHandlerUp);
                ej2_base_1.EventHandler.remove(this.firstBtn, 'focusout', this.sliderFocusOut);
        ...
        Slider.prototype.wireEvents = function () {
            ...
            if (this.enabled && !this.readonly) {
                ...
                ej2_base_1.EventHandler.add(this.sliderContainer, 'mouseover mouseout touchstart touchend', this.hover, this);
                ...
                if (this.isForm) {
                    ej2_base_1.EventHandler.add(this.formElement, 'reset', this.formResetHandler, this);
                }
            }
        };
        Slider.prototype.unwireEvents = function () {
            ...
            ej2_base_1.EventHandler.remove(this.sliderContainer, 'mouseover mouseout touchstart touchend', this.hover);
            ...
            ej2_base_1.EventHandler.remove(this.element, 'reset', this.formResetHandler);
        };
        ...
        Slider.prototype.hover = function (event) {
            if (!ej2_base_5.isNullOrUndefined(event)) {
        ...
        Slider.prototype.changeSliderType = function (type, args) {
            ...
            if (this.tooltip.isVisible && !ej2_base_5.isNullOrUndefined(this.tooltipObj)) {
            ...
            if (this.limits.enabled) {
                if (type === 'MinRange' || type === 'Default') {
                    if (!ej2_base_5.isNullOrUndefined(this.limitBarFirst)) {
                        this.removeElement(this.limitBarFirst);
                        this.limitBarFirst = undefined;
                    }
                }
                else {
                    if (!ej2_base_5.isNullOrUndefined(this.limitBarSecond)) {
            ...
            this.setBarColor();
            if ((!ej2_base_1.isBlazor() && !this.isServerRendered) || args !== 'tooltip') {
                this.updateConfig();
            }
        };
        Slider.prototype.changeRtl = function () {
            ...
            if (this.showButtons) {
                var enabledRTL = this.enableRtl && this.orientation !== 'Vertical';
                ej2_base_4.attributes(enabledRTL ? this.secondBtn : this.firstBtn, { 'aria-label': 'Decrease', title: 'Decrease' });
                ej2_base_4.attributes(enabledRTL ? this.firstBtn : this.secondBtn, { 'aria-label': 'Increase', title: 'Increase' });
            }
        };
        ...
        Slider.prototype.limitsPropertyChange = function () {
            if (this.limits.enabled) {
                if (ej2_base_5.isNullOrUndefined(this.limitBarFirst) && this.type !== 'Range') {
                    this.createLimitBar();
                }
                if (ej2_base_5.isNullOrUndefined(this.limitBarFirst) && ej2_base_5.isNullOrUndefined(this.limitBarSecond) && this.type === 'Range') {
                    this.createLimitBar();
                }
                this.setLimitBar();
                this.setValue();
                ...
                if (!ej2_base_5.isNullOrUndefined(this.limitBarFirst)) {
                    ej2_base_4.detach(this.limitBarFirst);
                }
                if (!ej2_base_5.isNullOrUndefined(this.limitBarSecond)) {
                    ej2_base_4.detach(this.limitBarSecond);
                }
            }
        };
        /**
        ...
        Slider.prototype.destroy = function () {
            ...
            if (!ej2_base_1.isBlazor() && !this.isServerRendered) {
                ...
                ej2_base_4.detach(this.sliderContainer);
            }
            if (this.tooltip.isVisible) {
                this.tooltipObj.destroy();
            }
        ...
        Slider.prototype.onPropertyChanged = function (newProp, oldProp) {
            ...
            for (var _i = 0, _a = Object.keys(newProp); _i < _a.length; _i++) {
                ...
                switch (prop) {
                    ...
                    case 'value':
                        if (newProp && oldProp) {
                            var value = ej2_base_5.isNullOrUndefined(newProp.value) ?
                                (this.type === 'Range' ? [this.min, this.max] : this.min) : newProp.value;
                            this.setProperties({ 'value': value }, true);
                            if (!ej2_base_5.isNullOrUndefined(oldProp.value) && oldProp.value.toString() !== value.toString()) {
                                this.setValue();
                                if (!ej2_base_1.isBlazor() || !this.isServerRendered) {
                                    this.refreshTooltip(this.tooltipTarget);
                                }
                                if (this.type === 'Range') {
                                    if (ej2_base_5.isNullOrUndefined(newProp.value) || oldProp.value[1] === value[1]) {
                                        this.activeHandle = 1;
                                    }
                                    else {
                                        this.activeHandle = 2;
                    ...
                    case 'tooltip':
                        ...
                        if (!ej2_base_5.isNullOrUndefined(newProp.tooltip) && !ej2_base_5.isNullOrUndefined(oldProp.tooltip)) {
                    ...
                    case 'type':
                        ...
                        if (!ej2_base_5.isNullOrUndefined(oldProp) && Object.keys(oldProp).length
                            && !ej2_base_5.isNullOrUndefined(oldProp.type)) {
                    ...
                    case 'orientation':
                        ...
                        break;
                    case 'ticks':
                        if (!ej2_base_5.isNullOrUndefined(this.sliderContainer.querySelector('.' + classNames.scale))) {
                            if (!ej2_base_1.isBlazor() || !this.isServerRendered) {
                                ej2_base_4.detach(this.ul);
                            }
        ...
        Slider.prototype.setZindex = function () {
            this.zIndex = 6;
            if (!ej2_base_5.isNullOrUndefined(this.ticks) && this.ticks.placement !== 'None') {
                this.ul.style.zIndex = (this.zIndex + -7) + '';
                this.element.style.zIndex = (this.zIndex + 2) + '';
            }
            if (!this.isMaterial && !ej2_base_5.isNullOrUndefined(this.ticks) && this.ticks.placement === 'Both') {
                this.element.style.zIndex = (this.zIndex + 2) + '';
            }
            this.firstHandle.style.zIndex = (this.zIndex + 3) + '';
            if (this.type === 'Range') {
        ...
        Slider.prototype.setBarColor = function () {
            ...
            for (var i = 0; i < this.colorRange.length; i++) {
                if (!ej2_base_5.isNullOrUndefined(this.colorRange[i].start) && !ej2_base_5.isNullOrUndefined(this.colorRange[i].end)) {
        ...
        __decorate([
            ej2_base_1.Collection([{}], ColorRangeData)
        ], Slider.prototype, "colorRange", void 0);
        __decorate([
            ej2_base_1.Complex({}, TicksData)
        ], Slider.prototype, "ticks", void 0);
        __decorate([
            ej2_base_1.Complex({}, LimitData)
        ], Slider.prototype, "limits", void 0);
        __decorate([
            ej2_base_1.Property(true)
        ], Slider.prototype, "enabled", void 0);
        __decorate([
            ej2_base_1.Complex({}, TooltipData)
