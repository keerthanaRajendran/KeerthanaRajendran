...
define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-splitbuttons", "@syncfusion/ej2-splitbuttons", "@syncfusion/ej2-popups", "./../input/index", "./../numerictextbox/index", "./../slider/slider"], function (require, exports, ej2_base_1, ej2_base_2, ej2_base_3, ej2_base_4, ej2_splitbuttons_1, ej2_splitbuttons_2, ej2_popups_1, index_1, index_2, slider_1) {
    "use strict";
    ...
    var ColorPicker = /** @class */ (function (_super) {
        ...
        ColorPicker.prototype.preRender = function () {
            ...
            this.l10n = new ej2_base_3.L10n('colorpicker', localeText, this.locale);
        ...
        ColorPicker.prototype.render = function () {
            ...
            if (!this.enableOpacity) {
                ej2_base_3.addClass([this.container.parentElement], HIDEOPACITY);
            }
            this.renderComplete();
        };
        ColorPicker.prototype.initWrapper = function () {
            ...
            ej2_base_3.attributes(this.element, { 'tabindex': '-1', 'spellcheck': 'false' });
            ...
            if (ej2_base_3.isNullOrUndefined(this.initialInputValue)) {
            ...
            this.tileRipple = ej2_base_4.rippleEffect(this.container, { selector: '.' + TILE });
            this.ctrlBtnRipple = ej2_base_4.rippleEffect(this.container, { selector: '.e-btn' });
        };
        ...
        ColorPicker.prototype.createSplitBtn = function () {
            ...
            this.splitBtn = new ej2_splitbuttons_1.SplitButton({
            ...
            ej2_base_2.select('.e-selected-color', splitButton).appendChild(preview);
            preview.style.backgroundColor = this.convertToRgbString(this.hexToRgb(this.value));
            var popupEle = this.getPopupEle();
            ej2_base_3.addClass([popupEle], 'e-colorpicker-popup');
            if (this.cssClass) {
                ej2_base_3.addClass([popupEle], this.cssClass.split(' '));
            }
            if (ej2_base_2.Browser.isDevice) {
                ...
                popupInst.offsetY = 4;
                popupEle.style.zIndex = ej2_popups_1.getZindexPartial(this.splitBtn.element).toString();
            }
        ...
        ColorPicker.prototype.getPopupInst = function () {
            return ej2_base_2.getInstance(this.getPopupEle(), ej2_popups_1.Popup);
        };
        ColorPicker.prototype.bindCallBackEvent = function () {
            var _this = this;
            this.splitBtn.beforeOpen = function (args) {
                var callBackPromise = new ej2_splitbuttons_2.Deferred();
                _this.trigger('beforeOpen', args, function (observeOpenArgs) {
                    if (!observeOpenArgs.cancel) {
                        var popupEle = _this.getPopupEle();
                        popupEle.style.top = ej2_base_2.formatUnit(0 + pageYOffset);
                        popupEle.style.left = ej2_base_2.formatUnit(0 + pageXOffset);
            ...
            this.splitBtn.beforeClose = function (args) {
                var callBackPromise = new ej2_splitbuttons_2.Deferred();
                if (!ej2_base_3.isNullOrUndefined(args.event)) {
                    ...
                    _this.trigger('beforeClose', beforeCloseArgs, function (observedCloseArgs) {
                        if (ej2_base_2.Browser.isDevice && args.event.target === _this.modal) {
        ...
        ColorPicker.prototype.onPopupClose = function () {
            ...
            ej2_base_2.select('.' + SPLITPREVIEW, this.splitBtn.element).style.backgroundColor
                = this.convertToRgbString(this.hexToRgb(this.value));
            this.container.innerHTML = '';
            ej2_base_4.removeClass([this.container], [PICKERCONTENT, PALETTECONTENT]);
            if (ej2_base_2.Browser.isDevice && this.modal) {
                ej2_base_4.removeClass([document.body], 'e-colorpicker-overflow');
        ...
        ColorPicker.prototype.createPalette = function () {
            ej2_base_3.classList(this.container, [PALETTECONTENT], [PICKERCONTENT]);
            if (this.presetColors) {
                ...
                if (ej2_base_2.selectAll('.e-row', paletteGroup).length > 10) {
                    ej2_base_3.addClass([paletteGroup], 'e-palette-group');
                }
            }
            else {
            ...
            this.container.style.width = ej2_base_2.formatUnit(this.container.children[0].offsetWidth + width + width);
            this.rgb = this.hexToRgb(this.roundValue(this.value));
            this.hsv = this.rgbToHsv.apply(this, this.rgb);
        };
        ColorPicker.prototype.firstPaletteFocus = function () {
            if (!ej2_base_2.select('.' + SELECT, this.container.children[0])) {
                ej2_base_2.selectAll('.' + PALETTES, this.container)[0].focus();
            }
        };
        ...
        ColorPicker.prototype.setNoColor = function () {
            ...
            if (!this.value) {
                ...
                ej2_base_2.closest(noColorEle, '.' + PALETTES).focus();
            }
        ...
        ColorPicker.prototype.createPicker = function () {
            ej2_base_3.classList(this.container, [PICKERCONTENT], [PALETTECONTENT]);
        ...
        ColorPicker.prototype.getHsvContainer = function () {
            return ej2_base_2.select('.' + HSVCONTAINER, this.container);
        };
        ColorPicker.prototype.setHandlerPosition = function () {
            var dragHandler = this.getDragHandler();
            var hsvArea = ej2_base_2.select('.' + HSVAREA, this.container);
            if (this.enableRtl) {
                dragHandler.style.left = ej2_base_2.formatUnit(hsvArea.offsetWidth * Math.abs(100 - this.hsv[1]) / 100);
            }
            else {
                dragHandler.style.left = ej2_base_2.formatUnit(hsvArea.offsetWidth * this.hsv[1] / 100);
            }
            dragHandler.style.top = ej2_base_2.formatUnit(hsvArea.offsetHeight * (100 - this.hsv[2]) / 100);
        };
        ColorPicker.prototype.createSlider = function () {
            ...
            this.hueSlider = new slider_1.Slider({
                value: this.hsv[0],
                min: 0,
                max: 359,
                enableRtl: this.enableRtl,
        ...
        ColorPicker.prototype.createOpacitySlider = function (slider) {
            this.opacitySlider = new slider_1.Slider({
        ...
        ColorPicker.prototype.updateOpacitySliderBg = function () {
            ...
            ej2_base_2.select('.e-slider-track', this.opacitySlider.element).style.background =
        ...
        ColorPicker.prototype.updateOpacityInput = function (value) {
            if (this.enableOpacity && !this.getWrapper().classList.contains(HIDEVALUE)) {
                var opacityTextBoxInst = ej2_base_2.getInstance(ej2_base_2.select('.' + OPACITY, this.container), index_2.NumericTextBox);
        ...
        ColorPicker.prototype.createNumericInput = function (element, value, label, max) {
            var _this = this;
            var numericInput = new index_2.NumericTextBox({
                value: value,
                placeholder: label,
                min: 0,
                max: max,
        ...
        ColorPicker.prototype.createInput = function () {
            ...
            if ((isPicker && !wrapper.classList.contains(HIDEVALUE)) || (!isPicker && wrapper.classList.contains(SHOWVALUE))) {
                ...
                if (!wrapper.classList.contains(HIDEHEX)) {
                    ...
                    index_1.Input.setValue(this.value.slice(0, 7), hexInput);
        ...
        ColorPicker.prototype.appendModeSwitchBtn = function () {
            ...
            ej2_base_2.select('.' + CTRLSWITCH, this.container).insertBefore(modeSwitcher, ej2_base_2.select('.' + CTRLBTN, this.container));
        };
        ColorPicker.prototype.createDragTooltip = function () {
            ...
            this.tooltipEle.style.zIndex = ej2_popups_1.getZindexPartial(this.tooltipEle).toString();
            ej2_base_2.select('.e-tip-content', this.tooltipEle).appendChild(this.createElement('div', { className: 'e-tip-transparent' }));
        };
        ColorPicker.prototype.getTooltipInst = function () {
            return ej2_base_2.getInstance(this.container, ej2_popups_1.Tooltip);
        };
        ...
        ColorPicker.prototype.toggleDisabled = function (enable) {
            ...
            if (this.showButtons) {
                ([].slice.call(ej2_base_2.selectAll('.e-btn', this.container))).forEach(function (ele) {
                    enable ? ej2_base_3.attributes(ele, { 'disabled': '' }) : ele.removeAttribute('disabled');
                });
            }
        };
        ...
        ColorPicker.prototype.updateInput = function (value) {
            ...
            if (!wrapper.classList.contains(HIDEVALUE)) {
                if (!wrapper.classList.contains(HIDEHEX)) {
                    index_1.Input.setValue(value.substr(0, 7), ej2_base_2.select('.' + HEX, this.container));
                }
                if (!wrapper.classList.contains(HIDERGBA)) {
                    if (this.isRgb) {
        ...
        ColorPicker.prototype.updatePreview = function (value) {
            ...
            ej2_base_2.select('.e-tip-transparent', this.tooltipEle).style.backgroundColor = value;
            ej2_base_2.select('.' + PREVIEW + ' .' + CURRENT, this.container).style.backgroundColor = value;
            ej2_base_2.select('.' + PREVIEW + ' .' + PREVIOUS, this.container).style.backgroundColor
                = this.convertToRgbString(this.hexToRgb(this.value));
        };
        ColorPicker.prototype.getDragHandler = function () {
            return ej2_base_2.select('.' + HANDLER, this.container);
        };
        ColorPicker.prototype.removeTileSelection = function () {
            var selectedEle = [].slice.call(ej2_base_2.selectAll('.' + SELECT, this.container.children[0]));
        ...
        ColorPicker.prototype.wireEvents = function () {
            if (this.isPicker()) {
                var dragHandler = this.getDragHandler();
                ej2_base_2.EventHandler.add(dragHandler, 'keydown', this.pickerKeyDown, this);
                ej2_base_2.EventHandler.add(this.getHsvContainer(), 'mousedown touchstart', this.handlerDown, this);
                if (this.modeSwitcher || this.showButtons) {
                    this.addCtrlSwitchEvent();
                }
                ej2_base_2.EventHandler.add(ej2_base_2.select('.' + PREVIOUS, this.container), 'click', this.previewHandler, this);
            }
            else {
                ej2_base_2.EventHandler.add(this.container, 'click', this.paletteClickHandler, this);
                ej2_base_2.EventHandler.add(this.container, 'keydown', this.paletteKeyDown, this);
            }
        };
        ColorPicker.prototype.formResetHandler = function () {
            this.value = this.initialInputValue;
            ej2_base_3.attributes(this.element, { 'value': this.initialInputValue });
        };
        ColorPicker.prototype.addCtrlSwitchEvent = function () {
            var ctrlSwitchBtn = ej2_base_2.select('.' + CTRLSWITCH, this.container);
            if (ctrlSwitchBtn) {
                ej2_base_2.EventHandler.add(ctrlSwitchBtn, 'click', this.btnClickHandler, this);
            }
        };
        ...
        ColorPicker.prototype.handlerDown = function (e) {
            ...
            this.convertToOtherFormat();
            this.getDragHandler().focus();
            ej2_base_2.EventHandler.add(document, 'mousemove touchmove', this.handlerMove, this);
            ej2_base_2.EventHandler.add(document, 'mouseup touchend', this.handlerEnd, this);
        };
        ColorPicker.prototype.handlerMove = function (e) {
            ...
            if (!this.tooltipEle.style.transform) {
                if (Math.abs(this.clientX - x) > 8 || Math.abs(this.clientY - y) > 8) {
                    ej2_base_2.select('.' + HSVAREA, this.container).style.cursor = 'pointer';
        ...
        ColorPicker.prototype.setHsv = function (clientX, clientY) {
            var ele = ej2_base_2.select('.' + HSVAREA, this.container);
        ...
        ColorPicker.prototype.handlerEnd = function (e) {
            ...
            ej2_base_2.EventHandler.remove(document, 'mousemove touchmove', this.handlerMove);
            ej2_base_2.EventHandler.remove(document, 'mouseup touchend', this.handlerEnd);
            var dragHandler = this.getDragHandler();
            ej2_base_2.select('.' + HSVAREA, this.container).style.cursor = '';
            if (this.tooltipEle.style.transform) {
        ...
        ColorPicker.prototype.btnClickHandler = function (e) {
            var target = e.target;
            if (ej2_base_2.closest(target, '.' + MODESWITCH)) {
                e.stopPropagation();
        ...
        ColorPicker.prototype.switchToPalette = function () {
            ...
            this.unWireEvents();
            this.destroyOtherComp();
            ej2_base_2.detach(ej2_base_2.select('.e-slider-preview', this.container));
            if (!this.getWrapper().classList.contains(HIDEVALUE)) {
                ej2_base_4.remove(ej2_base_2.select('.' + INPUTWRAPPER, this.container));
            }
            ej2_base_2.detach(this.getHsvContainer());
            this.createPalette();
            this.firstPaletteFocus();
            this.createInput();
            this.refreshPopupPos();
        ...
        ColorPicker.prototype.updateValue = function (value, format, idx, max) {
            ...
            for (var i = 0, len = clsName.length; i < len; i++) {
                inst = ej2_base_2.getInstance(ej2_base_2.select('.' + clsName[i], this.container), index_2.NumericTextBox);
        ...
        ColorPicker.prototype.previewHandler = function (e) {
            ...
            this.setHandlerPosition();
            this.updateInput(cValue);
            ej2_base_2.select('.' + PREVIEW + ' .' + CURRENT, this.container).style.backgroundColor = this.convertToRgbString(this.rgb);
            ...
            if (target.classList.contains(TILE)) {
                ...
                if (ej2_base_2.closest(target, '.' + MODESWITCH)) {
                    ...
                    if (target.classList.contains(APPLY) || target.classList.contains(CANCEL)) {
                        ...
                        if (this.getWrapper().classList.contains(SHOWVALUE) && ej2_base_2.closest(target, '.' + FORMATSWITCH)) {
        ...
        ColorPicker.prototype.switchToPicker = function () {
            ...
            this.unWireEvents();
            ([].slice.call(ej2_base_2.selectAll('.' + PALETTES, this.container))).forEach(function (ele) {
                ej2_base_2.detach(ele);
            });
            if (wrapper.classList.contains(SHOWVALUE)) {
                ej2_base_2.detach(ej2_base_2.select('.' + INPUTWRAPPER, this.container));
            }
            this.container.style.width = '';
            var grpEle = ej2_base_2.select('.e-custom-palette', this.container);
            if (this.presetColors) {
                ej2_base_4.remove(grpEle);
            }
            this.createPicker();
            this.getDragHandler().focus();
            this.createInput();
        ...
        ColorPicker.prototype.paletteKeyDown = function (e) {
            ...
            var selectedEle;
            var idx;
            var tiles = [].slice.call(ej2_base_2.selectAll('.' + TILE, target));
        ...
        ColorPicker.prototype.inputHandler = function (e) {
            ...
            var hsv;
            var pValue;
            var label = ej2_base_2.select('.e-float-text', target.parentElement).textContent;
            switch (label) {
                case 'HEX':
                    var value = '';
        ...
        ColorPicker.prototype.destroy = function () {
            ...
            if (this.element.nextElementSibling) {
                ej2_base_2.detach(this.element.nextElementSibling);
            }
            if (wrapper) {
                wrapper.parentElement.insertBefore(this.element, wrapper);
                ej2_base_2.detach(wrapper);
            }
            this.container = null;
            if (this.formElement) {
        ...
        ColorPicker.prototype.unWireEvents = function () {
            if (this.isPicker()) {
                var wrapper = this.getWrapper();
                var dragHandler = this.getDragHandler();
                ej2_base_2.EventHandler.remove(dragHandler, 'keydown', this.pickerKeyDown);
                ej2_base_2.EventHandler.remove(this.getHsvContainer(), 'mousedown touchstart', this.handlerDown);
                if (this.modeSwitcher || this.showButtons) {
                    ej2_base_2.EventHandler.remove(ej2_base_2.select('.' + CTRLSWITCH, this.container), 'click', this.btnClickHandler);
                }
                ej2_base_2.EventHandler.remove(ej2_base_2.select('.' + PREVIOUS, this.container), 'click', this.previewHandler);
            }
            else {
                ej2_base_2.EventHandler.remove(this.container, 'click', this.paletteClickHandler);
                ej2_base_2.EventHandler.remove(this.container, 'keydown', this.paletteKeyDown);
            }
        };
        ...
        ColorPicker.prototype.rgbToHsv = function (r, g, b, opacity) {
            ...
            if (!ej2_base_3.isNullOrUndefined(opacity)) {
                hsv.push(opacity);
            }
            return hsv;
        };
        ...
        ColorPicker.prototype.rgbToHex = function (rgb) {
            return rgb.length ? ('#' + this.hex(rgb[0]) + this.hex(rgb[1]) + this.hex(rgb[2]) +
                (!ej2_base_3.isNullOrUndefined(rgb[3]) ? (rgb[3] !== 0 ? (Math.round(rgb[3] * 255) + 0x10000).toString(16).substr(-2) : '00') : '')) : '';
        };
        ColorPicker.prototype.hex = function (x) {
            return ('0' + x.toString(16)).slice(-2);
        };
        ColorPicker.prototype.changeModeSwitcherProp = function (prop) {
            var ctrlSwitchWrapper = ej2_base_2.select('.' + CTRLSWITCH, this.container);
            if (prop) {
                ...
                if (ctrlSwitchWrapper) {
                    if (this.showButtons) {
                        ej2_base_2.detach(ej2_base_2.select('.' + MODESWITCH, ctrlSwitchWrapper));
                    }
                    else {
                        ej2_base_4.remove(ctrlSwitchWrapper);
                    }
                }
            }
        };
        ColorPicker.prototype.changeShowBtnProps = function (prop) {
            var ctrlBtnWrapper = ej2_base_2.select('.' + CTRLSWITCH, this.container);
            if (prop) {
                if (ctrlBtnWrapper) {
                    ej2_base_4.remove(ctrlBtnWrapper);
                }
                this.createCtrlBtn();
                if (this.isPicker() && !this.disabled) {
                    this.addCtrlSwitchEvent();
                ...
                if (this.modeSwitcher) {
                    ej2_base_2.detach(ej2_base_2.select('.' + CTRLBTN, ctrlBtnWrapper));
                }
                else {
                    ej2_base_4.remove(ctrlBtnWrapper);
                }
        ...
        ColorPicker.prototype.changeValueProp = function (newProp) {
            if (this.isPicker()) {
                ...
                this.hsv = this.rgbToHsv.apply(this, this.rgb);
                this.setHandlerPosition();
                ej2_base_2.detach(ej2_base_2.closest(this.hueSlider.element, '.e-slider-preview'));
                this.createSlider();
                this.setHsvContainerBg();
                ...
                this.removeTileSelection();
                var ele = ej2_base_2.select('span[aria-label="' + this.roundValue(newProp) + '"]', this.container);
                if (ele) {
        ...
        ColorPicker.prototype.changeCssClassProps = function (newProp, oldProp) {
            ...
            if (oldProp) {
                ej2_base_4.removeClass([wrapper, popupWrapper], oldProp.split(' '));
            }
            if (newProp) {
                ej2_base_3.addClass([wrapper, popupWrapper], newProp.split(' '));
            }
        };
        ColorPicker.prototype.changeRtlProps = function (newProp) {
            if (newProp) {
                ej2_base_3.addClass([this.getWrapper()], 'e-rtl');
            }
            else {
                ej2_base_4.removeClass([this.getWrapper()], 'e-rtl');
            }
        };
        ColorPicker.prototype.changePaletteProps = function () {
            ej2_base_2.detach(this.container.children[0]);
            this.container.style.width = '';
            this.createPalette();
        };
        ColorPicker.prototype.changeOpacityProps = function (newProp) {
            var wrapper = this.getWrapper();
            if (newProp) {
                ej2_base_4.removeClass([this.container.parentElement], HIDEOPACITY);
                this.createOpacitySlider(ej2_base_2.select('.e-colorpicker-slider', this.container).appendChild(this.createElement('div', { className: 'e-opacity-slider' })));
                if (!wrapper.classList.contains(HIDEVALUE) && !wrapper.classList.contains(HIDERGBA)) {
                    this.appendOpacityValue(ej2_base_2.select('.e-input-container', this.container));
                }
            }
            else {
                ej2_base_3.addClass([this.container.parentElement], HIDEOPACITY);
                this.opacitySlider.destroy();
                ej2_base_4.remove(this.opacitySlider.element);
                this.opacitySlider = null;
                if (!wrapper.classList.contains(HIDEVALUE) && !wrapper.classList.contains(HIDERGBA)) {
                    ej2_base_4.remove(ej2_base_2.select('.' + OPACITY, this.container).parentElement);
                }
            }
        };
        /**
        ...
        ColorPicker.prototype.onPropertyChanged = function (newProp, oldProp) {
            var _this = this;
            if (!ej2_base_3.isNullOrUndefined(newProp.value)) {
                var value = this.roundValue(newProp.value);
                if (value.length === 9) {
                    this.element.value = this.roundValue(value).slice(0, 7);
                    var preview = this.splitBtn && ej2_base_2.select('.' + SPLITPREVIEW, this.splitBtn.element);
                    if (preview) {
            ...
            if (!this.inline && ej2_base_3.isNullOrUndefined(newProp.inline)) {
                var otherCompModel = ['disabled', 'enableRtl'];
                this.splitBtn.setProperties(ej2_splitbuttons_1.getModel(newProp, otherCompModel));
                if (!this.isPopupOpen()) {
                ...
                switch (prop) {
                    case 'inline':
                        if (newProp.inline) {
                            ...
                            ej2_base_2.detach(this_1.element.nextElementSibling);
                    ...
                    case 'cssClass':
                        ...
                        props.forEach(function (cls) {
                            if (count_1 === 0 &&
                                ...
                                var inputWrap = ej2_base_2.select('.' + INPUTWRAPPER, _this.container);
                                if (inputWrap) {
                                    ej2_base_4.remove(ej2_base_2.select('.' + INPUTWRAPPER, _this.container));
                                }
                                _this.createInput();
                                count_1++;
                            }
