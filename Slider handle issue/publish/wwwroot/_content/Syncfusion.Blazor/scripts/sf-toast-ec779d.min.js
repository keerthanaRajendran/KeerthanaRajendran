...
window.sfBlazor.Toast = function () {
  ...
  function () {
    ...
    SfToast.prototype.show = function (options) {
      ...
      var target = _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(this.target) === STRING ? document.querySelector(this.target) : document.body;
    ...
    SfToast.prototype.hide = function (element) {
      ...
      if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(element) === STRING && element === ALL) {
  ...
  var Toast = {
    ...
    hide: function hide(element, toastElement, toastObj) {
      if (!sf.base.isNullOrUndefined(element)) {
