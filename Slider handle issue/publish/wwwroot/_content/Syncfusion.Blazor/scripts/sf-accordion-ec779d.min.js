...
window.sfBlazor.Accordion = function () {
  ...
  function () {
    ...
    SfAccordion.prototype.itemExpand = function (isExpand, ele, index) {
      ...
      if (sf.base.isNullOrUndefined(ctn) && isExpand) {
        var id = ele.id; // tslint:disable-next-line:no-any
  ...
  var Accordion = {
    ...
    enableItem: function enableItem(element, index, isEnable) {
      if (element && element.blazor__instance) {
        element.blazor__instance.enableItem(index, isEnable);
      }
    },
    expandItem: function expandItem(element, isExpand, index) {
      if (element && element.blazor__instance) {
        element.blazor__instance.expandItem(isExpand, index);
      }
    },
    hideItem: function hideItem(element, index, isHidden) {
      if (element && element.blazor__instance) {
    ...
    destroy: function destroy(element, elementId, expandedIndices) {
      if (element && element.blazor__instance) {
