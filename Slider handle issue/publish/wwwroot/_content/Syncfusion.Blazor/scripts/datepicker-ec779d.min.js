  ...
  function (_super) {
    ...
    DatePicker.prototype.destroy = function () {
      ...
      if (this.inputElement) {
        ...
        !sf.base.isNullOrUndefined(this.inputElementCopy.getAttribute('tabindex')) ? this.inputElement.setAttribute('tabindex', this.tabIndex) : this.inputElement.removeAttribute('tabindex');
        sf.base.EventHandler.remove(this.inputElement, 'blur', this.inputBlurHandler);
        sf.base.EventHandler.remove(this.inputElement, 'focus', this.inputFocusHandler);
    ...
    DatePicker.prototype.disabledDates = function () {
      ...
      if (!this.strictMode) {
        if (typeof this.value === 'string' || _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(this.value) === 'object' && +this.value !== +valueCopy) {
          this.setProperties({
            value: valueCopy
          }, true);
        }
