...
var sftreegrid = function sftreegrid(exports) {
  ...
  var treeGridDetails = {
    mapping_fields_missing: {
      ...
      logType: 'error',
      check: function check(args, parent) {
        var opt = {
          success: false
        };

        if (sf.base.isNullOrUndefined(parent.idMapping) && sf.base.isNullOrUndefined(parent.childMapping) && sf.base.isNullOrUndefined(parent.parentIdMapping) || !sf.base.isNullOrUndefined(parent.idMapping) && sf.base.isNullOrUndefined(parent.parentIdMapping) || sf.base.isNullOrUndefined(parent.idMapping) && !sf.base.isNullOrUndefined(parent.parentIdMapping)) {
          opt = {
            success: true
          };
        }
      ...
      generateMessage: function generateMessage(args, parent, field) {
      ...
      if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(args.column.template) === 'object' && this.templateResult) {
        ...
        if (treeColumn.field === args.column.field && !sf.base.isNullOrUndefined(treeColumn.template)) {
          ...
          if (this.parent.isReact) {
            ...
            var result = void 0;
            result = args.column[templateFn](sf.grids.extend({
              'index': ''
  ...
  function (_super) {
    ...
    TreeGrid.prototype.log = function (types, args) {
      this.loggerModule ? this.loggerModule.treeLog(types, args, this) : function () {
        return 0;
      }();
    };
    /**
    ...
    TreeGrid.prototype.bindGridEvents = function () {
      ...
      this.grid.rowSelecting = function (args) {
        if (!sf.base.isNullOrUndefined(args.target) && (args.target.classList.contains('e-treegridexpand') || args.target.classList.contains('e-treegridcollapse'))) {
          args.cancel = true;
          return;
        }
    ...
    TreeGrid.prototype.extendedGridDataBoundEvent = function () {
      ...
      this.grid.log = function (type, args) {
        _this.loggerModule ? _this.loggerModule.log(type, args) : function () {
          return 0;
        }();
      };
    };
    ...
    RowDD$$1.prototype.rowsAdded = function (e) {
      ...
      if (sf.base.isNullOrUndefined(this.parent.dataSource) || !this.parent.dataSource.length) {
        ...
        for (var i = dragLength - 1; i > -1; i--) {
          ...
          if (!sf.base.isNullOrUndefined(draggedRecord_1.taskData) && !draggedRecord_1.taskData.hasOwnProperty(tObj.childMapping)) {
            draggedRecord_1.taskData[tObj.childMapping] = [];
          }

          if (draggedRecord_1.hasOwnProperty(tObj.childMapping) && draggedRecord_1[tObj.childMapping].length && !this.isDraggedWithChild && !sf.base.isNullOrUndefined(tObj.parentIdMapping)) {
          ...
          if (draggedRecord_1.hasOwnProperty(tObj.parentIdMapping) && draggedRecord_1[tObj.parentIdMapping] != null && !this.isDraggedWithChild) {
  ...
  function (_super) {
    ...
    TreeVirtualRowModelGenerator.prototype.generateRows = function (data, notifyArgs) {
      if (this.parent.dataSource instanceof sf.data.DataManager && this.parent.dataSource.dataSource.url !== undefined && this.parent.dataSource.dataSource.url !== '' || isCountRequired(this.parent)) {
    ...
    Aggregate$$1.prototype.calculateSummaryValue = function (summaryQuery, filteredData, isSort) {
      ...
      if (this.parent.aggregates.filter(function (x) {
        ...
        for (var columnIndex = 0, length_1 = columnLength; columnIndex < length_1; columnIndex++) {
          var fields = sf.base.isNullOrUndefined(sf.grids.getObject('field', this.parent.columns[columnIndex])) ? this.parent.columns[columnIndex] : sf.grids.getObject('field', this.parent.columns[columnIndex]);
          items[fields] = null;
        }
        ...
        for (var _i = 0, keys_1 = keys; _i < keys_1.length; _i++) {
          ...
          if (key === displayColumn) {
            if (this.flatChildRecords.length) {
              ...
              var data = this.parent.dataSource instanceof sf.data.DataManager ? this.parent.dataSource.dataSource.json : this.parent.flatData;
  ...
  TreeGrid.Inject(Filter$1, Page$1, Sort$1, Reorder$1, Toolbar$1, Aggregate$1, Resize$1, ColumnMenu$1, ExcelExport$1, PdfExport$1, CommandColumn$1, ContextMenu$1, Edit$1, Selection, VirtualScroll$1, DetailRow$1, RowDD$1, Freeze$1, ColumnChooser$1, Logger$1);
