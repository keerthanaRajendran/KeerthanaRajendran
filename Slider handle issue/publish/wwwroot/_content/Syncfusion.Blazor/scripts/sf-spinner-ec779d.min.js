...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bundles/sf-spinner.js");
/******/ })
/************************************************************************/
/******/ ({
  ...
  var Spinner = {
    initialize: function initialize(element, target, dotnetRef) {
      if (!sf.base.isNullOrUndefined(element)) {
        ...
        return !sf.base.isNullOrUndefined(element) && !sf.base.isNullOrUndefined(element.blazor__instance) ? element.blazor__instance.initialize(element, target) : null;
      } else {
        return null;
      }
    },
