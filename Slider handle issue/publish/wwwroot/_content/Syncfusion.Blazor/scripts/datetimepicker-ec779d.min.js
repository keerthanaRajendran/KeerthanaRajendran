...
var sfdatetimepicker = function sfdatetimepicker(exports) {
  ...
  function (_super) {
    ...
    DateTimePicker.prototype.documentClickHandler = function (event) {
      ...
      if (!sf.base.closest(target, '#' + (this.popupObject && this.popupObject.element.id)) && target !== this.inputElement && target !== this.timeIcon && target !== this.inputWrapper.container) {
        if (this.isTimePopupOpen()) {
          this.hide(event);
          this.focusOut();
        }
