...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bundles/progressbar.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _modules_progressbar_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/progressbar.js */ "./modules/progressbar.js");


/***/ }),

/***/ "./modules/progressbar.js":
/*!********************************!*\
  !*** ./modules/progressbar.js ***!
  \********************************/
/*! no exports provided */
...
var sfprogressbar = function sfprogressbar(exports) {
  'use strict';
  ...
  function getPathArc(x, y, radius, startAngle, endAngle, enableRtl, pieView) {
    ...
    if (pieView) {
      d = 'M ' + x + ' ' + y + ' L ' + start.x + ' ' + start.y + ' A ' + radius + ' ' + radius + ' ' + ' 0 ' + ' ' + largeArcFlag + ' ' + sweepFlag + ' ' + end.x + ' ' + end.y + ' ' + 'Z';
    } else {
  ...
  function (_super) {
    ...
    __decorate$1([sf.base.Property('Far')], Font.prototype, "textAlignment", void 0);

    __decorate$1([sf.base.Property('')], Font.prototype, "text", void 0);
  ...
  function (_super) {
    ...
    __decorate$1([sf.base.Property(false)], Animation$$1.prototype, "enable", void 0);

    __decorate$1([sf.base.Property(2000)], Animation$$1.prototype, "duration", void 0);
  ...
  var ProgressAnnotationSettings =
  /** @class */
  function (_super) {
    ...
    __decorate$1([sf.base.Property(null)], ProgressAnnotationSettings.prototype, "content", void 0);

    __decorate$1([sf.base.Property(0)], ProgressAnnotationSettings.prototype, "annotationAngle", void 0);

    __decorate$1([sf.base.Property('0%')], ProgressAnnotationSettings.prototype, "annotationRadius", void 0);
  ...
  function (_super) {
    ...
    __decorate$1([sf.base.Property('')], RangeColor.prototype, "color", void 0);

    __decorate$1([sf.base.Property(null)], RangeColor.prototype, "start", void 0);

    __decorate$1([sf.base.Property(null)], RangeColor.prototype, "end", void 0);
  ...
  function () {
    ...
    AnnotationBase.prototype.processAnnotation = function (annotation, index, parentElement) {
      ...
      if (annotationElement) {
        ...
        removeElement(annotationElement.id); // tslint:disable-next-line:no-any
    ...
    AnnotationBase.prototype.setElementStyle = function (location, element, parentElement) {
      ...
      if (!argsData.cancel) {
        ...
        parentElement.appendChild(argsData.content); // tslint:disable-next-line:no-any
  ...
  function () {
    ...
    ProgressAnimation.prototype.doLinearAnimation = function (element, _progress, delay, previousWidth, active) {
      var _this = this;

      var animation = new sf.base.Animation({});
      var linearPath = element;
      var duration = _progress.isActive ? 3000 : _progress.animation.duration;
      var width = linearPath.getAttribute('width');
      var x = linearPath.getAttribute('x');
      var opacityValue = 0;
      var value = 0;
      var start = !_progress.enableRtl || _progress.cornerRadius === 'Round4px' ? previousWidth : parseInt(x, 10);
      var end = !_progress.enableRtl || _progress.cornerRadius === 'Round4px' ? parseInt(width, 10) - start : parseInt(width, 10) - previousWidth;
      ...
      animation.animate(linearPath, {
        ...
        progress: function progress(args) {
          _progress.cancelResize = true;

          if (_progress.enableRtl && !(_progress.cornerRadius === 'Round4px')) {
          ...
          if (_progress.enableRtl && !(_progress.cornerRadius === 'Round4px')) {
            if (_progress.isActive) {
              ...
              _this.doLinearAnimation(element, _progress, delay, previousWidth, active);
            } else {
          ...
          _progress.trigger('animationComplete', {
            value: _progress.value,
            trackColor: _progress.trackColor,
            progressColor: _progress.progressColor
          });
        }
      });
    };
    ...
    ProgressAnimation.prototype.doLinearIndeterminate = function (element, progressWidth, thickness, _progress2, clipPath) {
      var _this = this;
      ...
      var end = _progress2.progressRect.x + _progress2.progressRect.width + (width ? parseInt(width, 10) : progressWidth);
      var duration = !_progress2.enableProgressSegments ? 2500 : 3500;
      animation.animate(clipPath, {
        duration: duration,
        delay: 0,
        progress: function progress(args) {
          if (_progress2.enableRtl && !(_progress2.cornerRadius === 'Round4px')) {
            value = effect(args.timeStamp, parseInt(x, 10) || _progress2.progressRect.x + progressWidth, end, args.duration, true);

            if (!_progress2.enableProgressSegments) {
              linearPath.setAttribute('x', value.toString());
            } else {
              linearPath.setAttribute('d', _progress2.getPathLine(value, progressWidth, thickness));
            }
          } else {
            value = effect(args.timeStamp, start, end, args.duration, false);
          ...
          if (_progress2.enableRtl && !_progress2.enableProgressSegments && !(_progress2.cornerRadius === 'Round4px')) {
            linearPath.setAttribute('x', x.toString());
          } else if (!_progress2.enableProgressSegments) {
            linearPath.setAttribute('x', start.toString());
          }

          if (!_progress2.destroyIndeterminate) {
            _this.doLinearIndeterminate(element, progressWidth, thickness, _progress2, clipPath);
          }
        }
      });
    };
    ...
    ProgressAnimation.prototype.doStripedAnimation = function (element, _progress3, value, delay) {
      var _this = this;

      var animation = new sf.base.Animation({});
      var point = 1000 / _progress3.animation.duration;
      animation.animate(element, {
        duration: _progress3.animation.duration,
        delay: _progress3.animation.delay,
        progress: function progress() {
          value += _progress3.enableRtl ? -point : point;
          element.setAttribute('gradientTransform', 'translate(' + value + ') rotate(-45)');
        },
        end: function end() {
          if (!_progress3.destroyIndeterminate) {
            _this.doStripedAnimation(element, _progress3, value, false);
          }
        }
      });
    };
    ...
    ProgressAnimation.prototype.doCircularAnimation = function (x, y, radius, progressEnd, totalEnd, element, _progress4, thickness, delay, startValue, previousTotal, active) {
      var _this = this;

      var animation = new sf.base.Animation({});
      var circularPath = element;
      var start = _progress4.startAngle;
      var pathRadius = radius + thickness / 2;
      var end = 0;
      var opacityValue = 0;
      var startPos;
      var endPos;
      var duration = _progress4.isActive ? 3000 : _progress4.animation.duration;
      start += _progress4.cornerRadius === 'Round' && totalEnd !== completeAngle && totalEnd !== 0 ? _progress4.enableRtl ? lineCapRadius / 2 * thickness : -(lineCapRadius / 2) * thickness : 0;
      totalEnd += _progress4.cornerRadius === 'Round' && totalEnd !== completeAngle && totalEnd !== 0 ? lineCapRadius / 2 * thickness : 0;
      progressEnd += _progress4.cornerRadius === 'Round' && totalEnd !== completeAngle && totalEnd !== 0 ? _progress4.enableRtl ? -(lineCapRadius / 2) * thickness : lineCapRadius / 2 * thickness : 0;
      ...
      animation.animate(circularPath, {
        ...
        delay: delay,
        progress: function progress(args) {
          _progress4.cancelResize = true;

          if (args.timeStamp >= args.delay) {
            circularPath.setAttribute('visibility', 'visible');

            if (_progress4.isActive) {
              end = _this.activeAnimate(args.timeStamp / args.duration, startPos, endPos, _progress4.enableRtl);
              opacityValue = effect(args.timeStamp, 0.5, 0.5, args.duration, true);
              active.setAttribute('opacity', opacityValue.toString());
              circularPath.setAttribute('d', getPathArc(x, y, pathRadius, start, end % 360, _progress4.enableRtl, true));
            } else {
              end = effect(args.timeStamp, startPos, endPos, args.duration, _progress4.enableRtl);
              circularPath.setAttribute('d', getPathArc(x, y, pathRadius, start, end % 360, _progress4.enableRtl, true));
            }
          }
        },
        end: function end(model) {
          _progress4.cancelResize = false;
          circularPath.setAttribute('visibility', '');
          circularPath.setAttribute('d', getPathArc(x, y, pathRadius, start, progressEnd, _progress4.enableRtl, true));

          if (_progress4.isActive) {
            _this.doCircularAnimation(x, y, radius, progressEnd, totalEnd, element, _progress4, thickness, delay, startValue, previousTotal, active);
          }

          _progress4.trigger('animationComplete', {
            value: _progress4.value,
            trackColor: _progress4.trackColor,
            progressColor: _progress4.progressColor
          });
        }
      });
    };
    ...
    ProgressAnimation.prototype.doCircularIndeterminate = function (circularProgress, _progress5, start, _end, x, y, radius, thickness, clipPath) {
      var _this = this;

      var animation = new sf.base.Animation({});
      var pathRadius = radius + (!_progress5.enableProgressSegments ? thickness / 2 : 0);
      var value = !_progress5.enableProgressSegments ? 3 : 2;
      animation.animate(clipPath, {
        progress: function progress() {
          circularProgress.style.visibility = 'visible';
          start += _progress5.enableRtl ? -value : value;
          _end += _progress5.enableRtl ? -value : value;
          circularProgress.setAttribute('d', getPathArc(x, y, pathRadius, start % 360, _end % 360, _progress5.enableRtl, !_progress5.enableProgressSegments));
        },
        end: function end(model) {
          if (!_progress5.destroyIndeterminate) {
            _this.doCircularIndeterminate(circularProgress, _progress5, start, _end, x, y, radius, thickness, clipPath);
          }
        }
      });
    };
    ...
    ProgressAnimation.prototype.doLabelAnimation = function (labelPath, start, end, _progress6, delay, textSize) {
      var animation = new sf.base.Animation({});
      ...
      var percentage = 100;
      var labelText = _progress6.labelStyle.text;
      var labelPos = _progress6.labelStyle.textAlignment;
      var posX = parseInt(labelPath.getAttribute('x'), 10);
      labelPath.setAttribute('visibility', 'Hidden');

      if (_progress6.type === 'Linear') {
        startPos = _progress6.enableRtl ? _progress6.progressRect.x + _progress6.progressRect.width + textSize / 2 : _progress6.progressRect.x - textSize / 2;
        startPos = startPos <= 0 ? 0 : startPos;
        endPos = _progress6.enableRtl ? startPos - posX : posX - startPos;
      }

      animation.animate(labelPath, {
        duration: _progress6.animation.duration,
        delay: delay,
        progress: function progress(args) {
          _progress6.cancelResize = true;
          ...
          if (_progress6.type === 'Linear') {
            if (args.timeStamp >= args.delay) {
              if (labelText === '') {
                ...
                value = effect(args.timeStamp, start, end, args.duration, false);
                valueChanged$$1 = parseInt((value / _progress6.progressRect.width * percentage).toString(), 10);
                labelPath.innerHTML = valueChanged$$1.toString() + '%';

                if (labelPos === 'Far' || labelPos === 'Center') {
                  xPos = effect(args.timeStamp, startPos, endPos, args.duration, _progress6.enableRtl);
                  labelPath.setAttribute('x', xPos.toString());
                }
              }
            }
          } else if (_progress6.type === 'Circular') {
            if (labelText === '') {
              labelPath.setAttribute('visibility', 'visible');
              value = effect(args.timeStamp, start, end, args.duration, false);
              valueChanged$$1 = parseInt(((value - start) / _progress6.totalAngle * percentage).toString(), 10);
              labelPath.innerHTML = valueChanged$$1.toString() + '%';
            }
          }
        },
        end: function end() {
          _progress6.cancelResize = false;
    ...
    ProgressAnimation.prototype.doAnnotationAnimation = function (circularPath, _progress7, previousEnd, previousTotal) {
      var animation = new sf.base.Animation({});
      var value = 0;
      var percentage = 100;
      var isAnnotation = _progress7.annotations.length > 0;
      var annotatElementChanged;
      var firstAnnotatElement;
      var start = _progress7.startAngle;
      var totalAngle = _progress7.totalAngle;
      var totalEnd;
      ...
      if (isAnnotation && _progress7.progressAnnotationModule) {
        firstAnnotatElement = document.getElementById(_progress7.element.id + 'Annotation0').children[0];
      ...
      totalEnd = (_progress7.argsData.value - _progress7.minimum) / (_progress7.maximum - _progress7.minimum) * _progress7.totalAngle;
      _progress7.annotateTotal = totalEnd = _progress7.argsData.value < _progress7.minimum || _progress7.argsData.value > _progress7.maximum ? 0 : totalEnd;
      _progress7.annotateEnd = start + totalEnd;
      annotateValue = (_progress7.argsData.value - _progress7.minimum) / (_progress7.maximum - _progress7.minimum) * percentage;
      annotateValue = _progress7.argsData.value < _progress7.minimum || _progress7.argsData.value > _progress7.maximum ? 0 : Math.round(annotateValue);
      ...
      if (_progress7.argsData.value <= _progress7.minimum || _progress7.argsData.value > _progress7.maximum) {
        annotatElementChanged.innerHTML = annotateValue + '%';
      } else {
        animation.animate(circularPath, {
          duration: _progress7.animation.duration,
          delay: _progress7.animation.delay,
          progress: function progress(args) {
            _progress7.cancelResize = true;
  ...
  function (_super) {
    ...
    ProgressAnnotation.prototype.destroy = function (control) {// Destroy method performed here
    };
  ...
  function () {
    ...
    Segment.prototype.createLinearSegment = function (progress, id, width, opacity, thickness, progressWidth) {
      var locX = progress.enableRtl ? progress.cornerRadius === 'Round' ? progress.progressRect.x + progress.progressRect.width - lineCapRadius / 2 * thickness : progress.progressRect.x + progress.progressRect.width : progress.cornerRadius === 'Round' ? progress.progressRect.x + lineCapRadius / 2 * thickness : progress.progressRect.x;
      ...
      avlSegWidth = (avlSegWidth - (progress.cornerRadius === 'Round' ? progress.segmentCount * (lineCapRadius * thickness) : 0)) / progress.segmentCount;
      var gap = progress.cornerRadius === 'Round' ? gapWidth + lineCapRadius * thickness : gapWidth;
      var segmentGroup = progress.renderer.createGroup({
        'id': progress.element.id + id
      });
    ...
    Segment.prototype.createCircularSegment = function (progress, id, x, y, r, value, opacity, thickness, totalAngle, progressWidth) {
      ...
      end -= progress.cornerRadius === 'Round' && progress.totalAngle === completeAngle ? this.widthToAngle(0, progressWidth, lineCapRadius / 2 * thickness, totalAngle) : 0;
      var size = progressWidth - (progress.totalAngle === completeAngle ? progress.segmentCount : progress.segmentCount - 1) * (progress.gapWidth || progress.themeStyle.circularGapWidth);
      size = (size - (progress.cornerRadius === 'Round' ? (progress.totalAngle === completeAngle ? progress.segmentCount : progress.segmentCount - 1) * lineCapRadius * thickness : 0)) / progress.segmentCount;
      var avlTolEnd = this.widthToAngle(0, progressWidth, progressWidth / progress.segmentCount, totalAngle);
      avlTolEnd -= progress.cornerRadius === 'Round' && progress.totalAngle === completeAngle ? this.widthToAngle(0, progressWidth, lineCapRadius / 2 * thickness, totalAngle) : 0;
      ...
      for (var i = 0; i < count; i++) {
        segmentEnd = progress.enableRtl ? progress.startAngle - end > avlSegEnd ? progress.startAngle - end : avlSegEnd : progress.startAngle + end < avlSegEnd ? progress.startAngle + end : avlSegEnd;
    ...
    Segment.prototype.createLinearRange = function (totalWidth, progress) {
      ...
      var rangeGroup = progress.renderer.createGroup({
        'id': progress.element.id + '_LinearRangeGroup'
      });
      ...
      for (var i = 0; i < range.length; i++) {
        validRange = range[i].start >= rangeMin && range[i].start <= rangeMax && range[i].end >= rangeMin && range[i].end <= rangeMax;
    ...
    Segment.prototype.createCircularRange = function (centerX, centerY, radius, progress) {
      var rangeGroup = progress.renderer.createGroup({
        'id': progress.element.id + '_CircularRangeGroup'
      });
      var range = progress.rangeColors;
      var thickness = progress.progressThickness || progress.themeStyle.linearProgressThickness;
      var opacity = progress.themeStyle.progressOpacity;
      ...
      for (var i = 0; i < range.length; i++) {
        isValidRange = range[i].start >= rangeMin && range[i].start <= rangeMax && range[i].end >= rangeMin && range[i].end <= rangeMax;
  ...
  function () {
    ...
    Linear.prototype.renderLinearTrack = function () {
      ...
      var linearTrackGroup = progress.renderer.createGroup({
        'id': progress.element.id + '_LinearTrackGroup'
      });
      var linearTrack;
      var option;
      var thickness;
      var stroke;
      this.isRange = this.progress.rangeColors[0].color !== '' || this.progress.rangeColors[0].start !== null || this.progress.rangeColors[0].end !== null;
    ...
    Linear.prototype.renderLinearProgress = function (refresh, previousWidth) {
      ...
      progress.previousWidth = linearProgressWidth = progress.progressRect.width * (progress.isIndeterminate && !progress.enableProgressSegments ? 1 : progressWidth);

      if (!refresh) {
        linearProgressGroup = progress.renderer.createGroup({
          'id': progress.element.id + '_LinearProgressGroup'
        });
      } else {
      ...
      progress.segmentSize = !progress.enableProgressSegments ? progress.segmentSize : progress.calculateSegmentSize(progress.progressWidth, thickness);
    ...
    Linear.prototype.renderLinearBuffer = function (progress) {
      ...
      linearBufferGroup = progress.renderer.createGroup({
        'id': progress.element.id + '_LinearBufferGroup'
      });
      thickness = progress.progressThickness || progress.themeStyle.linearProgressThickness;
    ...
    Linear.prototype.renderLinearLabel = function () {
      ...
      linearLabelGroup = progress.renderer.createGroup({
        'id': progress.element.id + '_LinearLabelGroup'
      });
      labelValue = (progress.value - progress.minimum) / (progress.maximum - progress.minimum) * percentage;
      linearValue = progress.value < progress.minimum || progress.value > progress.maximum ? 0 : Math.round(labelValue); // Checking the font color

      rgbValue = convertHexToColor(colorNameToHex(fontBackground));
      contrast = Math.round((rgbValue.r * 299 + rgbValue.g * 587 + rgbValue.b * 114) / 1000);
      argsData = {
        cancel: false,
        text: labelText ? labelText : String(linearValue) + '%',
        color: progress.labelStyle.color
      };
      progress.trigger('textRender', argsData);

      if (!argsData.cancel) {
        textSize = sf.svgbase.measureText(argsData.text, progress.labelStyle);
        defaultPos = progress.enableRtl ? progress.progressRect.x + progress.progressRect.width - textSize.width / 2 : progress.progressRect.x + textSize.width / 2;

        if (textAlignment === 'Near') {
          posX = defaultPos + (progress.enableRtl ? -padding : padding);
        } else if (textAlignment === 'Center') {
          center = progress.enableRtl ? progress.progressRect.x + progress.progressRect.width - progressWidth / 2 : progress.progressRect.x + progressWidth / 2;
          ...
          far = progress.enableRtl ? progress.progressRect.x + progress.progressRect.width - progressWidth + textSize.width / 2 : progress.progressRect.x + progressWidth - textSize.width / 2;
        ...
        if (progress.animation.enable && !progress.isIndeterminate) {
          clipPath = progress.renderer.createClipPath({
            'id': progress.element.id + '_clippathLabel'
          });
    ...
    Linear.prototype.renderLinearStriped = function (color, group, progress) {
      ...
      var stopOption = [];
      gradOption = {
        id: progress.element.id + '_LinearStriped',
        x1: progress.progressRect.x.toString(),
    ...
    Linear.prototype.cornerRadius = function (x, y, width, height, radius, pathtype) {
      ...
      switch (pathtype) {
        case 'start':
          path = 'M' + x + ',' + y + ' ' + 'h' + width + ' ' + 'v' + height + ' ' + 'h' + -width + ' ' + 'a' + radius + ',' + radius + ' 0 0 1 ' + -radius + ',' + -radius + ' ' + 'v' + (2 * radius - height) + ' ' + 'a' + radius + ',' + radius + ' 0 0 1 ' + radius + ',' + -radius + ' ' + 'z';
          break;

        case 'end':
          path = 'M' + x + ',' + y + ' ' + 'h' + (endWidth - endRadius) + ' ' + 'a' + endRadius + ',' + endRadius + ' 0 0 1 ' + endRadius + ',' + endRadius + ' ' + 'v' + (height - 2 * endRadius) + ' ' + 'a' + endRadius + ',' + endRadius + ' 0 0 1 ' + -endRadius + ',' + endRadius + ' ' + 'h' + (radius - endWidth) + ' ' + 'v' + -height + ' ' + 'z';
          break;

        case 'none':
          path = 'M' + x + ',' + y + ' ' + 'h' + width + ' ' + 'v' + height + ' ' + 'h' + -width + ' ' + 'v' + -height + ' ' + 'z';
          break;

        default:
          path = 'M' + x + ',' + y + ' ' + 'h' + (width - radius) + ' ' + 'a' + radius + ',' + radius + ' 0 0 1 ' + radius + ',' + radius + ' ' + 'v' + (height - 2 * radius) + ' ' + 'a' + radius + ',' + radius + ' 0 0 1 ' + -radius + ',' + radius + ' ' + 'h' + (radius - width) + ' ' + 'a' + radius + ',' + radius + ' 0 0 1 ' + -radius + ',' + -radius + ' ' + 'v' + (2 * radius - height) + ' ' + 'a' + radius + ',' + radius + ' 0 0 1 ' + radius + ',' + -radius + ' ' + 'z';
      }
    ...
    Linear.prototype.createRoundCornerSegment = function (id, stroke, thickness, isTrack, progressWidth, progress, opacity) {
      ...
      var segmentGroup = progress.renderer.createGroup({
        'id': progress.element.id + id + 'SegmentGroup'
      });
      var segmentPath;
  ...
  function () {
    ...
    Circular.prototype.renderCircularTrack = function () {
      var progress = this.progress;
      var circularTrackGroup = progress.renderer.createGroup({
        'id': progress.element.id + '_CircularTrackGroup'
      });
      var radius;
      var startAngle;
      var endAngle;
      ...
      this.maxThickness = Math.max(progress.trackThickness, progress.progressThickness) || Math.max(progress.themeStyle.circularProgressThickness, progress.themeStyle.circularTrackThickness);
    ...
    Circular.prototype.renderCircularProgress = function (previousEnd, previousTotalEnd, refresh) {
      ...
      if (!refresh) {
        circularProgressGroup = progress.renderer.createGroup({
          'id': progress.element.id + '_CircularProgressGroup'
        });
      } else {
    ...
    Circular.prototype.renderCircularBuffer = function (progress, radius, progressTotalAngle) {
      ...
      var endAngle;
      var stroke;
      circularBufferGroup = progress.renderer.createGroup({
        'id': progress.element.id + '_ CircularBufferGroup'
      });
    ...
    Circular.prototype.renderCircularLabel = function () {
      ...
      var progress = this.progress;
      var labelText = progress.labelStyle.text;
      circularLabelGroup = progress.renderer.createGroup({
        'id': progress.element.id + '_CircularLabelGroup'
      });
      ...
      argsData = {
        cancel: false,
        text: labelText ? labelText : String(circularValue) + '%',
        color: progress.labelStyle.color
      };
      progress.trigger('textRender', argsData);
    ...
    Circular.prototype.validateSegmentSize = function (progress, thickness) {
      ...
      if (rDiff !== 0 && !progress.enableProgressSegments) {
        progressSegment = progress.trackWidth + (rDiff < 0 ? progress.trackWidth * Math.abs(rDiff) / parseInt(progress.radius, 10) : -(progress.trackWidth * Math.abs(rDiff)) / parseInt(progress.radius, 10));
  ...
  function (_super) {
    ...
    ProgressBar.prototype.preRender = function () {
      var blazor = 'Blazor'; // tslint:disable-next-line
    ...
    ProgressBar.prototype.render = function () {
      ...
      this.trigger('load', {
        progressBar: this.isBlazor ? {} : this
      });
      ...
      if (this.argsData.value === this.maximum) {
        this.trigger(progressCompleted, this.argsData, function () {
          _this.controlRendering();
        });
      } else {
        this.trigger(valueChanged, this.argsData, function () {
          _this.controlRendering();
        });
      }
    };
    ...
    ProgressBar.prototype.clipPathElement = function () {
      this.clipPath = this.renderer.createClipPath({
        'id': this.element.id + '_clippath'
      });
      this.bufferClipPath = this.renderer.createClipPath({
        'id': this.element.id + '_clippathBuffer'
      });
    };
    ...
    ProgressBar.prototype.getPathLine = function (x, width, thickness) {
      var moveTo = this.enableRtl ? this.cornerRadius === 'Round' ? x + this.progressRect.width - lineCapRadius / 2 * thickness : x + this.progressRect.width : this.cornerRadius === 'Round' ? x + lineCapRadius / 2 * thickness : x;
      var lineTo = this.enableRtl ? this.cornerRadius === 'Round' && width ? moveTo - width + lineCapRadius * thickness : moveTo - width : this.cornerRadius === 'Round' && width ? moveTo + width - lineCapRadius * thickness : moveTo + width;
      return 'M' + moveTo + ' ' + (this.progressRect.y + this.progressRect.height / 2) + 'L' + lineTo + ' ' + (this.progressRect.y + this.progressRect.height / 2);
    };
    ...
    ProgressBar.prototype.createClipPath = function (clipPath, range, d, refresh, thickness, isLabel, isMaximum) {
      ...
      if (this.type === 'Linear') {
        if (this.cornerRadius === 'Round4px') {
          ...
          pathWidth = totalWidth * range;
          posx += this.cornerRadius === 'Round' && !isLabel ? this.enableRtl ? lineCapRadius / 2 * thickness : -(lineCapRadius / 2) * thickness : 0;
    ...
    ProgressBar.prototype.setTheme = function () {
      ...
      switch (this.theme) {
        case 'Bootstrap':
        case 'Bootstrap4':
          this.cornerRadius = this.cornerRadius === 'Auto' ? this.type === 'Linear' ? 'Round4px' : 'Round' : this.cornerRadius;
          break;
    ...
    ProgressBar.prototype.progressResize = function (e) {
      var _this = this; // 800 used as buffer time for resize event preventing from control rendered time
    ...
    __decorate([sf.base.Property('Linear')], ProgressBar.prototype, "type", void 0);

    __decorate([sf.base.Property(null)], ProgressBar.prototype, "value", void 0);

    __decorate([sf.base.Property(null)], ProgressBar.prototype, "secondaryProgress", void 0);

    __decorate([sf.base.Property(0)], ProgressBar.prototype, "minimum", void 0);

    __decorate([sf.base.Property(100)], ProgressBar.prototype, "maximum", void 0);

    __decorate([sf.base.Property(0)], ProgressBar.prototype, "startAngle", void 0);

    __decorate([sf.base.Property(0)], ProgressBar.prototype, "endAngle", void 0);

    __decorate([sf.base.Property('100%')], ProgressBar.prototype, "radius", void 0);

    __decorate([sf.base.Property('100%')], ProgressBar.prototype, "innerRadius", void 0);

    __decorate([sf.base.Property(1)], ProgressBar.prototype, "segmentCount", void 0);

    __decorate([sf.base.Property(null)], ProgressBar.prototype, "gapWidth", void 0);

    __decorate([sf.base.Property('')], ProgressBar.prototype, "segmentColor", void 0);

    __decorate([sf.base.Property('Auto')], ProgressBar.prototype, "cornerRadius", void 0);

    __decorate([sf.base.Property(null)], ProgressBar.prototype, "height", void 0);

    __decorate([sf.base.Property(null)], ProgressBar.prototype, "width", void 0);

    __decorate([sf.base.Property(false)], ProgressBar.prototype, "isIndeterminate", void 0);

    __decorate([sf.base.Property(false)], ProgressBar.prototype, "isActive", void 0);

    __decorate([sf.base.Property(false)], ProgressBar.prototype, "isGradient", void 0);

    __decorate([sf.base.Property(false)], ProgressBar.prototype, "isStriped", void 0);

    __decorate([sf.base.Property('Auto')], ProgressBar.prototype, "role", void 0);

    __decorate([sf.base.Property(false)], ProgressBar.prototype, "enableRtl", void 0);

    __decorate([sf.base.Property(null)], ProgressBar.prototype, "trackColor", void 0);

    __decorate([sf.base.Property(null)], ProgressBar.prototype, "progressColor", void 0);

    __decorate([sf.base.Property(0)], ProgressBar.prototype, "trackThickness", void 0);

    __decorate([sf.base.Property(0)], ProgressBar.prototype, "progressThickness", void 0);

    __decorate([sf.base.Property(false)], ProgressBar.prototype, "enablePieProgress", void 0);

    __decorate([sf.base.Property('Fabric')], ProgressBar.prototype, "theme", void 0);

    __decorate([sf.base.Property(false)], ProgressBar.prototype, "showProgressValue", void 0);

    __decorate([sf.base.Property(false)], ProgressBar.prototype, "enableProgressSegments", void 0);
    ...
    __decorate([sf.base.Complex({
      ...
      fontWeight: 'Normal',
      fontFamily: null
    }, Font)], ProgressBar.prototype, "labelStyle", void 0);

    __decorate([sf.base.Complex({}, Margin)], ProgressBar.prototype, "margin", void 0);

    __decorate([sf.base.Complex({}, Animation$1)], ProgressBar.prototype, "animation", void 0);

    __decorate([sf.base.Event()], ProgressBar.prototype, "load", void 0);

    __decorate([sf.base.Event()], ProgressBar.prototype, "textRender", void 0);

    __decorate([sf.base.Event()], ProgressBar.prototype, "loaded", void 0);

    __decorate([sf.base.Event()], ProgressBar.prototype, "valueChanged", void 0);

    __decorate([sf.base.Event()], ProgressBar.prototype, "progressCompleted", void 0);

    __decorate([sf.base.Event()], ProgressBar.prototype, "animationComplete", void 0);

    __decorate([sf.base.Event()], ProgressBar.prototype, "mouseClick", void 0);

    __decorate([sf.base.Event()], ProgressBar.prototype, "mouseMove", void 0);

    __decorate([sf.base.Event()], ProgressBar.prototype, "mouseUp", void 0);

    __decorate([sf.base.Event()], ProgressBar.prototype, "mouseDown", void 0);

    __decorate([sf.base.Event()], ProgressBar.prototype, "mouseLeave", void 0);

    __decorate([sf.base.Collection([{}], ProgressAnnotationSettings)], ProgressBar.prototype, "annotations", void 0);

    __decorate([sf.base.Collection([{}], RangeColor)], ProgressBar.prototype, "rangeColors", void 0);

    ProgressBar = __decorate([sf.base.NotifyPropertyChanges], ProgressBar);
    return ProgressBar;
  }(sf.base.Component);
  /**
...
sfBlazor.loadDependencies(sfBlazor.dependencyJson.progressbar, function () {
