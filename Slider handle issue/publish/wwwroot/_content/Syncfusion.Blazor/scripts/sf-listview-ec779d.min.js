...
window.sfBlazor.ListView = function () {
  ...
  function () {
    ...
    function SfListView(element, dotnetRef, properties, enableSelectEvent) {
      ...
      this.liDifference = 0;
      this.liHeight = 0;
      this.virtualListDifference = 0; // tslint:enable
    ...
    SfListView.prototype.getSelectEventData = function (liElement, event) {
      ...
      var clickEventArgs = {
        ...
        IsChecked: checked,
        Key: liElement.classList.contains(HASCHILD) ? this.dataSourceLevel[this.dataSourceLevel.length - 2] : this.curDSKey,
  ...
  var listView = {
    // tslint:disable
    initialize: function initialize(element, dotnetRef, properties, isSelect, liDiff) {
      // tslint:enable
