...
var dropdownsbase = function dropdownsbase(exports) {
  ...
  function (_super) {
    ...
    DropDownBase.prototype.setEnableRtl = function () {
      ...
      this.enableRtl ? sf.base.addClass(this.enableRtlElements, dropDownBaseClasses.rtl) : sf.base.removeClass(this.enableRtlElements, dropDownBaseClasses.rtl);
    };
    /**
    ...
    DropDownBase.prototype.typeOfData = function (items) {
      ...
      for (var i = 0; !sf.base.isNullOrUndefined(items) && i < items.length; i++) {
        if (!sf.base.isNullOrUndefined(items[i])) {
          ...
          if (!isNullData) {
            return item = {
              typeof: _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(items[i]),
              item: items[i]
            };
          }
        }
    ...
    DropDownBase.prototype.addItem = function (items, itemIndex) {
      ...
      for (var i = 0; i < items.length; i++) {
        ...
        if (this.itemTemplate && !isHeader) {
          var compiledString = sf.base.compile(this.itemTemplate); // tslint:disable-next-line
