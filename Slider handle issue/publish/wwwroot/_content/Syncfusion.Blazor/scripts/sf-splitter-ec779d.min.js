...
window.sfBlazor.Splitter = function () {
  ...
  function () {
    ...
    SfSplitter.prototype.onMouseMove = function (e) {
      ...
      this.nextPaneHeightWidth = _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(this.nextPaneHeightWidth) === STRING && this.nextPaneHeightWidth.indexOf('p') > -1 ? this.convertPixelToNumber(this.nextPaneHeightWidth) : parseInt(this.nextPaneHeightWidth, RADIX);
    ...
    SfSplitter.prototype.isCollapsed = function (index) {
      if (!sf.base.isNullOrUndefined(index) && this.paneSettings[index].collapsed && sf.base.isNullOrUndefined(this.allPanes[index].classList.contains(COLLAPSE_PANE))) {
        return;
      }
