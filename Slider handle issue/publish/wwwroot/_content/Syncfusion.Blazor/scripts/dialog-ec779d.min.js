      ...
      if (this.preventVisibility) {
        ...
        this.trigger('beforeClose', eventArgs, function (beforeCloseArgs) {
          if (!beforeCloseArgs.cancel) {
            if (_this.isModal) {
              !sf.base.isNullOrUndefined(_this.targetEle) ? sf.base.removeClass([_this.targetEle], [DLG_TARGET, SCROLL_DISABLED]) : sf.base.removeClass([document.body], [DLG_TARGET, SCROLL_DISABLED]);
            }
