...
var sfcombobox = function sfcombobox(exports) {
  ...
  function (_super) {
    ...
    ComboBox.prototype.clearAll = function (e, property) {
      if (sf.base.isNullOrUndefined(property) || !sf.base.isNullOrUndefined(property) && sf.base.isNullOrUndefined(property.dataSource) || sf.base.isNullOrUndefined(this.itemData) && this.allowFiltering) {
