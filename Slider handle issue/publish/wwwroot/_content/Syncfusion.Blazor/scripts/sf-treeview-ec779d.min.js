...
window.sfBlazor.TreeView = function () {
  ...
  function () {
    ...
    SfTreeView.prototype.appendNode = function (dropTarget, dragLi, dropLi, e, dragObj, offsetY) {
      ...
      if (!dragLi.classList.contains(DISABLE) && !checkContainer && (expand && e.event.offsetY < 5 || collapse && e.event.offsetX < 3 || expand && e.event.offsetY > 19 || collapse && e.event.offsetX > 19 || !expand && !collapse)) {
    ...
    SfTreeView.prototype.dragAction = function (e, virtualEle) {
      ...
      if (dropRoot) {
        ...
        if (!dropRoot.classList.contains(ROOT) || dropWrap && !dropLi.isSameNode(this.dragLi) && !this.isDescendant(this.dragLi, dropLi)) {
          if (dropLi && e && !expand && !collapse && e.event.offsetY < 7 && !checkContainer || expand && e.event.offsetY < 5 || collapse && e.event.offsetX < 3) {
          ...
          } else if (dropLi && e && !expand && !collapse && e.target.offsetHeight > 0 && e.event.offsetY > e.target.offsetHeight - 10 && !checkContainer || expand && e.event.offsetY > 19 || collapse && e.event.offsetX > 19) {
            sf.base.addClass([icon], DROPNEXT);
            var element = sf.base.createElement('div', {
              className: SIBLING
            });
  ...
  var TreeView = {
    ...
    selectedNode: function selectedNode(element, args) {
      if (this.valid(element)) {
