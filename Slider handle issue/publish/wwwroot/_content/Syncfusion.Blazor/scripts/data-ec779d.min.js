...
window.sf.data = function (exports) {
  ...
  function () {
    ...
    DataUtil.getFieldList = function (obj, fields, prefix) {
      ...
      for (var _i = 0, keys_1 = keys; _i < keys_1.length; _i++) {
        ...
        if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(copyObj[prop]) === 'object' && !(copyObj[prop] instanceof Array)) {
    ...
    DataUtil.distinct = function (json, fieldName, requiresCompleteRecord) {
      ...
      json.forEach(function (data, index) {
        val = _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(json[index]) === 'object' ? DataUtil.getVal(json, index, fieldName) : json[index];
    ...
    DataUtil.parse = {
      ...
      parseJson: function parseJson(jsonText) {
        ...
        } else if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(jsonText) === 'object' && jsonText !== null) {
  ...
  function (_super) {
    ...
    JsonAdaptor.prototype.remove = function (dm, keyField, value, tableName) {
      ...
      if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(value) === 'object' && !(value instanceof Date)) {
  ...
  function (_super) {
    ...
    UrlAdaptor.prototype.processQuery = function (dm, query, hierarchyFilters) {
      ...
      for (var i = 0; i < queries.filters.length; i++) {
        ...
        var keys_3 = _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(request.filters[i]) === 'object' ? Object.keys(request.filters[i]) : [];
  ...
  function () {
    ...
    function DataManager(dataSource, query, adaptor) {
      ...
      } else if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(dataSource) === 'object') {
        if (!dataSource.json) {
          dataSource.json = [];
        }
