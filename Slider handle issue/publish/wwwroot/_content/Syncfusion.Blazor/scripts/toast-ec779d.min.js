...
var sftoast = function sftoast(exports) {
  ...
  function (_super) {
    ...
    Toast.prototype.hide = function (element) {
      ...
      this.destroyToast(element); // tslint:disable-next-line:no-any
    ...
    Toast.prototype.setContent = function () {
      ...
      if (sf.base.isNullOrUndefined(this.content) || this.content === '') {
        ...
        if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(this.content) === 'object' && !sf.base.isNullOrUndefined(this.content.tagName)) {
