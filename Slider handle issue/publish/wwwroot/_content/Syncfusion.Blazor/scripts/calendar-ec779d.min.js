...
var sfcalendar = function sfcalendar(exports) {
  ...
  function (_super) {
    ...
    CalendarBase.prototype.destroy = function () {
      ...
      if (this.getModuleName() === 'calendar') {
        ...
        !sf.base.isNullOrUndefined(this.calendarEleCopy.getAttribute('tabindex')) ? this.element.setAttribute('tabindex', this.tabIndex) : this.element.removeAttribute('tabindex');
      }
    ...
    CalendarBase.prototype.getFromatStringValue = function () {
      return sf.base.isBlazor() ? // tslint:disable-next-line
  ...
  function (_super) {
    ...
    Calendar.prototype.render = function () {
      ...
      if (this.isMultiSelection && _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(this.values) === 'object' && !sf.base.isNullOrUndefined(this.values) && this.values.length > 0) {
        var tempValues = [];
        var copyValues = [];
    ...
    Calendar.prototype.addDate = function (dates) {
      if (typeof dates !== 'string' && typeof dates !== 'number') {
        ...
        if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(dates) === 'object' && dates.length > 0) {
          var tempDates = dates;
