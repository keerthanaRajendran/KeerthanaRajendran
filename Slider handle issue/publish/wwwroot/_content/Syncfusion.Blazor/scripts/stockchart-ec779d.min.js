...
window.sf=window.sf||{};var sfstockchart=function sfstockchart(exports){'use strict';/**
 ...
 */ /** @private */ /** @private */ /** @private */function getRangeValueXByPoint(value,size,range,inversed){var actualValue=!inversed?value/size:1-value/size;return actualValue*range.delta+range.min;}/** @private */ /** @private */ /**
...
if(chart.visibleSeries.length===chart.visibleSeriesCount){chart.refreshBound();chart.trigger('loaded',{chart:chart.isBlazor?{}:chart});if(this.chart.stockChart&&this.chart.stockChart.initialRender){this.chart.stockChart.stockChartDataManagerSuccess();this.chart.stockChart.initialRender=false;}}if(this instanceof Series){chart.visibleSeriesCount+=isRemoteData?0:1;}};__decorate$5([sf.base.Property('')],SeriesBase.prototype,"xName",void 0);__decorate$5([sf.base.Property('')],SeriesBase.prototype,"high",void 0);__decorate$5([sf.base.Property('')],SeriesBase.prototype,"low",void 0);__decorate$5([sf.base.Property('')],SeriesBase.prototype,"open",void 0);__decorate$5([sf.base.Property('')],SeriesBase.prototype,"close",void 0);__decorate$5([sf.base.Property('')],SeriesBase.prototype,"volume",void 0);__decorate$5([sf.base.Property('')],SeriesBase.prototype,"pointColorMapping",void 0);__decorate$5([sf.base.Property(true)],SeriesBase.prototype,"visible",void 0);__decorate$5([sf.base.Property(null)],SeriesBase.prototype,"xAxisName",void 0);__decorate$5([sf.base.Property(null)],SeriesBase.prototype,"yAxisName",void 0);__decorate$5([sf.base.Complex(null,Animation$1)],SeriesBase.prototype,"animation",void 0);__decorate$5([sf.base.Property(null)],SeriesBase.prototype,"fill",void 0);__decorate$5([sf.base.Property(1)],SeriesBase.prototype,"width",void 0);__decorate$5([sf.base.Property('0')],SeriesBase.prototype,"dashArray",void 0);__decorate$5([sf.base.Property('')],SeriesBase.prototype,"dataSource",void 0);__decorate$5([sf.base.Property()],SeriesBase.prototype,"query",void 0);__decorate$5([sf.base.Collection([],ChartSegment)],SeriesBase.prototype,"segments",void 0);__decorate$5([sf.base.Property('X')],SeriesBase.prototype,"segmentAxis",void 0);__decorate$5([sf.base.Property(false)],SeriesBase.prototype,"enableComplexProperty",void 0);return SeriesBase;}(sf.base.ChildProperty);/**
 * Configures the series in charts.
 * @public
 */var Series=/** @class */function(_super){__extends$6(Series,_super);// tslint:disable-next-line:no-any
...
this.chart.clearTemplate();if(tooltipElement&&this.previousPoints.length>0){this.toolTipInterval=setTimeout(function(){if(_this.svgTooltip){_this.svgTooltip.fadeOut();}},duration);}};return BaseTooltip;}(ChartData);var __extends$7=undefined&&undefined.__extends||function(){var _extendStatics8=function extendStatics(d,b){_extendStatics8=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(d,b){d.__proto__=b;}||function(d,b){for(var p in b){if(b.hasOwnProperty(p))d[p]=b[p];}};return _extendStatics8(d,b);};return function(d,b){_extendStatics8(d,b);function __(){this.constructor=d;}d.prototype=b===null?Object.create(b):(__.prototype=b.prototype,new __());};}();/**
 * @private
 ...
 */var StockChart=/** @class */function(_super){__extends(StockChart,_super);/**
     ...
     * @hidden
     */function StockChart(options,element){var _this=_super.call(this,options,element)||this;/** @private */_this.isSingleAxis=false;_this.chartid=57723;_this.tempSeriesType=[];/** private */_this.zoomChange=false;/** @private */_this.allowPan=false;/** @private  */_this.onPanning=false;/** @private */_this.trendlinetriggered=true;/** @private */_this.toolbarHeight=_this.enablePeriodSelector?sf.base.Browser.isDevice?56:42:0;/** @private */_this.initialRender=true;/** @private */_this.rangeFound=false;/** @private */_this.tempPeriods=[];return _this;}/**
...
if(!this.enableSelector){this.cartesianChart.cartesianChartRefresh(this,this.startValue,this.endValue);}}};StockChart.prototype.chartRender=function(){this.cartesianChart=new CartesianChart(this);this.cartesianChart.initializeChart();};/**
...
if(!document.getElementById(this.element.id)){return false;}this.animateSeries=false;if(this.resizeTo){clearTimeout(this.resizeTo);}this.resizeTo=setTimeout(function(){calculateSize(_this);_this.renderBorder();_this.renderTitle();_this.cartesianChart.cartesianChartRefresh(_this,_this.startValue,_this.endValue);_this.mainObject.setAttribute('width',_this.availableSize.width.toString());if(_this.enablePeriodSelector){_this.renderPeriodSelector();}},500);return false;};/**
     ...
     */StockChart.prototype.setMouseXY=function(pageX,pageY){var svgRect=getElement$1(this.element.id+'_stockChart_chart').getBoundingClientRect();var rect=this.element.getBoundingClientRect();this.mouseX=pageX-rect.left-Math.max(svgRect.left-rect.left,0);this.mouseY=pageY-rect.top-Math.max(svgRect.top-rect.top,0);};/**
...
var element=void 0;if(this.chart.tooltip.enable||this.crosshair.enable){element=document.getElementById(this.element.id+'_stockChart_chart_tooltip');if(element){sf.base.remove(element);}}if(getElement$1(this.element.id+'_StockEvents_Tooltip')){this.stockEvent.removeStockEventTooltip(0);}}if(e.target.id.indexOf('StockEvents')!==-1){clearInterval(this.stockEvent.toolTipInterval);this.stockEvent.renderStockEventTooltip(e.target.id);}else{if(this.stockEvent){this.stockEvent.removeStockEventTooltip(1000);}}this.isTouch=false;return false;};/**
     ...
     * @return {boolean}
     * @private
     */StockChart.prototype.stockChartOnMouseLeaveEvent=function(e){var element=e.target;var cancelEvent=sf.base.Browser.isPointer?'pointerleave':'mouseleave';//this.trigger(chartMouseLeave, { target: element.id, x: this.mouseX, y: this.mouseY });
 ...
 */var LegendSettings=/** @class */function(_super){__extends$12(LegendSettings,_super);function LegendSettings(){return _super!==null&&_super.apply(this,arguments)||this;}__decorate$7([sf.base.Property(true)],LegendSettings.prototype,"visible",void 0);__decorate$7([sf.base.Property(null)],LegendSettings.prototype,"height",void 0);__decorate$7([sf.base.Property(null)],LegendSettings.prototype,"width",void 0);__decorate$7([sf.base.Complex({x:0,y:0},Location)],LegendSettings.prototype,"location",void 0);__decorate$7([sf.base.Property('Auto')],LegendSettings.prototype,"position",void 0);__decorate$7([sf.base.Property(8)],LegendSettings.prototype,"padding",void 0);__decorate$7([sf.base.Property('Center')],LegendSettings.prototype,"alignment",void 0);__decorate$7([sf.base.Complex(Theme.legendLabelFont,Font)],LegendSettings.prototype,"textStyle",void 0);__decorate$7([sf.base.Property(10)],LegendSettings.prototype,"shapeHeight",void 0);__decorate$7([sf.base.Property(10)],LegendSettings.prototype,"shapeWidth",void 0);__decorate$7([sf.base.Complex({},Border)],LegendSettings.prototype,"border",void 0);__decorate$7([sf.base.Complex({left:0,right:0,top:0,bottom:0},Margin)],LegendSettings.prototype,"margin",void 0);__decorate$7([sf.base.Property(5)],LegendSettings.prototype,"shapePadding",void 0);__decorate$7([sf.base.Property('transparent')],LegendSettings.prototype,"background",void 0);__decorate$7([sf.base.Property(1)],LegendSettings.prototype,"opacity",void 0);__decorate$7([sf.base.Property(true)],LegendSettings.prototype,"toggleVisibility",void 0);__decorate$7([sf.base.Property(null)],LegendSettings.prototype,"description",void 0);__decorate$7([sf.base.Property(3)],LegendSettings.prototype,"tabIndex",void 0);__decorate$7([sf.base.Property(null)],LegendSettings.prototype,"title",void 0);__decorate$7([sf.base.Complex(Theme.legendTitleFont,Font)],LegendSettings.prototype,"titleStyle",void 0);__decorate$7([sf.base.Property('Top')],LegendSettings.prototype,"titlePosition",void 0);__decorate$7([sf.base.Property(100)],LegendSettings.prototype,"maximumTitleWidth",void 0);__decorate$7([sf.base.Property(true)],LegendSettings.prototype,"enablePages",void 0);return LegendSettings;}(sf.base.ChildProperty);/**
 ...
 */var Chart$1=/** @class */function(_super){__extends$9(Chart$$1,_super);/**
     * Constructor for creating the widget
     * @hidden
     */function Chart$$1(options,element){var _this=_super.call(this,options,element)||this;/** @public */_this.animated=false;/** @private */_this.isPointMouseDown=false;/** @private */_this.isScrolling=false;/** @private */_this.checkResize=0;/** @private */_this.visible=0;/** @private */_this.clickCount=0;/** @private */_this.singleClickTimer=0;/** @private */_this.chartAreaType='Cartesian';/** @private */_this.isRtlEnabled=window.getComputedStyle(document.querySelector('body')).direction==='rtl';_this.chartid=57723;sf.base.setValue('mergePersistData',_this.mergePersistChartData,_this);return _this;}/**
...
element.style.overflow='hidden';};/**
     ...
     * To find mouse x, y for aligned chart element svg position
     */Chart$$1.prototype.setMouseXY=function(pageX,pageY){var svgRect=getElement$1(this.svgId).getBoundingClientRect();var rect=this.element.getBoundingClientRect();this.mouseY=pageY-rect.top-Math.max(svgRect.top-rect.top,0);this.mouseX=pageX-rect.left-Math.max(svgRect.left-rect.left,0);};/**
...
if(!this.isTouch){this.titleTooltip(e,this.mouseX,this.mouseY);this.axisTooltip(e,this.mouseX,this.mouseY);}if(this.dataEditingModule){this.dataEditingModule.pointMouseMove(e);}this.notify(sf.base.Browser.touchMoveEvent,e);this.isTouch=false;return false;};Chart$$1.prototype.titleTooltip=function(event,x,y,isTouch){var targetId=event.target.id;var id=targetId===this.element.id+'_ChartTitle'||targetId===this.element.id+'_ChartSubTitle'||targetId.indexOf('_AxisTitle')>-1||targetId.indexOf('_legend_title')>-1;var index=0;if(targetId.indexOf('_AxisTitle')>-1){index=parseInt(targetId.replace(this.element.id,'').replace('AxisLabel_','').split('_')[2],10);}if(id&&event.target.textContent.indexOf('...')>-1){var title=targetId===this.element.id+'_ChartTitle'?this.title:targetId.indexOf('_AxisTitle')>-1?this.axisCollections[index].title:targetId.indexOf('_ChartSubTitle')>-1?this.subTitle:this.legendSettings.title;showTooltip(title,x,y,this.element.offsetWidth,this.element.id+'_EJ2_Title_Tooltip',getElement$1(this.element.id+'_Secondary_Element'),isTouch);}else{removeElement(this.element.id+'_EJ2_Title_Tooltip');}};Chart$$1.prototype.axisTooltip=function(event,x,y,isTouch){var targetId=event.target.id;if((targetId.indexOf('AxisLabel')>-1||targetId.indexOf('Axis_MultiLevelLabel')>-1)&&event.target.textContent.indexOf('...')>-1){showTooltip(this.findAxisLabel(targetId),x,y,this.element.offsetWidth,this.element.id+'_EJ2_AxisLabel_Tooltip',getElement$1(this.element.id+'_Secondary_Element'),isTouch);}else{removeElement(this.element.id+'_EJ2_AxisLabel_Tooltip');}};Chart$$1.prototype.findAxisLabel=function(text){var texts;if(text.indexOf('AxisLabel')>-1){texts=text.replace(this.element.id,'').replace('AxisLabel_','').split('_');return this.axisCollections[parseInt(texts[0],10)].visibleLabels[parseInt(texts[1],10)].originalText;}else{texts=text.replace(this.element.id,'').replace('Axis_MultiLevelLabel_Level_','').replace('Text_','').split('_');return this.axisCollections[parseInt(texts[0],10)].multiLevelLabels[parseInt(texts[1],10)].categories[parseInt(texts[2],10)].text;}};/**
     ...
     * @return {boolean}
     * @private
     */Chart$$1.prototype.chartOnMouseUp=function(e){var element=e.target;this.trigger(chartMouseUp,{target:element.id,x:this.mouseX,y:this.mouseY});this.isChartDrag=false;if(this.isTouch){this.titleTooltip(e,this.mouseX,this.mouseY,this.isTouch);this.axisTooltip(e,this.mouseX,this.mouseY,this.isTouch);this.threshold=new Date().getTime()+300;}if(this.dataEditingModule){this.dataEditingModule.pointMouseUp();}if(!this.enableCanvas){this.seriesElements.removeAttribute('clip-path');}this.notify(sf.base.Browser.touchEndEvent,e);return false;};/**
     * Method to set culture for chart
 ...
 */var BarSeries=/** @class */function(_super){__extends$23(BarSeries,_super);function BarSeries(){return _super!==null&&_super.apply(this,arguments)||this;}/**
     ...
     */BarSeries.prototype.destroy=function(chart){/**
         ...
         */};/**
     * Get module name
     */BarSeries.prototype.getModuleName=function(){return'BarSeries';};return BarSeries;}(ColumnBase);var __extends$25=undefined&&undefined.__extends||function(){var _extendStatics25=function extendStatics(d,b){_extendStatics25=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(d,b){d.__proto__=b;}||function(d,b){for(var p in b){if(b.hasOwnProperty(p))d[p]=b[p];}};return _extendStatics25(d,b);};return function(d,b){_extendStatics25(d,b);function __(){this.constructor=d;}d.prototype=b===null?Object.create(b):(__.prototype=b.prototype,new __());};}();var PolarRadarPanel=/** @class */function(_super){__extends$25(PolarRadarPanel,_super);function PolarRadarPanel(){var _this=_super!==null&&_super.apply(this,arguments)||this;/** @private */_this.visibleAxisLabelRect=[];return _this;}/**
