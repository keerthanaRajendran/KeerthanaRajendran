...
var sftimepicker = function sftimepicker(exports) {
  ...
  function (_super) {
    ...
    TimePicker.prototype.checkInvalidValue = function (value) {
      ...
      if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(value) !== 'object' && !sf.base.isNullOrUndefined(value)) {
    ...
    TimePicker.prototype.createDateObj = function (val) {
      var formatStr = sf.base.isBlazor() ? // tslint:disable-next-line
    ...
    TimePicker.prototype.documentClickHandler = function (event) {
      ...
      if (!sf.base.closest(target, '#' + this.popupObj.element.id) && target !== this.inputElement && target !== (this.inputWrapper && this.inputWrapper.buttons[0]) && target !== (this.inputWrapper && this.inputWrapper.clearButton) && target !== (this.inputWrapper && this.inputWrapper.container)) {
        if (this.isPopupOpen()) {
          this.hide();
          this.focusOut();
        }
