...
var sftooltip = function sftooltip(exports) {
  ...
  function (_super) {
      ...
      if (!sf.base.isNullOrUndefined(this.content)) {
        if (this.isBlazorTooltip || !this.isServerRender()) {
          ...
          if (this.content instanceof HTMLElement) {
            ...
            sf.base.append(templateFunction({}, this, 'content', this.element.id + 'content'), tooltipContent);
    ...
    Tooltip.prototype.contentUpdated = function (args) {
      if (sf.base.isNullOrUndefined(this.tooltipEle)) {
        if (this.isServerRender()) {
          ...
          if (this.tooltipEle) {
            this.tooltipEle.setAttribute('style', 'width:' + sf.base.formatUnit(this.width) + ';height:' + sf.base.formatUnit(this.height) + ';position:absolute;');
    ...
    Tooltip.prototype.needTemplateReposition = function () {
      ...
      var tooltip = this;
      return !sf.base.isNullOrUndefined(tooltip.viewContainerRef) && typeof tooltip.viewContainerRef !== 'string' || this.isServerRender() && this.isBlazorTemplate;
    };
    ...
    Tooltip.prototype.collisionFlipFit = function (target, x, y) {
      ...
      var left = sf.popups.fit(this.tooltipEle, this.target ? this.element : null, {
        X: true,
        Y: false
      }, eleOffset).left;
      this.tooltipEle.style.display = 'block';
