...
window.sfBlazor.Schedule = function () {
  ...
  function () {
    ...
    VerticalEvent.prototype.addOrRemoveClass = function () {
      ...
      countCell.filter(function (element) {
        !_this.parent.uiStateValues.expand && _this.allDayLevel > 2 ? sf.base.removeClass([element], DISABLE_CLASS) : sf.base.addClass([element], DISABLE_CLASS);
      });
    };
  ...
  function (_super) {
    ...
    MonthEvent.prototype.renderAppointments = function () {
      if (this.parent.options.currentView === 'Month') {
        ...
        for (var i = 0; i < elementList.length; i++) {
          ...
          var appTop = this.monthHeaderHeight + (ele.classList.contains('e-block-appointment') ? top_1 : top_1 + EVENT_GAP + overlapCount * (appHeight + EVENT_GAP)) + EVENT_TOP;
    ...
    MonthEvent.prototype.getCellTd = function (resIndex, date) {
      if (this.parent.activeViewOptions.group.resources.length > 0 && !this.parent.uiStateValues.isGroupAdaptive) {
        return this.parent.element.querySelector('.' + CONTENT_WRAP_CLASS + ' ' + 'tbody td[data-group-index="' + resIndex.toString() + '"][data-date="' + date + '"]');
      }

      return this.parent.element.querySelector('.' + CONTENT_WRAP_CLASS + ' ' + 'tbody td[data-date="' + date + '"]');
    };
    ...
    MonthEvent.prototype.updateBlockElements = function () {
      ...
      for (var _i = 0, blockElement_2 = blockElement; _i < blockElement_2.length; _i++) {
        ...
        var appLeft = this.parent.options.enableRtl ? 0 : cellTd.offsetLeft;
        var appRight = this.parent.options.enableRtl ? cellTd.parentElement.offsetWidth - cellTd.offsetLeft - this.cellWidth : 0;
        var appTop = cellTd.offsetTop + this.monthHeaderHeight + EVENT_TOP;
    ...
    MonthEvent.prototype.updateNormalEventElements = function (appHeight) {
      ...
      for (var _i = 0, blockElement_3 = blockElement; _i < blockElement_3.length; _i++) {
        ...
        var appLeft = this.parent.options.enableRtl ? 0 : cellTd.offsetLeft;
        var appRight = this.parent.options.enableRtl ? cellTd.parentElement.offsetWidth - cellTd.offsetLeft - this.cellWidth : 0;
        var top_2 = this.monthHeaderHeight + (cellTd.offsetTop + EVENT_GAP) + overlapCount * (appHeight + EVENT_GAP) + EVENT_TOP;
        sf.base.setStyleAttribute(element, {
          'left': appLeft + 'px',
          'right': appRight + 'px',
          'top': top_2 + 'px'
  ...
  function (_super) {
    ...
    TimelineEvent.prototype.renderAppointments = function () {
      ...
      for (var i = 0; i < elementList.length; i++) {
        ...
        if (this.day >= 0) {
          ...
          var appLeft = 0;
          var appRight = 0;
          var position = this.getPosition(startTime, endTime, isAllDay, this.day);
          appWidth = appWidth <= 0 ? this.cellWidth : appWidth; // appWidth 0 when start and end time as same

          var resIndex = this.getGroupIndex(ele);
          var top_1 = this.getRowTop(resIndex);
          var appTop = ele.classList.contains('e-block-appointment') ? top_1 : top_1 + EVENT_GAP$1 + overlapCount * (appHeight + EVENT_GAP$1);
    ...
    TimelineEvent.prototype.renderEvents = function (event, resIndex, appointmentsList) {
      ...
      var appTop = top + EVENT_GAP$1 + (
      /*overlapCount */
      appHeight + EVENT_GAP$1);
      ...
      if (this.parent.activeViewOptions.allowVirtualScrolling) {
        ...
        if (conWrap.scrollTop - this.translateY < 0) {
          ...
          if (index === 0) {
            ...
            this.translateY = conWrap.scrollTop - this.elementHeight * this.bufferCount > 0 ? conWrap.scrollTop - this.elementHeight * this.bufferCount : 0;
          }
  ...
  function () {
    ...
    ActionBase.prototype.getContentAreaDimension = function () {
      ...
      if (!this.parent.isTimelineView() && this.parent.activeViewOptions.group.resources.length > 0 && !this.parent.isAdaptive) {
  ...
  function (_super) {
    ...
    Resize.prototype.resizeStart = function (e) {
      ...
      var args = JSON.stringify(resizeArgs); // tslint:disable-next-line:no-any
      ...
      this.parent.dotNetRef.invokeMethodAsync('OnResizeStart', args, dataGuid).then(function (dataObj) {
        ...
        if (_this.parent.options.currentView === 'Month') {
    ...
    Resize.prototype.resizeStop = function () {
      ...
      var endTime = addLocalOffset(this.actionObj.end); // tslint:disable-next-line:no-any
    ...
    Resize.prototype.getLeftRightStyles = function (e, isLeft) {
      ...
      var targetWidth = isTimelineView ? this.actionObj.element.offsetWidth / this.actionObj.cellWidth * this.actionObj.cellWidth : this.parent.options.currentView === 'Month' ? this.actionObj.element.offsetWidth : Math.ceil(this.actionObj.element.offsetWidth / this.actionObj.cellWidth) * this.actionObj.cellWidth;
  ...
  function (_super) {
    ...
    DragAndDrop.prototype.dragHelper = function (e) {
      ...
      if (!this.parent.options.eventDragArea && this.parent.options.currentView !== 'Month' && this.parent.activeViewOptions.timeScale.enable && !this.parent.isTimelineView() && !this.actionObj.element.classList.contains(ALLDAY_APPOINTMENT_CLASS)) {
    ...
    DragAndDrop.prototype.dragStart = function (e) {
      ...
      var args = JSON.stringify(dragArgs); // tslint:disable-next-line:no-any
    ...
    DragAndDrop.prototype.dragStop = function (e) {
      ...
      var groupIndex = this.parent.activeViewOptions.group.resources.length > 0 ? this.actionObj.groupIndex : -1; // tslint:disable-next-line:no-any
    ...
    DragAndDrop.prototype.updateEventHeight = function (event) {// this.verticalEvent.initializeValues();
    ...
    DragAndDrop.prototype.calculateTimelineTime = function (e) {
      ...
      var width = this.timelineEventModule.getEventWidth(startTime, endTime, eventObj.isAllDay, eventData.count);
  ...
  function () {
    ...
    InlineEdit.prototype.eventEdit = function (guid) {
      var inlineSubject = this.parent.element.querySelector('.' + INLINE_SUBJECT_CLASS);
      var subject;
      ...
      if (inlineSubject) {
        ...
        if (sf.base.closest(activeEvent, '.' + MORE_POPUP_WRAPPER_CLASS)) {
          ...
          var elementSelector = ['TimelineWeek', 'TimelineMonth'].indexOf(this.parent.options.currentView) > -1 ? '.e-inner-wrap' : '.e-appointment-details';
  ...
  function () {
    ...
    SfSchedule.prototype.initializeLayout = function (viewName) {
      ...
      this.uiStateValues.isGroupAdaptive = this.isAdaptive && this.activeViewOptions.group.resources.length > 0 && this.activeViewOptions.group.enableCompactView;
    ...
    SfSchedule.prototype.getTimeString = function (date) {
      var timeFormat = sf.base.IntlBase.compareBlazorDateFormats({
        skeleton: 't'
      }, this.options.locale).format;
    ...
    SfSchedule.prototype.destroy = function (enablePersistence) {
  ...
  var Schedule = {
    ...
    destroy: function destroy(element, enablePersistence) {
      if (element && element.blazor__instance) {
    ...
    inlineEdit: function inlineEdit(element, clickType, isTemplate, guid) {
      if (guid === void 0) {
        guid = null;
      }
