...
/******/ 	return __webpack_require__(__webpack_require__.s = "./bundles/dashboardlayout.js");
/******/ })
/************************************************************************/
/******/ ({
...
var sfdashboardlayout = function sfdashboardlayout(exports) {
  ...
  function (_super) {
    ...
    DashboardLayout.prototype.renderTemplate = function (content, appendElement, type, isStringTemplate, prop) {
      ...
      var templateElements = []; // tslint:disable-next-line
    ...
    DashboardLayout.prototype.checkMediaQuerySizing = function () {
      ...
      for (var i = 0; i < updatedPanel.length; i++) {
        var panelElement = document.getElementById(updatedPanel[i].id); // tslint:disable-next-line
        ...
        if (panelElement) {
          ...
          if (updatedPanel[i].sizeY > 1) {
            updatedHeight = (this.element.parentElement && this.element.parentElement.offsetWidth / this.cellAspectRatio) * updatedPanel[i].sizeY + parseInt((Math.round(updatedPanel[i].sizeY / 2) * this.cellSpacing[1]).toString(), 0);
