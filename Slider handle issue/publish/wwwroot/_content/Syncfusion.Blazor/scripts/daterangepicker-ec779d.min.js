...
var sfdaterangepicker = function sfdaterangepicker(exports) {
  ...
  function (_super) {
    ...
    DateRangePicker.prototype.selectRange = function (event, element) {
      ...
      var date;
      date = sf.base.isNullOrUndefined(event) ? this.getIdValue(null, element) : this.getIdValue(event, null);
    ...
    DateRangePicker.prototype.renderPopup = function () {
      ...
      this.popupObj = new sf.popups.Popup(this.popupWrapper, {
        ...
        position: this.isMobile ? !sf.base.isUndefined(this.presets[0].start && this.presets[0].end && this.presets[0].label) && !this.isCustomWindow ? {
          X: 'left',
          Y: 'bottom'
        } : {
          X: 'center',
        ...
        offsetY: OFFSETVALUE,
        collision: this.isMobile ? !sf.base.isUndefined(this.presets[0].start && this.presets[0].end && this.presets[0].label) && !this.isCustomWindow ? {
          X: 'fit'
        } : {
          X: 'fit',
          Y: 'fit'
    ...
    DateRangePicker.prototype.documentHandler = function (e) {
      ...
      if (!this.inputWrapper.container.contains(target) || !sf.base.isNullOrUndefined(this.popupObj) && !sf.base.closest(target, this.popupWrapper.id)) {
        if (e.type !== 'touchstart' && (e.type === 'mousedown' || this.closeEventArgs && !this.closeEventArgs.cancel)) {
          e.preventDefault();
        }
      }

      if ((sf.base.isNullOrUndefined(this.targetElement) || !sf.base.isNullOrUndefined(this.targetElement) && !(target === this.targetElement)) && !sf.base.closest(target, '#' + this.popupObj.element.id) && !(sf.base.closest(target, '.' + INPUTCONTAINER) === this.inputWrapper.container) && !(sf.base.closest(target, '.e-daterangepicker.e-popup') && !target.classList.contains('e-day'))) {
        this.preventBlur = false;
    ...
    DateRangePicker.prototype.checkInvalidRange = function (value) {
      if (!sf.base.isNullOrUndefined(value)) {
        ...
        if (typeof value === 'string') {
          ...
          if (!(startinvalue instanceof Date) && _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(startinvalue) !== 'object') {
          ...
          if (!(endinvalue instanceof Date) && _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(endinvalue) !== 'object') {
    ...
    DateRangePicker.prototype.destroy = function () {
      ...
      if (this.inputElement) {
        ...
        !sf.base.isNullOrUndefined(this.cloneElement.getAttribute('tabindex')) ? this.inputElement.setAttribute('tabindex', this.tabIndex) : this.inputElement.removeAttribute('tabindex');
