...
var sftoolbar = function sftoolbar(exports) {
  ...
  function (_super) {
    ...
    Toolbar.prototype.eleContains = function (el) {
      // tslint:disable-next-line:max-line-length
      return el.classList.contains(CLS_SEPARATOR) || el.classList.contains(CLS_DISABLE) || el.getAttribute('disabled') || el.classList.contains(CLS_HIDDEN) || !sf.base.isVisible(el); // tslint:enable-next-line:max-line-length
    };
    ...
    Toolbar.prototype.templateRender = function (templateProp, innerEle, item, index) {
      ...
      if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(templateProp) === 'object') {
      ...
      if (typeof templateProp === 'string' || !isComponent) {
        ...
        try {
          if (_babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(templateProp) === 'object' && !sf.base.isNullOrUndefined(templateProp.tagName)) {
    ...
    Toolbar.prototype.hideItem = function (index, value) {
      var isElement = _babel_runtime_helpers_typeof__WEBPACK_IMPORTED_MODULE_0___default()(index) === 'object' ? true : false;
      var eleIndex = index;
      var initIndex;
      var ele;
      var innerItems = [].slice.call(sf.base.selectAll('.' + CLS_ITEM, this.element));
