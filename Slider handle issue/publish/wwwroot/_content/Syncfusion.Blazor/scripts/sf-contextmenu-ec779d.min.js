...
window.sfBlazor.ContextMenu = function () {
  ...
  function () {
    ...
    SfContextMenu.prototype.cmenuHandler = function (e) {
      ...
      var top = e.changedTouches ? e.changedTouches[0].clientY : e.clientY; // tslint:disable-next-line:no-any

      this.dotnetRef.invokeMethodAsync(OPENMENU, Math.ceil(left), Math.ceil(top)).then(function (rtl) {
        return _this.contextMenuPosition(left, top, rtl, false);
      });
    };
    ...
    SfContextMenu.prototype.mouseDownHandler = function (e) {
      ...
      if (!sf.base.closest(e.target, HASH + this.element.id) && (sf.base.isNullOrUndefined(this.menuId) || !sf.base.closest(e.target, this.menuId))) {
        this.dotnetRef.invokeMethodAsync(CLOSE, 0, false, true, false);
      }
    };
